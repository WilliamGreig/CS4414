...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	c7 44 24 04 60 3e 00 	movl   $0x3e60,0x4(%esp)
       d:	00 
       e:	a1 80 55 00 00       	mov    0x5580,%eax
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 01 3b 00 00       	call   3b1c <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 f3 3d 00 00 	movl   $0x3df3,(%esp)
      22:	e8 cc 39 00 00       	call   39f3 <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	c7 44 24 04 cc 3d 00 	movl   $0x3dcc,0x4(%esp)
      32:	00 
      33:	a1 80 55 00 00       	mov    0x5580,%eax
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 dc 3a 00 00       	call   3b1c <printf>
    exit();
      40:	e8 46 39 00 00       	call   398b <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 f3 3d 00 00 	movl   $0x3df3,(%esp)
      4c:	e8 aa 39 00 00       	call   39fb <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	c7 44 24 04 da 3d 00 	movl   $0x3dda,0x4(%esp)
      5c:	00 
      5d:	a1 80 55 00 00       	mov    0x5580,%eax
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 b2 3a 00 00       	call   3b1c <printf>
    exit();
      6a:	e8 1c 39 00 00       	call   398b <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 f0 3d 00 00 	movl   $0x3df0,(%esp)
      76:	e8 60 39 00 00       	call   39db <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	c7 44 24 04 fb 3d 00 	movl   $0x3dfb,0x4(%esp)
      86:	00 
      87:	a1 80 55 00 00       	mov    0x5580,%eax
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 88 3a 00 00       	call   3b1c <printf>
    exit();
      94:	e8 f2 38 00 00       	call   398b <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 15 3e 00 00 	movl   $0x3e15,(%esp)
      a0:	e8 56 39 00 00       	call   39fb <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	c7 44 24 04 17 3e 00 	movl   $0x3e17,0x4(%esp)
      b0:	00 
      b1:	a1 80 55 00 00       	mov    0x5580,%eax
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 5e 3a 00 00       	call   3b1c <printf>
    exit();
      be:	e8 c8 38 00 00       	call   398b <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	c7 44 24 04 98 3e 00 	movl   $0x3e98,0x4(%esp)
      ca:	00 
      cb:	a1 80 55 00 00       	mov    0x5580,%eax
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 44 3a 00 00       	call   3b1c <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	c7 44 24 04 27 3e 00 	movl   $0x3e27,0x4(%esp)
      e7:	00 
      e8:	a1 80 55 00 00       	mov    0x5580,%eax
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 27 3a 00 00       	call   3b1c <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
      fe:	c7 44 24 04 0d 4d 00 	movl   $0x4d0d,0x4(%esp)
     105:	00 
     106:	a1 80 55 00 00       	mov    0x5580,%eax
     10b:	89 04 24             	mov    %eax,(%esp)
     10e:	e8 09 3a 00 00       	call   3b1c <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     120:	c7 04 24 f3 3d 00 00 	movl   $0x3df3,(%esp)
     127:	e8 c7 38 00 00       	call   39f3 <mkdir>
     12c:	85 c0                	test   %eax,%eax
     12e:	79 1a                	jns    14a <exitiputtest+0x70>
      printf(stdout, "mkdir failed\n");
     130:	c7 44 24 04 cc 3d 00 	movl   $0x3dcc,0x4(%esp)
     137:	00 
     138:	a1 80 55 00 00       	mov    0x5580,%eax
     13d:	89 04 24             	mov    %eax,(%esp)
     140:	e8 d7 39 00 00       	call   3b1c <printf>
      exit();
     145:	e8 41 38 00 00       	call   398b <exit>
    }
    if(chdir("iputdir") < 0){
     14a:	c7 04 24 f3 3d 00 00 	movl   $0x3df3,(%esp)
     151:	e8 a5 38 00 00       	call   39fb <chdir>
     156:	85 c0                	test   %eax,%eax
     158:	79 1a                	jns    174 <exitiputtest+0x9a>
      printf(stdout, "child chdir failed\n");
     15a:	c7 44 24 04 36 3e 00 	movl   $0x3e36,0x4(%esp)
     161:	00 
     162:	a1 80 55 00 00       	mov    0x5580,%eax
     167:	89 04 24             	mov    %eax,(%esp)
     16a:	e8 ad 39 00 00       	call   3b1c <printf>
      exit();
     16f:	e8 17 38 00 00       	call   398b <exit>
    }
    if(unlink("../iputdir") < 0){
     174:	c7 04 24 f0 3d 00 00 	movl   $0x3df0,(%esp)
     17b:	e8 5b 38 00 00       	call   39db <unlink>
     180:	85 c0                	test   %eax,%eax
     182:	79 1a                	jns    19e <exitiputtest+0xc4>
      printf(stdout, "unlink ../iputdir failed\n");
     184:	c7 44 24 04 fb 3d 00 	movl   $0x3dfb,0x4(%esp)
     18b:	00 
     18c:	a1 80 55 00 00       	mov    0x5580,%eax
     191:	89 04 24             	mov    %eax,(%esp)
     194:	e8 83 39 00 00       	call   3b1c <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1a8:	c7 44 24 04 4a 3e 00 	movl   $0x3e4a,0x4(%esp)
     1af:	00 
     1b0:	a1 80 55 00 00       	mov    0x5580,%eax
     1b5:	89 04 24             	mov    %eax,(%esp)
     1b8:	e8 5f 39 00 00       	call   3b1c <printf>
}
     1bd:	c9                   	leave  
     1be:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1c5:	c7 44 24 04 5c 3e 00 	movl   $0x3e5c,0x4(%esp)
     1cc:	00 
     1cd:	a1 80 55 00 00       	mov    0x5580,%eax
     1d2:	89 04 24             	mov    %eax,(%esp)
     1d5:	e8 42 39 00 00       	call   3b1c <printf>
  if(mkdir("oidir") < 0){
     1da:	c7 04 24 6b 3e 00 00 	movl   $0x3e6b,(%esp)
     1e1:	e8 0d 38 00 00       	call   39f3 <mkdir>
     1e6:	85 c0                	test   %eax,%eax
     1e8:	79 1a                	jns    204 <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1ea:	c7 44 24 04 71 3e 00 	movl   $0x3e71,0x4(%esp)
     1f1:	00 
     1f2:	a1 80 55 00 00       	mov    0x5580,%eax
     1f7:	89 04 24             	mov    %eax,(%esp)
     1fa:	e8 1d 39 00 00       	call   3b1c <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     20d:	c7 44 24 04 0d 4d 00 	movl   $0x4d0d,0x4(%esp)
     214:	00 
     215:	a1 80 55 00 00       	mov    0x5580,%eax
     21a:	89 04 24             	mov    %eax,(%esp)
     21d:	e8 fa 38 00 00       	call   3b1c <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     232:	00 
     233:	c7 04 24 6b 3e 00 00 	movl   $0x3e6b,(%esp)
     23a:	e8 8c 37 00 00       	call   39cb <open>
    if(fd >= 0){
     23f:	85 c0                	test   %eax,%eax
     241:	78 1a                	js     25d <openiputtest+0x9e>
      printf(stdout, "open directory for write succeeded\n");
     243:	c7 44 24 04 f0 4d 00 	movl   $0x4df0,0x4(%esp)
     24a:	00 
     24b:	a1 80 55 00 00       	mov    0x5580,%eax
     250:	89 04 24             	mov    %eax,(%esp)
     253:	e8 c4 38 00 00       	call   3b1c <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     26e:	c7 04 24 6b 3e 00 00 	movl   $0x3e6b,(%esp)
     275:	e8 61 37 00 00       	call   39db <unlink>
     27a:	85 c0                	test   %eax,%eax
     27c:	74 1a                	je     298 <openiputtest+0xd9>
    printf(stdout, "unlink failed\n");
     27e:	c7 44 24 04 85 3e 00 	movl   $0x3e85,0x4(%esp)
     285:	00 
     286:	a1 80 55 00 00       	mov    0x5580,%eax
     28b:	89 04 24             	mov    %eax,(%esp)
     28e:	e8 89 38 00 00       	call   3b1c <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     29d:	c7 44 24 04 94 3e 00 	movl   $0x3e94,0x4(%esp)
     2a4:	00 
     2a5:	a1 80 55 00 00       	mov    0x5580,%eax
     2aa:	89 04 24             	mov    %eax,(%esp)
     2ad:	e8 6a 38 00 00       	call   3b1c <printf>
}
     2b2:	c9                   	leave  
     2b3:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2ba:	c7 44 24 04 a6 3e 00 	movl   $0x3ea6,0x4(%esp)
     2c1:	00 
     2c2:	a1 80 55 00 00       	mov    0x5580,%eax
     2c7:	89 04 24             	mov    %eax,(%esp)
     2ca:	e8 4d 38 00 00       	call   3b1c <printf>
  fd = open("echo", 0);
     2cf:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2d6:	00 
     2d7:	c7 04 24 b1 3e 00 00 	movl   $0x3eb1,(%esp)
     2de:	e8 e8 36 00 00       	call   39cb <open>
  if(fd < 0){
     2e3:	85 c0                	test   %eax,%eax
     2e5:	79 1a                	jns    301 <opentest+0x4d>
    printf(stdout, "open echo failed!\n");
     2e7:	c7 44 24 04 b6 3e 00 	movl   $0x3eb6,0x4(%esp)
     2ee:	00 
     2ef:	a1 80 55 00 00       	mov    0x5580,%eax
     2f4:	89 04 24             	mov    %eax,(%esp)
     2f7:	e8 20 38 00 00       	call   3b1c <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     310:	00 
     311:	c7 04 24 c9 3e 00 00 	movl   $0x3ec9,(%esp)
     318:	e8 ae 36 00 00       	call   39cb <open>
  if(fd >= 0){
     31d:	85 c0                	test   %eax,%eax
     31f:	78 1a                	js     33b <opentest+0x87>
    printf(stdout, "open doesnotexist succeeded!\n");
     321:	c7 44 24 04 d6 3e 00 	movl   $0x3ed6,0x4(%esp)
     328:	00 
     329:	a1 80 55 00 00       	mov    0x5580,%eax
     32e:	89 04 24             	mov    %eax,(%esp)
     331:	e8 e6 37 00 00       	call   3b1c <printf>
    exit();
     336:	e8 50 36 00 00       	call   398b <exit>
  }
  printf(stdout, "open test ok\n");
     33b:	c7 44 24 04 f4 3e 00 	movl   $0x3ef4,0x4(%esp)
     342:	00 
     343:	a1 80 55 00 00       	mov    0x5580,%eax
     348:	89 04 24             	mov    %eax,(%esp)
     34b:	e8 cc 37 00 00       	call   3b1c <printf>
}
     350:	c9                   	leave  
     351:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     35a:	c7 44 24 04 02 3f 00 	movl   $0x3f02,0x4(%esp)
     361:	00 
     362:	a1 80 55 00 00       	mov    0x5580,%eax
     367:	89 04 24             	mov    %eax,(%esp)
     36a:	e8 ad 37 00 00       	call   3b1c <printf>
  fd = open("small", O_CREATE|O_RDWR);
     36f:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     376:	00 
     377:	c7 04 24 13 3f 00 00 	movl   $0x3f13,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     389:	c7 44 24 04 19 3f 00 	movl   $0x3f19,0x4(%esp)
     390:	00 
     391:	a1 80 55 00 00       	mov    0x5580,%eax
     396:	89 04 24             	mov    %eax,(%esp)
     399:	e8 7e 37 00 00       	call   3b1c <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     3a8:	c7 44 24 04 34 3f 00 	movl   $0x3f34,0x4(%esp)
     3af:	00 
     3b0:	a1 80 55 00 00       	mov    0x5580,%eax
     3b5:	89 04 24             	mov    %eax,(%esp)
     3b8:	e8 5f 37 00 00       	call   3b1c <printf>
    exit();
     3bd:	e8 c9 35 00 00       	call   398b <exit>
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     3c2:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
     3c9:	00 
     3ca:	c7 44 24 04 50 3f 00 	movl   $0x3f50,0x4(%esp)
     3d1:	00 
     ...
     3e3:	c7 44 24 04 14 4e 00 	movl   $0x4e14,0x4(%esp)
     3ea:	00 
     3eb:	a1 80 55 00 00       	mov    0x5580,%eax
     3f0:	89 04 24             	mov    %eax,(%esp)
     3f3:	e8 24 37 00 00       	call   3b1c <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     404:	00 
     405:	c7 44 24 04 5b 3f 00 	movl   $0x3f5b,0x4(%esp)
     40c:	00 
     ...
     41e:	c7 44 24 04 38 4e 00 	movl   $0x4e38,0x4(%esp)
     425:	00 
     426:	a1 80 55 00 00       	mov    0x5580,%eax
     42b:	89 04 24             	mov    %eax,(%esp)
     42e:	e8 e9 36 00 00       	call   3b1c <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     440:	c7 44 24 04 66 3f 00 	movl   $0x3f66,0x4(%esp)
     447:	00 
     448:	a1 80 55 00 00       	mov    0x5580,%eax
     44d:	89 04 24             	mov    %eax,(%esp)
     450:	e8 c7 36 00 00       	call   3b1c <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     464:	00 
     465:	c7 04 24 13 3f 00 00 	movl   $0x3f13,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     477:	c7 44 24 04 71 3f 00 	movl   $0x3f71,0x4(%esp)
     47e:	00 
     47f:	a1 80 55 00 00       	mov    0x5580,%eax
     484:	89 04 24             	mov    %eax,(%esp)
     487:	e8 90 36 00 00       	call   3b1c <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     493:	00 
     494:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
     49b:	00 
  ...
  if(i == 2000){
    ...
    printf(stdout, "error: open small failed!\n");
     4ad:	c7 44 24 04 8a 3f 00 	movl   $0x3f8a,0x4(%esp)
     4b4:	00 
     4b5:	a1 80 55 00 00       	mov    0x5580,%eax
     4ba:	89 04 24             	mov    %eax,(%esp)
     4bd:	e8 5a 36 00 00       	call   3b1c <printf>
    exit();
     4c2:	e8 c4 34 00 00       	call   398b <exit>
    printf(stdout, "read succeeded ok\n");
     4c7:	c7 44 24 04 a5 3f 00 	movl   $0x3fa5,0x4(%esp)
     4ce:	00 
     4cf:	a1 80 55 00 00       	mov    0x5580,%eax
     4d4:	89 04 24             	mov    %eax,(%esp)
     4d7:	e8 40 36 00 00       	call   3b1c <printf>
  } else {
  ...
  if(unlink("small") < 0){
     4e4:	c7 04 24 13 3f 00 00 	movl   $0x3f13,(%esp)
    ...
    printf(stdout, "read failed\n");
     4f6:	c7 44 24 04 d1 42 00 	movl   $0x42d1,0x4(%esp)
     4fd:	00 
     4fe:	a1 80 55 00 00       	mov    0x5580,%eax
     503:	89 04 24             	mov    %eax,(%esp)
     506:	e8 11 36 00 00       	call   3b1c <printf>
    exit();
     50b:	e8 7b 34 00 00       	call   398b <exit>
    printf(stdout, "unlink small failed\n");
     510:	c7 44 24 04 b8 3f 00 	movl   $0x3fb8,0x4(%esp)
     517:	00 
     518:	a1 80 55 00 00       	mov    0x5580,%eax
     51d:	89 04 24             	mov    %eax,(%esp)
     520:	e8 f7 35 00 00       	call   3b1c <printf>
    exit();
     525:	e8 61 34 00 00       	call   398b <exit>
  }
  printf(stdout, "small file test ok\n");
     52a:	c7 44 24 04 cd 3f 00 	movl   $0x3fcd,0x4(%esp)
     531:	00 
     532:	a1 80 55 00 00       	mov    0x5580,%eax
     537:	89 04 24             	mov    %eax,(%esp)
     53a:	e8 dd 35 00 00       	call   3b1c <printf>
}
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     54e:	c7 44 24 04 e1 3f 00 	movl   $0x3fe1,0x4(%esp)
     555:	00 
     556:	a1 80 55 00 00       	mov    0x5580,%eax
     55b:	89 04 24             	mov    %eax,(%esp)
     55e:	e8 b9 35 00 00       	call   3b1c <printf>

  fd = open("big", O_CREATE|O_RDWR);
     563:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     56a:	00 
     56b:	c7 04 24 5b 40 00 00 	movl   $0x405b,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     57d:	c7 44 24 04 f1 3f 00 	movl   $0x3ff1,0x4(%esp)
     584:	00 
     585:	a1 80 55 00 00       	mov    0x5580,%eax
     58a:	89 04 24             	mov    %eax,(%esp)
     58d:	e8 8a 35 00 00       	call   3b1c <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ((int*)buf)[0] = i;
     597:	89 1d 60 7d 00 00    	mov    %ebx,0x7d60
    if(write(fd, buf, 512) != 512){
     59d:	c7 44 24 08 00 02 00 	movl   $0x200,0x8(%esp)
     5a4:	00 
     5a5:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
     5ac:	00 
     ...
     5c0:	c7 44 24 04 0b 40 00 	movl   $0x400b,0x4(%esp)
     5c7:	00 
     5c8:	a1 80 55 00 00       	mov    0x5580,%eax
     5cd:	89 04 24             	mov    %eax,(%esp)
     5d0:	e8 47 35 00 00       	call   3b1c <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     5fb:	00 
     5fc:	c7 04 24 5b 40 00 00 	movl   $0x405b,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     60e:	c7 44 24 04 29 40 00 	movl   $0x4029,0x4(%esp)
     615:	00 
     616:	a1 80 55 00 00       	mov    0x5580,%eax
     61b:	89 04 24             	mov    %eax,(%esp)
     61e:	e8 f9 34 00 00       	call   3b1c <printf>
    exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     634:	00 
     635:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
     63c:	00 
    ...
    if(i == 0){
     ...
     655:	c7 44 24 04 42 40 00 	movl   $0x4042,0x4(%esp)
     65c:	00 
     65d:	a1 80 55 00 00       	mov    0x5580,%eax
     662:	89 04 24             	mov    %eax,(%esp)
     665:	e8 b2 34 00 00       	call   3b1c <printf>
        exit();
     ...
     67a:	c7 44 24 04 5f 40 00 	movl   $0x405f,0x4(%esp)
     681:	00 
     682:	a1 80 55 00 00       	mov    0x5580,%eax
     687:	89 04 24             	mov    %eax,(%esp)
     68a:	e8 8d 34 00 00       	call   3b1c <printf>
      exit();
     68f:	e8 f7 32 00 00       	call   398b <exit>
    }
    if(((int*)buf)[0] != n){
     694:	a1 60 7d 00 00       	mov    0x7d60,%eax
     ...
     6a5:	c7 44 24 04 5c 4e 00 	movl   $0x4e5c,0x4(%esp)
     6ac:	00 
     6ad:	a1 80 55 00 00       	mov    0x5580,%eax
     6b2:	89 04 24             	mov    %eax,(%esp)
     6b5:	e8 62 34 00 00       	call   3b1c <printf>
             n, ((int*)buf)[0]);
      exit();
  ...
  if(unlink("big") < 0){
     6cf:	c7 04 24 5b 40 00 00 	movl   $0x405b,(%esp)
     6d6:	e8 00 33 00 00       	call   39db <unlink>
     6db:	85 c0                	test   %eax,%eax
     6dd:	79 1a                	jns    6f9 <writetest1+0x1b3>
    printf(stdout, "unlink big failed\n");
     6df:	c7 44 24 04 6f 40 00 	movl   $0x406f,0x4(%esp)
     6e6:	00 
     6e7:	a1 80 55 00 00       	mov    0x5580,%eax
     6ec:	89 04 24             	mov    %eax,(%esp)
     6ef:	e8 28 34 00 00       	call   3b1c <printf>
    exit();
     6f4:	e8 92 32 00 00       	call   398b <exit>
  }
  printf(stdout, "big files ok\n");
     6f9:	c7 44 24 04 82 40 00 	movl   $0x4082,0x4(%esp)
     700:	00 
     701:	a1 80 55 00 00       	mov    0x5580,%eax
     706:	89 04 24             	mov    %eax,(%esp)
     709:	e8 0e 34 00 00       	call   3b1c <printf>
}
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     71c:	c7 44 24 04 7c 4e 00 	movl   $0x4e7c,0x4(%esp)
     723:	00 
     724:	a1 80 55 00 00       	mov    0x5580,%eax
     729:	89 04 24             	mov    %eax,(%esp)
     72c:	e8 eb 33 00 00       	call   3b1c <printf>

  name[0] = 'a';
     731:	c6 05 60 9d 00 00 61 	movb   $0x61,0x9d60
  name[2] = '\0';
     738:	c6 05 62 9d 00 00 00 	movb   $0x0,0x9d62
  for(i = 0; i < 52; i++){
     73f:	bb 00 00 00 00       	mov    $0x0,%ebx
     744:	eb 27                	jmp    76d <createtest+0x58>
    name[1] = '0' + i;
     746:	8d 43 30             	lea    0x30(%ebx),%eax
     749:	a2 61 9d 00 00       	mov    %al,0x9d61
    fd = open(name, O_CREATE|O_RDWR);
     74e:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     755:	00 
     756:	c7 04 24 60 9d 00 00 	movl   $0x9d60,(%esp)
  ...
  name[0] = 'a';
     772:	c6 05 60 9d 00 00 61 	movb   $0x61,0x9d60
  name[2] = '\0';
     779:	c6 05 62 9d 00 00 00 	movb   $0x0,0x9d62
  for(i = 0; i < 52; i++){
     780:	bb 00 00 00 00       	mov    $0x0,%ebx
     785:	eb 17                	jmp    79e <createtest+0x89>
    name[1] = '0' + i;
     787:	8d 43 30             	lea    0x30(%ebx),%eax
     78a:	a2 61 9d 00 00       	mov    %al,0x9d61
    unlink(name);
     78f:	c7 04 24 60 9d 00 00 	movl   $0x9d60,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     7a3:	c7 44 24 04 a4 4e 00 	movl   $0x4ea4,0x4(%esp)
     7aa:	00 
     7ab:	a1 80 55 00 00       	mov    0x5580,%eax
     7b0:	89 04 24             	mov    %eax,(%esp)
     7b3:	e8 64 33 00 00       	call   3b1c <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     7c4:	c7 44 24 04 90 40 00 	movl   $0x4090,0x4(%esp)
     7cb:	00 
     7cc:	a1 80 55 00 00       	mov    0x5580,%eax
     7d1:	89 04 24             	mov    %eax,(%esp)
     7d4:	e8 43 33 00 00       	call   3b1c <printf>

  if(mkdir("dir0") < 0){
     7d9:	c7 04 24 9c 40 00 00 	movl   $0x409c,(%esp)
     7e0:	e8 0e 32 00 00       	call   39f3 <mkdir>
     7e5:	85 c0                	test   %eax,%eax
     7e7:	79 1a                	jns    803 <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     7e9:	c7 44 24 04 cc 3d 00 	movl   $0x3dcc,0x4(%esp)
     7f0:	00 
     7f1:	a1 80 55 00 00       	mov    0x5580,%eax
     7f6:	89 04 24             	mov    %eax,(%esp)
     7f9:	e8 1e 33 00 00       	call   3b1c <printf>
    exit();
     7fe:	e8 88 31 00 00       	call   398b <exit>
  }

  if(chdir("dir0") < 0){
     803:	c7 04 24 9c 40 00 00 	movl   $0x409c,(%esp)
     80a:	e8 ec 31 00 00       	call   39fb <chdir>
     80f:	85 c0                	test   %eax,%eax
     811:	79 1a                	jns    82d <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     813:	c7 44 24 04 a1 40 00 	movl   $0x40a1,0x4(%esp)
     81a:	00 
     81b:	a1 80 55 00 00       	mov    0x5580,%eax
     820:	89 04 24             	mov    %eax,(%esp)
     823:	e8 f4 32 00 00       	call   3b1c <printf>
    exit();
     828:	e8 5e 31 00 00       	call   398b <exit>
  }

  if(chdir("..") < 0){
     82d:	c7 04 24 41 46 00 00 	movl   $0x4641,(%esp)
     834:	e8 c2 31 00 00       	call   39fb <chdir>
     839:	85 c0                	test   %eax,%eax
     83b:	79 1a                	jns    857 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     83d:	c7 44 24 04 b4 40 00 	movl   $0x40b4,0x4(%esp)
     844:	00 
     845:	a1 80 55 00 00       	mov    0x5580,%eax
     84a:	89 04 24             	mov    %eax,(%esp)
     84d:	e8 ca 32 00 00       	call   3b1c <printf>
    exit();
     852:	e8 34 31 00 00       	call   398b <exit>
  }

  if(unlink("dir0") < 0){
     857:	c7 04 24 9c 40 00 00 	movl   $0x409c,(%esp)
     85e:	e8 78 31 00 00       	call   39db <unlink>
     863:	85 c0                	test   %eax,%eax
     865:	79 1a                	jns    881 <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     867:	c7 44 24 04 c5 40 00 	movl   $0x40c5,0x4(%esp)
     86e:	00 
     86f:	a1 80 55 00 00       	mov    0x5580,%eax
     874:	89 04 24             	mov    %eax,(%esp)
     877:	e8 a0 32 00 00       	call   3b1c <printf>
    exit();
     87c:	e8 0a 31 00 00       	call   398b <exit>
  }
  printf(stdout, "mkdir test ok\n");
     881:	c7 44 24 04 d9 40 00 	movl   $0x40d9,0x4(%esp)
     888:	00 
     889:	a1 80 55 00 00       	mov    0x5580,%eax
     88e:	89 04 24             	mov    %eax,(%esp)
     891:	e8 86 32 00 00       	call   3b1c <printf>
}
     896:	c9                   	leave  
     897:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     89e:	c7 44 24 04 e8 40 00 	movl   $0x40e8,0x4(%esp)
     8a5:	00 
     8a6:	a1 80 55 00 00       	mov    0x5580,%eax
     8ab:	89 04 24             	mov    %eax,(%esp)
     8ae:	e8 69 32 00 00       	call   3b1c <printf>
  if(exec("echo", echoargv) < 0){
     8b3:	c7 44 24 04 84 55 00 	movl   $0x5584,0x4(%esp)
     8ba:	00 
     8bb:	c7 04 24 b1 3e 00 00 	movl   $0x3eb1,(%esp)
     8c2:	e8 fc 30 00 00       	call   39c3 <exec>
     8c7:	85 c0                	test   %eax,%eax
     8c9:	79 1a                	jns    8e5 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     8cb:	c7 44 24 04 f3 40 00 	movl   $0x40f3,0x4(%esp)
     8d2:	00 
     8d3:	a1 80 55 00 00       	mov    0x5580,%eax
     8d8:	89 04 24             	mov    %eax,(%esp)
     8db:	e8 3c 32 00 00       	call   3b1c <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     8ff:	c7 44 24 04 05 41 00 	movl   $0x4105,0x4(%esp)
     906:	00 
     907:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     90e:	e8 09 32 00 00       	call   3b1c <printf>
    exit();
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     937:	eb 58                	jmp    991 <pipe1+0xaa>
      for(i = 0; i < 1033; i++)
        buf[i] = seq++;
     939:	88 98 60 7d 00 00    	mov    %bl,0x7d60(%eax)
      for(i = 0; i < 1033; i++)
     ...
     95a:	00 
     95b:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
     962:	00 
     ...
     975:	c7 44 24 04 14 41 00 	movl   $0x4114,0x4(%esp)
     97c:	00 
     97d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     984:	e8 93 31 00 00       	call   3b1c <printf>
        exit();
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     9c2:	38 9a 60 7d 00 00    	cmp    %bl,0x7d60(%edx)
     9c8:	74 19                	je     9e3 <pipe1+0xfc>
          printf(1, "pipe1 oops 2\n");
     9ca:	c7 44 24 04 22 41 00 	movl   $0x4122,0x4(%esp)
     9d1:	00 
     9d2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     9d9:	e8 3e 31 00 00       	call   3b1c <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a08:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
     a0f:	00 
    ...
    if(total != 5 * 1033){
     ...
     a2b:	c7 44 24 04 30 41 00 	movl   $0x4130,0x4(%esp)
     a32:	00 
     a33:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a3a:	e8 dd 30 00 00       	call   3b1c <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     a54:	c7 44 24 04 47 41 00 	movl   $0x4147,0x4(%esp)
     a5b:	00 
     a5c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a63:	e8 b4 30 00 00       	call   3b1c <printf>
     a68:	eb 19                	jmp    a83 <pipe1+0x19c>
    printf(1, "fork() failed\n");
     a6a:	c7 44 24 04 51 41 00 	movl   $0x4151,0x4(%esp)
     a71:	00 
     a72:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a79:	e8 9e 30 00 00       	call   3b1c <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     a94:	c7 44 24 04 60 41 00 	movl   $0x4160,0x4(%esp)
     a9b:	00 
     a9c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     aa3:	e8 74 30 00 00       	call   3b1c <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     aec:	00 
     aed:	c7 44 24 04 25 47 00 	movl   $0x4725,0x4(%esp)
     af4:	00 
     ...
     b05:	c7 44 24 04 6a 41 00 	movl   $0x416a,0x4(%esp)
     b0c:	00 
     b0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b14:	e8 03 30 00 00       	call   3b1c <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     b38:	00 
     b39:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
     b40:	00 
    ...
    printf(1, "preempt read error");
     b51:	c7 44 24 04 7e 41 00 	movl   $0x417e,0x4(%esp)
     b58:	00 
     b59:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b60:	e8 b7 2f 00 00       	call   3b1c <printf>
  ...
  printf(1, "kill... ");
     b72:	c7 44 24 04 91 41 00 	movl   $0x4191,0x4(%esp)
     b79:	00 
     b7a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b81:	e8 96 2f 00 00       	call   3b1c <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     b9e:	c7 44 24 04 9a 41 00 	movl   $0x419a,0x4(%esp)
     ba5:	00 
     ba6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bad:	e8 6a 2f 00 00       	call   3b1c <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     bc5:	c7 44 24 04 a3 41 00 	movl   $0x41a3,0x4(%esp)
     bcc:	00 
     bcd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bd4:	e8 43 2f 00 00       	call   3b1c <printf>
}
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     bf9:	79 16                	jns    c11 <exitwait+0x30>
      printf(1, "fork failed\n");
     bfb:	c7 44 24 04 0d 4d 00 	movl   $0x4d0d,0x4(%esp)
     c02:	00 
     c03:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c0a:	e8 0d 2f 00 00       	call   3b1c <printf>
      return;
    ...
    if(pid){
     ...
     c22:	c7 44 24 04 af 41 00 	movl   $0x41af,0x4(%esp)
     c29:	00 
     c2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c31:	e8 e6 2e 00 00       	call   3b1c <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     c45:	c7 44 24 04 bf 41 00 	movl   $0x41bf,0x4(%esp)
     c4c:	00 
     c4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c54:	e8 c3 2e 00 00       	call   3b1c <printf>
}
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     c69:	c7 44 24 04 cc 41 00 	movl   $0x41cc,0x4(%esp)
     c70:	00 
     c71:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c78:	e8 9f 2e 00 00       	call   3b1c <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     ca4:	e8 93 30 00 00       	call   3d3c <malloc>
    ...
    while(m1){
     ...
     cb4:	e8 c7 2f 00 00       	call   3c80 <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     cc6:	e8 71 30 00 00       	call   3d3c <malloc>
    if(m1 == 0){
     ccb:	85 c0                	test   %eax,%eax
     ccd:	75 21                	jne    cf0 <mem+0x90>
      printf(1, "couldn't allocate mem?!!\n");
     ccf:	c7 44 24 04 d6 41 00 	movl   $0x41d6,0x4(%esp)
     cd6:	00 
     cd7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cde:	e8 39 2e 00 00       	call   3b1c <printf>
      kill(ppid);
    ...
    free(m1);
     ...
     cf3:	e8 88 2f 00 00       	call   3c80 <free>
    printf(1, "mem ok\n");
     cf8:	c7 44 24 04 f0 41 00 	movl   $0x41f0,0x4(%esp)
     cff:	00 
     d00:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d07:	e8 10 2e 00 00       	call   3b1c <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     d27:	c7 44 24 04 f8 41 00 	movl   $0x41f8,0x4(%esp)
     d2e:	00 
     d2f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d36:	e8 e1 2d 00 00       	call   3b1c <printf>

  unlink("sharedfd");
     d3b:	c7 04 24 07 42 00 00 	movl   $0x4207,(%esp)
     d42:	e8 94 2c 00 00       	call   39db <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     d47:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     d4e:	00 
     d4f:	c7 04 24 07 42 00 00 	movl   $0x4207,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     d61:	c7 44 24 04 cc 4e 00 	movl   $0x4ecc,0x4(%esp)
     d68:	00 
     d69:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d70:	e8 a7 2d 00 00       	call   3b1c <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     dc9:	c7 44 24 04 f8 4e 00 	movl   $0x4ef8,0x4(%esp)
     dd0:	00 
     dd1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     dd8:	e8 3f 2d 00 00       	call   3b1c <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     e09:	00 
     e0a:	c7 04 24 07 42 00 00 	movl   $0x4207,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     e1c:	c7 44 24 04 18 4f 00 	movl   $0x4f18,0x4(%esp)
     e23:	00 
     e24:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e2b:	e8 ec 2c 00 00       	call   3b1c <printf>
    return;
  ...
  unlink("sharedfd");
     e88:	c7 04 24 07 42 00 00 	movl   $0x4207,(%esp)
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
     ef2:	c7 45 d8 32 42 00 00 	movl   $0x4232,-0x28(%ebp)
     ef9:	c7 45 dc 7b 43 00 00 	movl   $0x437b,-0x24(%ebp)
     f00:	c7 45 e0 7f 43 00 00 	movl   $0x437f,-0x20(%ebp)
     f07:	c7 45 e4 35 42 00 00 	movl   $0x4235,-0x1c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
     f0e:	c7 44 24 04 38 42 00 	movl   $0x4238,0x4(%esp)
     f15:	00 
     f16:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f1d:	e8 fa 2b 00 00       	call   3b1c <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    if(pid < 0){
     ...
     f3f:	79 19                	jns    f5a <fourfiles+0x71>
      printf(1, "fork failed\n");
     f41:	c7 44 24 04 0d 4d 00 	movl   $0x4d0d,0x4(%esp)
     f48:	00 
     f49:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f50:	e8 c7 2b 00 00       	call   3b1c <printf>
      exit();
    ...
    if(pid == 0){
     ...
     f78:	c7 44 24 04 d3 44 00 	movl   $0x44d3,0x4(%esp)
     f7f:	00 
     f80:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f87:	e8 90 2b 00 00       	call   3b1c <printf>
        exit();
     ...
     fa0:	c7 04 24 60 7d 00 00 	movl   $0x7d60,(%esp)
     ...
     fba:	00 
     fbb:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
     fc2:	00 
     ...
     fd6:	c7 44 24 04 48 42 00 	movl   $0x4248,0x4(%esp)
     fdd:	00 
     fde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fe5:	e8 32 2b 00 00       	call   3b1c <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    104c:	eb 34                	jmp    1082 <fourfiles+0x199>
        if(buf[j] != '0'+i){
    104e:	0f be 8a 60 7d 00 00 	movsbl 0x7d60(%edx),%ecx
    1055:	39 d9                	cmp    %ebx,%ecx
    1057:	74 19                	je     1072 <fourfiles+0x189>
          printf(1, "wrong char\n");
    1059:	c7 44 24 04 59 42 00 	movl   $0x4259,0x4(%esp)
    1060:	00 
    1061:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1068:	e8 af 2a 00 00       	call   3b1c <printf>
          exit();
    ...
    1089:	00 
    108a:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    1091:	00 
    ...
    10b2:	c7 44 24 04 65 42 00 	movl   $0x4265,0x4(%esp)
    10b9:	00 
    10ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10c1:	e8 56 2a 00 00       	call   3b1c <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    10e4:	c7 44 24 04 76 42 00 	movl   $0x4276,0x4(%esp)
    10eb:	00 
    10ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10f3:	e8 24 2a 00 00       	call   3b1c <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1109:	c7 44 24 04 84 42 00 	movl   $0x4284,0x4(%esp)
    1110:	00 
    1111:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1118:	e8 ff 29 00 00       	call   3b1c <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    112e:	79 19                	jns    1149 <createdelete+0x49>
      printf(1, "fork failed\n");
    1130:	c7 44 24 04 0d 4d 00 	movl   $0x4d0d,0x4(%esp)
    1137:	00 
    1138:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113f:	e8 d8 29 00 00       	call   3b1c <printf>
      exit();
    ...
    117d:	79 19                	jns    1198 <createdelete+0x98>
          printf(1, "create failed\n");
    117f:	c7 44 24 04 d3 44 00 	movl   $0x44d3,0x4(%esp)
    1186:	00 
    1187:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    118e:	e8 89 29 00 00       	call   3b1c <printf>
          exit();
    ...
    11c4:	c7 44 24 04 85 3e 00 	movl   $0x3e85,0x4(%esp)
    11cb:	00 
    11cc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11d3:	e8 44 29 00 00       	call   3b1c <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    125a:	c7 44 24 04 44 4f 00 	movl   $0x4f44,0x4(%esp)
    1261:	00 
    1262:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1269:	e8 ae 28 00 00       	call   3b1c <printf>
        exit();
    ...
    1286:	c7 44 24 04 68 4f 00 	movl   $0x4f68,0x4(%esp)
    128d:	00 
    128e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1295:	e8 82 28 00 00       	call   3b1c <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    130f:	c7 44 24 04 97 42 00 	movl   $0x4297,0x4(%esp)
    1316:	00 
    1317:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    131e:	e8 f9 27 00 00       	call   3b1c <printf>
}
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1333:	c7 44 24 04 a8 42 00 	movl   $0x42a8,0x4(%esp)
    133a:	00 
    133b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1342:	e8 d5 27 00 00       	call   3b1c <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1347:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    134e:	00 
    134f:	c7 04 24 b9 42 00 00 	movl   $0x42b9,(%esp)
  ...
  if(fd < 0){
    ...
    1361:	c7 44 24 04 c4 42 00 	movl   $0x42c4,0x4(%esp)
    1368:	00 
    1369:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1370:	e8 a7 27 00 00       	call   3b1c <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1381:	00 
    1382:	c7 44 24 04 de 42 00 	movl   $0x42de,0x4(%esp)
    1389:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    13a1:	00 
    13a2:	c7 04 24 b9 42 00 00 	movl   $0x42b9,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1433:	00 
    1434:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    143b:	00 
    ...
    1449:	c7 44 24 04 1a 43 00 	movl   $0x431a,0x4(%esp)
    1450:	00 
    1451:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1458:	e8 bf 26 00 00       	call   3b1c <printf>
    exit();
    145d:	e8 29 25 00 00       	call   398b <exit>
  }
  if(buf[0] != 'h'){
    1462:	80 3d 60 7d 00 00 68 	cmpb   $0x68,0x7d60
    1469:	74 19                	je     1484 <unlinkread+0x159>
    printf(1, "unlinkread wrong data\n");
    146b:	c7 44 24 04 31 43 00 	movl   $0x4331,0x4(%esp)
    1472:	00 
    1473:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    147a:	e8 9d 26 00 00       	call   3b1c <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    148b:	00 
    148c:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    1493:	00 
    ...
    14a1:	c7 44 24 04 48 43 00 	movl   $0x4348,0x4(%esp)
    14a8:	00 
    14a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14b0:	e8 67 26 00 00       	call   3b1c <printf>
    exit();
  ...
  unlink("unlinkread");
    14c2:	c7 04 24 b9 42 00 00 	movl   $0x42b9,(%esp)
    14c9:	e8 0d 25 00 00       	call   39db <unlink>
  printf(1, "unlinkread ok\n");
    14ce:	c7 44 24 04 61 43 00 	movl   $0x4361,0x4(%esp)
    14d5:	00 
    14d6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14dd:	e8 3a 26 00 00       	call   3b1c <printf>
}
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    14f0:	c7 44 24 04 70 43 00 	movl   $0x4370,0x4(%esp)
    14f7:	00 
    14f8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14ff:	e8 18 26 00 00       	call   3b1c <printf>

  unlink("lf1");
    1504:	c7 04 24 7a 43 00 00 	movl   $0x437a,(%esp)
    150b:	e8 cb 24 00 00       	call   39db <unlink>
  unlink("lf2");
    1510:	c7 04 24 7e 43 00 00 	movl   $0x437e,(%esp)
    1517:	e8 bf 24 00 00       	call   39db <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    151c:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1523:	00 
    1524:	c7 04 24 7a 43 00 00 	movl   $0x437a,(%esp)
  ...
  if(fd < 0){
    ...
    1536:	c7 44 24 04 82 43 00 	movl   $0x4382,0x4(%esp)
    153d:	00 
    153e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1545:	e8 d2 25 00 00       	call   3b1c <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1556:	00 
    1557:	c7 44 24 04 de 42 00 	movl   $0x42de,0x4(%esp)
    155e:	00 
    ...
    156c:	c7 44 24 04 95 43 00 	movl   $0x4395,0x4(%esp)
    1573:	00 
    1574:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    157b:	e8 9c 25 00 00       	call   3b1c <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    1602:	00 
    1603:	c7 04 24 7e 43 00 00 	movl   $0x437e,(%esp)
  ...
  if(fd < 0){
    ...
    1615:	c7 44 24 04 bc 43 00 	movl   $0x43bc,0x4(%esp)
    161c:	00 
    161d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1624:	e8 f3 24 00 00       	call   3b1c <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1635:	00 
    1636:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    163d:	00 
    ...
    164b:	c7 44 24 04 cd 43 00 	movl   $0x43cd,0x4(%esp)
    1652:	00 
    1653:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165a:	e8 bd 24 00 00       	call   3b1c <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    166c:	c7 44 24 04 7e 43 00 	movl   $0x437e,0x4(%esp)
    1673:	00 
    1674:	c7 04 24 7e 43 00 00 	movl   $0x437e,(%esp)
    167b:	e8 6b 23 00 00       	call   39eb <link>
    1680:	85 c0                	test   %eax,%eax
    1682:	78 19                	js     169d <linktest+0x1b4>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1684:	c7 44 24 04 de 43 00 	movl   $0x43de,0x4(%esp)
    168b:	00 
    168c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1693:	e8 84 24 00 00       	call   3b1c <printf>
    exit();
    1698:	e8 ee 22 00 00       	call   398b <exit>
  }

  unlink("lf2");
    169d:	c7 04 24 7e 43 00 00 	movl   $0x437e,(%esp)
    16a4:	e8 32 23 00 00       	call   39db <unlink>
  if(link("lf2", "lf1") >= 0){
    16a9:	c7 44 24 04 7a 43 00 	movl   $0x437a,0x4(%esp)
    16b0:	00 
    16b1:	c7 04 24 7e 43 00 00 	movl   $0x437e,(%esp)
    16b8:	e8 2e 23 00 00       	call   39eb <link>
    16bd:	85 c0                	test   %eax,%eax
    16bf:	78 19                	js     16da <linktest+0x1f1>
    printf(1, "link non-existant succeeded! oops\n");
    16c1:	c7 44 24 04 b0 4f 00 	movl   $0x4fb0,0x4(%esp)
    16c8:	00 
    16c9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16d0:	e8 47 24 00 00       	call   3b1c <printf>
    exit();
    16d5:	e8 b1 22 00 00       	call   398b <exit>
  }

  if(link(".", "lf1") >= 0){
    16da:	c7 44 24 04 7a 43 00 	movl   $0x437a,0x4(%esp)
    16e1:	00 
    16e2:	c7 04 24 42 46 00 00 	movl   $0x4642,(%esp)
    16e9:	e8 fd 22 00 00       	call   39eb <link>
    16ee:	85 c0                	test   %eax,%eax
    16f0:	78 19                	js     170b <linktest+0x222>
    printf(1, "link . lf1 succeeded! oops\n");
    16f2:	c7 44 24 04 fc 43 00 	movl   $0x43fc,0x4(%esp)
    16f9:	00 
    16fa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1701:	e8 16 24 00 00       	call   3b1c <printf>
    exit();
    1706:	e8 80 22 00 00       	call   398b <exit>
  }

  printf(1, "linktest ok\n");
    170b:	c7 44 24 04 18 44 00 	movl   $0x4418,0x4(%esp)
    1712:	00 
    1713:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    171a:	e8 fd 23 00 00       	call   3b1c <printf>
}
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    172e:	c7 44 24 04 25 44 00 	movl   $0x4425,0x4(%esp)
    1735:	00 
    1736:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    173d:	e8 da 23 00 00       	call   3b1c <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1790:	c7 04 24 35 44 00 00 	movl   $0x4435,(%esp)
    ...
    17c2:	c7 04 24 35 44 00 00 	movl   $0x4435,(%esp)
    ...
    17eb:	c7 44 24 04 38 44 00 	movl   $0x4438,0x4(%esp)
    17f2:	00 
    17f3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    17fa:	e8 1d 23 00 00       	call   3b1c <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1848:	00 
    1849:	c7 04 24 42 46 00 00 	movl   $0x4642,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1887:	c7 44 24 04 54 44 00 	movl   $0x4454,0x4(%esp)
    188e:	00 
    188f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1896:	e8 81 22 00 00       	call   3b1c <printf>
        exit();
    ...
    18ae:	c7 44 24 04 6d 44 00 	movl   $0x446d,0x4(%esp)
    18b5:	00 
    18b6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18bd:	e8 5a 22 00 00       	call   3b1c <printf>
        exit();
  ...
  if(n != 40){
    ...
    18fc:	c7 44 24 04 d4 4f 00 	movl   $0x4fd4,0x4(%esp)
    1903:	00 
    1904:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    190b:	e8 0c 22 00 00       	call   3b1c <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1924:	79 19                	jns    193f <concreate+0x21a>
      printf(1, "fork failed\n");
    1926:	c7 44 24 04 0d 4d 00 	movl   $0x4d0d,0x4(%esp)
    192d:	00 
    192e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1935:	e8 e2 21 00 00       	call   3b1c <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1a0b:	c7 44 24 04 8a 44 00 	movl   $0x448a,0x4(%esp)
    1a12:	00 
    1a13:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a1a:	e8 fd 20 00 00       	call   3b1c <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1a30:	c7 44 24 04 98 44 00 	movl   $0x4498,0x4(%esp)
    1a37:	00 
    1a38:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a3f:	e8 d8 20 00 00       	call   3b1c <printf>

  unlink("x");
    1a44:	c7 04 24 25 47 00 00 	movl   $0x4725,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1a5c:	c7 44 24 04 0d 4d 00 	movl   $0x4d0d,0x4(%esp)
    1a63:	00 
    1a64:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a6b:	e8 ac 20 00 00       	call   3b1c <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1ab5:	00 
    1ab6:	c7 04 24 25 47 00 00 	movl   $0x4725,(%esp)
    ...
    1ad0:	75 16                	jne    1ae8 <linkunlink+0xc1>
      link("cat", "x");
    1ad2:	c7 44 24 04 25 47 00 	movl   $0x4725,0x4(%esp)
    1ad9:	00 
    1ada:	c7 04 24 a9 44 00 00 	movl   $0x44a9,(%esp)
    1ae1:	e8 05 1f 00 00       	call   39eb <link>
    1ae6:	eb 0c                	jmp    1af4 <linkunlink+0xcd>
    } else {
      unlink("x");
    1ae8:	c7 04 24 25 47 00 00 	movl   $0x4725,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1b07:	c7 44 24 04 ad 44 00 	movl   $0x44ad,0x4(%esp)
    1b0e:	00 
    1b0f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b16:	e8 01 20 00 00       	call   3b1c <printf>
...
bigdir(void)
{
  ...
  unlink("bd");
    1bfe:	c7 04 24 c9 44 00 00 	movl   $0x44c9,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1c51:	c7 44 24 04 f6 44 00 	movl   $0x44f6,0x4(%esp)
    1c58:	00 
    1c59:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c60:	e8 b7 1e 00 00       	call   3b1c <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1c75:	c7 44 24 04 0b 45 00 	movl   $0x450b,0x4(%esp)
    1c7c:	00 
    1c7d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1c84:	e8 93 1e 00 00       	call   3b1c <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1c97:	c7 44 24 04 16 45 00 	movl   $0x4516,0x4(%esp)
    1c9e:	00 
    1c9f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ca6:	e8 71 1e 00 00       	call   3b1c <printf>

  unlink("ff");
    1cab:	c7 04 24 9f 45 00 00 	movl   $0x459f,(%esp)
    1cb2:	e8 24 1d 00 00       	call   39db <unlink>
  if(mkdir("dd") != 0){
    1cb7:	c7 04 24 3c 46 00 00 	movl   $0x463c,(%esp)
    1cbe:	e8 30 1d 00 00       	call   39f3 <mkdir>
    1cc3:	85 c0                	test   %eax,%eax
    1cc5:	74 19                	je     1ce0 <subdir+0x50>
    printf(1, "subdir mkdir dd failed\n");
    1cc7:	c7 44 24 04 23 45 00 	movl   $0x4523,0x4(%esp)
    1cce:	00 
    1ccf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cd6:	e8 41 1e 00 00       	call   3b1c <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1ce7:	00 
    1ce8:	c7 04 24 75 45 00 00 	movl   $0x4575,(%esp)
  ...
  if(fd < 0){
    ...
    1cfa:	c7 44 24 04 3b 45 00 	movl   $0x453b,0x4(%esp)
    1d01:	00 
    1d02:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d09:	e8 0e 1e 00 00       	call   3b1c <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1d1a:	00 
    1d1b:	c7 44 24 04 9f 45 00 	movl   $0x459f,0x4(%esp)
    1d22:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1d8c:	00 
    1d8d:	c7 04 24 72 45 00 00 	movl   $0x4572,(%esp)
  ...
  if(fd < 0){
    ...
    1d9f:	c7 44 24 04 7b 45 00 	movl   $0x457b,0x4(%esp)
    1da6:	00 
    1da7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1dae:	e8 69 1d 00 00       	call   3b1c <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    1dbf:	00 
    1dc0:	c7 44 24 04 93 45 00 	movl   $0x4593,0x4(%esp)
    1dc7:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1ddf:	00 
    1de0:	c7 04 24 96 45 00 00 	movl   $0x4596,(%esp)
  ...
  if(fd < 0){
    ...
    1df2:	c7 44 24 04 a2 45 00 	movl   $0x45a2,0x4(%esp)
    1df9:	00 
    1dfa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e01:	e8 16 1d 00 00       	call   3b1c <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e12:	00 
    1e13:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    1e1a:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e28:	80 3d 60 7d 00 00 66 	cmpb   $0x66,0x7d60
    1e2f:	74 19                	je     1e4a <subdir+0x1ba>
    printf(1, "dd/dd/../ff wrong content\n");
    1e31:	c7 44 24 04 bb 45 00 	movl   $0x45bb,0x4(%esp)
    1e38:	00 
    1e39:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e40:	e8 d7 1c 00 00       	call   3b1c <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1f88:	00 
    1f89:	c7 04 24 d6 45 00 00 	movl   $0x45d6,(%esp)
  ...
  if(fd < 0){
    ...
    1f9b:	c7 44 24 04 57 46 00 	movl   $0x4657,0x4(%esp)
    1fa2:	00 
    1fa3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1faa:	e8 6d 1b 00 00       	call   3b1c <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1fbb:	00 
    1fbc:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    1fc3:	00 
    ...
    1fd1:	c7 44 24 04 6f 46 00 	movl   $0x466f,0x4(%esp)
    1fd8:	00 
    1fd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe0:	e8 37 1b 00 00       	call   3b1c <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    23ba:	c7 44 24 04 29 48 00 	movl   $0x4829,0x4(%esp)
    23c1:	00 
    23c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23c9:	e8 4e 17 00 00       	call   3b1c <printf>

  unlink("bigwrite");
    23ce:	c7 04 24 38 48 00 00 	movl   $0x4838,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    23eb:	00 
    23ec:	c7 04 24 38 48 00 00 	movl   $0x4838,(%esp)
    ...
    23fe:	c7 44 24 04 41 48 00 	movl   $0x4841,0x4(%esp)
    2405:	00 
    2406:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    240d:	e8 0a 17 00 00       	call   3b1c <printf>
      exit();
    ...
    241b:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    2422:	00 
    ...
    2437:	c7 44 24 04 59 48 00 	movl   $0x4859,0x4(%esp)
    243e:	00 
    243f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2446:	e8 d1 16 00 00       	call   3b1c <printf>
        exit();
    ...
    unlink("bigwrite");
    2467:	c7 04 24 38 48 00 00 	movl   $0x4838,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    2485:	c7 44 24 04 6b 48 00 	movl   $0x486b,0x4(%esp)
    248c:	00 
    248d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2494:	e8 83 16 00 00       	call   3b1c <printf>
}
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    24aa:	c7 44 24 04 78 48 00 	movl   $0x4878,0x4(%esp)
    24b1:	00 
    24b2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24b9:	e8 5e 16 00 00       	call   3b1c <printf>

  unlink("bigfile");
    24be:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    24c5:	e8 11 15 00 00       	call   39db <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    24ca:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    24d1:	00 
    24d2:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
  ...
  if(fd < 0){
    ...
    24e4:	c7 44 24 04 86 48 00 	movl   $0x4886,0x4(%esp)
    24eb:	00 
    24ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    24f3:	e8 24 16 00 00       	call   3b1c <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2509:	c7 04 24 60 7d 00 00 	movl   $0x7d60,(%esp)
    2510:	e8 33 13 00 00       	call   3848 <memset>
    if(write(fd, buf, 600) != 600){
    2515:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    251c:	00 
    251d:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    2524:	00 
    ...
    2534:	c7 44 24 04 9c 48 00 	movl   $0x489c,0x4(%esp)
    253b:	00 
    253c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2543:	e8 d4 15 00 00       	call   3b1c <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    256b:	00 
    256c:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
  ...
  if(fd < 0){
    ...
    257e:	c7 44 24 04 b2 48 00 	movl   $0x48b2,0x4(%esp)
    2585:	00 
    2586:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    258d:	e8 8a 15 00 00       	call   3b1c <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    25a8:	00 
    25a9:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    25b0:	00 
    ...
    25bd:	c7 44 24 04 c7 48 00 	movl   $0x48c7,0x4(%esp)
    25c4:	00 
    25c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25cc:	e8 4b 15 00 00       	call   3b1c <printf>
      exit();
    ...
    25e1:	c7 44 24 04 dc 48 00 	movl   $0x48dc,0x4(%esp)
    25e8:	00 
    25e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    25f0:	e8 27 15 00 00       	call   3b1c <printf>
      exit();
    25f5:	e8 91 13 00 00       	call   398b <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    25fa:	0f be 0d 60 7d 00 00 	movsbl 0x7d60,%ecx
    ...
    260e:	0f be 0d 8b 7e 00 00 	movsbl 0x7e8b,%ecx
    2615:	39 ca                	cmp    %ecx,%edx
    2617:	74 19                	je     2632 <bigfile+0x191>
      printf(1, "read bigfile wrong data\n");
    2619:	c7 44 24 04 f0 48 00 	movl   $0x48f0,0x4(%esp)
    2620:	00 
    2621:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2628:	e8 ef 14 00 00       	call   3b1c <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    264c:	c7 44 24 04 09 49 00 	movl   $0x4909,0x4(%esp)
    2653:	00 
    2654:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    265b:	e8 bc 14 00 00       	call   3b1c <printf>
    exit();
    2660:	e8 26 13 00 00       	call   398b <exit>
  }
  unlink("bigfile");
    2665:	c7 04 24 94 48 00 00 	movl   $0x4894,(%esp)
    266c:	e8 6a 13 00 00       	call   39db <unlink>

  printf(1, "bigfile test ok\n");
    2671:	c7 44 24 04 23 49 00 	movl   $0x4923,0x4(%esp)
    2678:	00 
    2679:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2680:	e8 97 14 00 00       	call   3b1c <printf>
}
...
dirfile(void)
{
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2b39:	c7 44 24 04 05 4b 00 	movl   $0x4b05,0x4(%esp)
    2b40:	00 
    2b41:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b48:	e8 cf 0f 00 00       	call   3b1c <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2b5a:	c7 44 24 04 19 4b 00 	movl   $0x4b19,0x4(%esp)
    2b61:	00 
    2b62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b69:	e8 ae 0f 00 00       	call   3b1c <printf>
}
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2b7b:	c7 44 24 04 29 4b 00 	movl   $0x4b29,0x4(%esp)
    2b82:	00 
    2b83:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2b8a:	e8 8d 0f 00 00       	call   3b1c <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2c32:	00 
    2c33:	c7 04 24 24 47 00 00 	movl   $0x4724,(%esp)
    ...
    unlink("xx");
    2c4b:	c7 04 24 24 47 00 00 	movl   $0x4724,(%esp)
  ...
  chdir("/");
    2c63:	c7 04 24 15 3e 00 00 	movl   $0x3e15,(%esp)
    2c6a:	e8 8c 0d 00 00       	call   39fb <chdir>
  printf(1, "empty file name OK\n");
    2c6f:	c7 44 24 04 68 4b 00 	movl   $0x4b68,0x4(%esp)
    2c76:	00 
    2c77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c7e:	e8 99 0e 00 00       	call   3b1c <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2c90:	c7 44 24 04 7c 4b 00 	movl   $0x4b7c,0x4(%esp)
    2c97:	00 
    2c98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c9f:	e8 78 0e 00 00       	call   3b1c <printf>
  ...
  if(n == 1000){
    ...
    2cd0:	c7 44 24 04 1c 53 00 	movl   $0x531c,0x4(%esp)
    2cd7:	00 
    2cd8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cdf:	e8 38 0e 00 00       	call   3b1c <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    2cf2:	c7 44 24 04 87 4b 00 	movl   $0x4b87,0x4(%esp)
    2cf9:	00 
    2cfa:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d01:	e8 16 0e 00 00       	call   3b1c <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    2d1c:	c7 44 24 04 9b 4b 00 	movl   $0x4b9b,0x4(%esp)
    2d23:	00 
    2d24:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d2b:	e8 ec 0d 00 00       	call   3b1c <printf>
    exit();
    2d30:	e8 56 0c 00 00       	call   398b <exit>
  }

  printf(1, "fork test OK\n");
    2d35:	c7 44 24 04 ae 4b 00 	movl   $0x4bae,0x4(%esp)
    2d3c:	00 
    2d3d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d44:	e8 d3 0d 00 00       	call   3b1c <printf>
}
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2d58:	c7 44 24 04 bc 4b 00 	movl   $0x4bbc,0x4(%esp)
    2d5f:	00 
    2d60:	a1 80 55 00 00       	mov    0x5580,%eax
    2d65:	89 04 24             	mov    %eax,(%esp)
    2d68:	e8 af 0d 00 00       	call   3b1c <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    2dac:	c7 44 24 04 c7 4b 00 	movl   $0x4bc7,0x4(%esp)
    2db3:	00 
    2db4:	a1 80 55 00 00       	mov    0x5580,%eax
    2db9:	89 04 24             	mov    %eax,(%esp)
    2dbc:	e8 5b 0d 00 00       	call   3b1c <printf>
      exit();
  ...
  if(pid < 0){
    ...
    2de2:	c7 44 24 04 e2 4b 00 	movl   $0x4be2,0x4(%esp)
    2de9:	00 
    2dea:	a1 80 55 00 00       	mov    0x5580,%eax
    2def:	89 04 24             	mov    %eax,(%esp)
    2df2:	e8 25 0d 00 00       	call   3b1c <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    2e1b:	c7 44 24 04 f9 4b 00 	movl   $0x4bf9,0x4(%esp)
    2e22:	00 
    2e23:	a1 80 55 00 00       	mov    0x5580,%eax
    2e28:	89 04 24             	mov    %eax,(%esp)
    2e2b:	e8 ec 0c 00 00       	call   3b1c <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    2e66:	c7 44 24 04 40 53 00 	movl   $0x5340,0x4(%esp)
    2e6d:	00 
    2e6e:	a1 80 55 00 00       	mov    0x5580,%eax
    2e73:	89 04 24             	mov    %eax,(%esp)
    2e76:	e8 a1 0c 00 00       	call   3b1c <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    2ea6:	c7 44 24 04 15 4c 00 	movl   $0x4c15,0x4(%esp)
    2ead:	00 
    2eae:	a1 80 55 00 00       	mov    0x5580,%eax
    2eb3:	89 04 24             	mov    %eax,(%esp)
    2eb6:	e8 61 0c 00 00       	call   3b1c <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    2ede:	c7 44 24 04 80 53 00 	movl   $0x5380,0x4(%esp)
    2ee5:	00 
    2ee6:	a1 80 55 00 00       	mov    0x5580,%eax
    2eeb:	89 04 24             	mov    %eax,(%esp)
    2eee:	e8 29 0c 00 00       	call   3b1c <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2f36:	c7 44 24 04 b8 53 00 	movl   $0x53b8,0x4(%esp)
    2f3d:	00 
    2f3e:	a1 80 55 00 00       	mov    0x5580,%eax
    2f43:	89 04 24             	mov    %eax,(%esp)
    2f46:	e8 d1 0b 00 00       	call   3b1c <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    2f59:	c7 44 24 04 e0 53 00 	movl   $0x53e0,0x4(%esp)
    2f60:	00 
    2f61:	a1 80 55 00 00       	mov    0x5580,%eax
    2f66:	89 04 24             	mov    %eax,(%esp)
    2f69:	e8 ae 0b 00 00       	call   3b1c <printf>
    exit();
  ...
  if(c != a){
    ...
    2fa9:	c7 44 24 04 10 54 00 	movl   $0x5410,0x4(%esp)
    2fb0:	00 
    2fb1:	a1 80 55 00 00       	mov    0x5580,%eax
    2fb6:	89 04 24             	mov    %eax,(%esp)
    2fb9:	e8 5e 0b 00 00       	call   3b1c <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2fd1:	79 1a                	jns    2fed <sbrktest+0x29e>
      printf(stdout, "fork failed\n");
    2fd3:	c7 44 24 04 0d 4d 00 	movl   $0x4d0d,0x4(%esp)
    2fda:	00 
    2fdb:	a1 80 55 00 00       	mov    0x5580,%eax
    2fe0:	89 04 24             	mov    %eax,(%esp)
    2fe3:	e8 34 0b 00 00       	call   3b1c <printf>
      exit();
    ...
    2ffc:	c7 44 24 04 30 4c 00 	movl   $0x4c30,0x4(%esp)
    3003:	00 
    3004:	a1 80 55 00 00       	mov    0x5580,%eax
    3009:	89 04 24             	mov    %eax,(%esp)
    300c:	e8 0b 0b 00 00       	call   3b1c <printf>
      kill(ppid);
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    304b:	c7 44 24 04 05 41 00 	movl   $0x4105,0x4(%esp)
    3052:	00 
    3053:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    305a:	e8 bd 0a 00 00       	call   3b1c <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    3093:	00 
    3094:	c7 44 24 04 25 47 00 	movl   $0x4725,0x4(%esp)
    309b:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    311b:	c7 44 24 04 49 4c 00 	movl   $0x4c49,0x4(%esp)
    3122:	00 
    3123:	a1 80 55 00 00       	mov    0x5580,%eax
    3128:	89 04 24             	mov    %eax,(%esp)
    312b:	e8 ec 09 00 00       	call   3b1c <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    315b:	c7 44 24 04 64 4c 00 	movl   $0x4c64,0x4(%esp)
    3162:	00 
    3163:	a1 80 55 00 00       	mov    0x5580,%eax
    3168:	89 04 24             	mov    %eax,(%esp)
    316b:	e8 ac 09 00 00       	call   3b1c <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    3185:	c7 44 24 04 72 4c 00 	movl   $0x4c72,0x4(%esp)
    318c:	00 
    318d:	a1 80 55 00 00       	mov    0x5580,%eax
    3192:	89 04 24             	mov    %eax,(%esp)
    3195:	e8 82 09 00 00       	call   3b1c <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    31da:	c7 04 24 81 4c 00 00 	movl   $0x4c81,(%esp)
    31e1:	e8 05 08 00 00       	call   39eb <link>
    31e6:	83 f8 ff             	cmp    $0xffffffff,%eax
    31e9:	74 1a                	je     3205 <validatetest+0x88>
      printf(stdout, "link should not succeed\n");
    31eb:	c7 44 24 04 8c 4c 00 	movl   $0x4c8c,0x4(%esp)
    31f2:	00 
    31f3:	a1 80 55 00 00       	mov    0x5580,%eax
    31f8:	89 04 24             	mov    %eax,(%esp)
    31fb:	e8 1c 09 00 00       	call   3b1c <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    3213:	c7 44 24 04 a5 4c 00 	movl   $0x4ca5,0x4(%esp)
    321a:	00 
    321b:	a1 80 55 00 00       	mov    0x5580,%eax
    3220:	89 04 24             	mov    %eax,(%esp)
    3223:	e8 f4 08 00 00       	call   3b1c <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    3235:	c7 44 24 04 b2 4c 00 	movl   $0x4cb2,0x4(%esp)
    323c:	00 
    323d:	a1 80 55 00 00       	mov    0x5580,%eax
    3242:	89 04 24             	mov    %eax,(%esp)
    3245:	e8 d2 08 00 00       	call   3b1c <printf>
  for(i = 0; i < sizeof(uninit); i++){
    324a:	b8 00 00 00 00       	mov    $0x0,%eax
    324f:	eb 26                	jmp    3277 <bsstest+0x48>
    if(uninit[i] != '\0'){
    3251:	80 b8 40 56 00 00 00 	cmpb   $0x0,0x5640(%eax)
    3258:	74 1a                	je     3274 <bsstest+0x45>
      printf(stdout, "bss test failed\n");
    325a:	c7 44 24 04 bc 4c 00 	movl   $0x4cbc,0x4(%esp)
    3261:	00 
    3262:	a1 80 55 00 00       	mov    0x5580,%eax
    3267:	89 04 24             	mov    %eax,(%esp)
    326a:	e8 ad 08 00 00       	call   3b1c <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    327e:	c7 44 24 04 cd 4c 00 	movl   $0x4ccd,0x4(%esp)
    3285:	00 
    3286:	a1 80 55 00 00       	mov    0x5580,%eax
    328b:	89 04 24             	mov    %eax,(%esp)
    328e:	e8 89 08 00 00       	call   3b1c <printf>
}
    3293:	c9                   	leave  
    3294:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    329b:	c7 04 24 da 4c 00 00 	movl   $0x4cda,(%esp)
  ...
  if(pid == 0){
    ...
    32b6:	c7 04 85 a0 55 00 00 	movl   $0x5434,0x55a0(,%eax,4)
    32bd:	34 54 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    args[MAXARG-1] = 0;
    32d0:	c7 05 1c 56 00 00 00 	movl   $0x0,0x561c
    32d7:	00 00 00 
    printf(stdout, "bigarg test\n");
    32da:	c7 44 24 04 e4 4c 00 	movl   $0x4ce4,0x4(%esp)
    32e1:	00 
    32e2:	a1 80 55 00 00       	mov    0x5580,%eax
    32e7:	89 04 24             	mov    %eax,(%esp)
    32ea:	e8 2d 08 00 00       	call   3b1c <printf>
    exec("echo", args);
    32ef:	c7 44 24 04 a0 55 00 	movl   $0x55a0,0x4(%esp)
    32f6:	00 
    32f7:	c7 04 24 b1 3e 00 00 	movl   $0x3eb1,(%esp)
    32fe:	e8 c0 06 00 00       	call   39c3 <exec>
    printf(stdout, "bigarg test ok\n");
    3303:	c7 44 24 04 f1 4c 00 	movl   $0x4cf1,0x4(%esp)
    330a:	00 
    330b:	a1 80 55 00 00       	mov    0x5580,%eax
    3310:	89 04 24             	mov    %eax,(%esp)
    3313:	e8 04 08 00 00       	call   3b1c <printf>
    fd = open("bigarg-ok", O_CREATE);
    3318:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    331f:	00 
    3320:	c7 04 24 da 4c 00 00 	movl   $0x4cda,(%esp)
    ...
    333d:	c7 44 24 04 01 4d 00 	movl   $0x4d01,0x4(%esp)
    3344:	00 
    3345:	a1 80 55 00 00       	mov    0x5580,%eax
    334a:	89 04 24             	mov    %eax,(%esp)
    334d:	e8 ca 07 00 00       	call   3b1c <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3363:	00 
    3364:	c7 04 24 da 4c 00 00 	movl   $0x4cda,(%esp)
    336b:	e8 5b 06 00 00       	call   39cb <open>
  if(fd < 0){
    3370:	85 c0                	test   %eax,%eax
    3372:	79 1a                	jns    338e <bigargtest+0xf9>
    printf(stdout, "bigarg test failed!\n");
    3374:	c7 44 24 04 1a 4d 00 	movl   $0x4d1a,0x4(%esp)
    337b:	00 
    337c:	a1 80 55 00 00       	mov    0x5580,%eax
    3381:	89 04 24             	mov    %eax,(%esp)
    3384:	e8 93 07 00 00       	call   3b1c <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3396:	c7 04 24 da 4c 00 00 	movl   $0x4cda,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    33ad:	c7 44 24 04 2f 4d 00 	movl   $0x4d2f,0x4(%esp)
    33b4:	00 
    33b5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    33bc:	e8 5b 07 00 00       	call   3b1c <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    344e:	c7 44 24 04 3c 4d 00 	movl   $0x4d3c,0x4(%esp)
    3455:	00 
    3456:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    345d:	e8 ba 06 00 00       	call   3b1c <printf>
    ...
    3482:	c7 44 24 04 48 4d 00 	movl   $0x4d48,0x4(%esp)
    3489:	00 
    348a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3491:	e8 86 06 00 00       	call   3b1c <printf>
      break;
    ...
    34a7:	00 
    34a8:	c7 44 24 04 60 7d 00 	movl   $0x7d60,0x4(%esp)
    34af:	00 
    ...
    34c7:	c7 44 24 04 58 4d 00 	movl   $0x4d58,0x4(%esp)
    34ce:	00 
    34cf:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    34d6:	e8 41 06 00 00       	call   3b1c <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    358a:	c7 44 24 04 68 4d 00 	movl   $0x4d68,0x4(%esp)
    3591:	00 
    3592:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3599:	e8 7e 05 00 00       	call   3b1c <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    35ac:	c7 44 24 04 7e 4d 00 	movl   $0x4d7e,0x4(%esp)
    35b3:	00 
    35b4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35bb:	e8 5c 05 00 00       	call   3b1c <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    35d7:	c7 44 24 04 14 55 00 	movl   $0x5514,0x4(%esp)
    35de:	00 
    35df:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    35e6:	e8 31 05 00 00       	call   3b1c <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    35f4:	c7 44 24 04 0d 4d 00 	movl   $0x4d0d,0x4(%esp)
    35fb:	00 
    35fc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3603:	e8 14 05 00 00       	call   3b1c <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3612:	c7 44 24 04 88 4d 00 	movl   $0x4d88,0x4(%esp)
    3619:	00 
    361a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3621:	e8 f6 04 00 00       	call   3b1c <printf>
}
    3626:	c9                   	leave  
    3627:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3636:	00 
    3637:	c7 04 24 97 4d 00 00 	movl   $0x4d97,(%esp)
  ...
  if (fd < 0) {
    ...
    3649:	c7 44 24 04 9c 4d 00 	movl   $0x4d9c,0x4(%esp)
    3650:	00 
    3651:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3658:	e8 bf 04 00 00       	call   3b1c <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    368d:	c7 44 24 04 a9 4d 00 	movl   $0x4da9,0x4(%esp)
    3694:	00 
    3695:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    369c:	e8 7b 04 00 00       	call   3b1c <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    36aa:	69 05 7c 55 00 00 0d 	imul   $0x19660d,0x557c,%eax
    36b1:	66 19 00 
    36b4:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    36b9:	a3 7c 55 00 00       	mov    %eax,0x557c
  return randstate;
}
    36be:	5d                   	pop    %ebp
    36bf:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3715:	00 
    3716:	c7 04 24 ce 4d 00 00 	movl   $0x4dce,(%esp)
...
00003a53 <getprocessesinfo>:
SYSCALL(getprocessesinfo)
    3a53:	b8 1b 00 00 00       	mov    $0x1b,%eax
    3a58:	cd 40                	int    $0x40
    3a5a:	c3                   	ret    

00003a5b <getpagetableentry>:
SYSCALL(getpagetableentry)
    3a5b:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3a60:	cd 40                	int    $0x40
    3a62:	c3                   	ret    

00003a63 <isphysicalpagefree>:
SYSCALL(isphysicalpagefree)
    3a63:	b8 1d 00 00 00       	mov    $0x1d,%eax
    3a68:	cd 40                	int    $0x40
    3a6a:	c3                   	ret    

00003a6b <dumppagetable>:
    3a6b:	b8 1e 00 00 00       	mov    $0x1e,%eax
    3a70:	cd 40                	int    $0x40
    3a72:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    3a83:	83 ec 18             	sub    $0x18,%esp
    3a86:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
    3a89:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3a90:	00 
    3a91:	8d 55 f4             	lea    -0xc(%ebp),%edx
    3a94:	89 54 24 04          	mov    %edx,0x4(%esp)
    3a98:	89 04 24             	mov    %eax,(%esp)
    3a9b:	e8 0b ff ff ff       	call   39ab <write>
}
    3aa0:	c9                   	leave  
    3aa1:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3aa6:	56                   	push   %esi
    3aa7:	53                   	push   %ebx
    3aa8:	83 ec 2c             	sub    $0x2c,%esp
    3aab:	89 c7                	mov    %eax,%edi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    3aad:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    3ab1:	0f 95 c3             	setne  %bl
    3ab4:	89 d0                	mov    %edx,%eax
    3ab6:	c1 e8 1f             	shr    $0x1f,%eax
    3ab9:	84 c3                	test   %al,%bl
    3abb:	74 0b                	je     3ac8 <printint+0x26>
    neg = 1;
    x = -xx;
    3abd:	f7 da                	neg    %edx
    neg = 1;
    3abf:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
    3ac6:	eb 07                	jmp    3acf <printint+0x2d>
  neg = 0;
    3ac8:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    3acf:	be 00 00 00 00       	mov    $0x0,%esi
  do{
    buf[i++] = digits[x % base];
    3ad4:	8d 5e 01             	lea    0x1(%esi),%ebx
    3ad7:	89 d0                	mov    %edx,%eax
    3ad9:	ba 00 00 00 00       	mov    $0x0,%edx
    3ade:	f7 f1                	div    %ecx
    3ae0:	0f b6 92 6b 55 00 00 	movzbl 0x556b(%edx),%edx
    3ae7:	88 54 35 d8          	mov    %dl,-0x28(%ebp,%esi,1)
  }while((x /= base) != 0);
    3aeb:	89 c2                	mov    %eax,%edx
    buf[i++] = digits[x % base];
    3aed:	89 de                	mov    %ebx,%esi
  }while((x /= base) != 0);
    3aef:	85 c0                	test   %eax,%eax
    3af1:	75 e1                	jne    3ad4 <printint+0x32>
  if(neg)
    3af3:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    3af7:	74 16                	je     3b0f <printint+0x6d>
    buf[i++] = '-';
    3af9:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    3afe:	8d 5b 01             	lea    0x1(%ebx),%ebx
    3b01:	eb 0c                	jmp    3b0f <printint+0x6d>

  while(--i >= 0)
    putc(fd, buf[i]);
    3b03:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    3b08:	89 f8                	mov    %edi,%eax
    3b0a:	e8 71 ff ff ff       	call   3a80 <putc>
  while(--i >= 0)
    3b0f:	83 eb 01             	sub    $0x1,%ebx
    3b12:	79 ef                	jns    3b03 <printint+0x61>
}
    3b14:	83 c4 2c             	add    $0x2c,%esp
    3b17:	5b                   	pop    %ebx
    3b18:	5e                   	pop    %esi
    3b19:	5f                   	pop    %edi
    3b1a:	5d                   	pop    %ebp
...
printf(int fd, const char *fmt, ...)
{
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3b25:	8d 45 10             	lea    0x10(%ebp),%eax
    3b28:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    3b2b:	bf 00 00 00 00       	mov    $0x0,%edi
  for(i = 0; fmt[i]; i++){
    3b30:	be 00 00 00 00       	mov    $0x0,%esi
    3b35:	e9 23 01 00 00       	jmp    3c5d <printf+0x141>
    c = fmt[i] & 0xff;
    3b3a:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    3b3d:	85 ff                	test   %edi,%edi
    3b3f:	75 19                	jne    3b5a <printf+0x3e>
      if(c == '%'){
    3b41:	83 f8 25             	cmp    $0x25,%eax
    3b44:	0f 84 0b 01 00 00    	je     3c55 <printf+0x139>
        state = '%';
      } else {
        putc(fd, c);
    3b4a:	0f be d3             	movsbl %bl,%edx
    3b4d:	8b 45 08             	mov    0x8(%ebp),%eax
    3b50:	e8 2b ff ff ff       	call   3a80 <putc>
    3b55:	e9 00 01 00 00       	jmp    3c5a <printf+0x13e>
      }
    } else if(state == '%'){
    3b5a:	83 ff 25             	cmp    $0x25,%edi
    3b5d:	0f 85 f7 00 00 00    	jne    3c5a <printf+0x13e>
      if(c == 'd'){
    3b63:	83 f8 64             	cmp    $0x64,%eax
    3b66:	75 26                	jne    3b8e <printf+0x72>
        printint(fd, *ap, 10, 1);
    3b68:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3b6b:	8b 10                	mov    (%eax),%edx
    3b6d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b74:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3b79:	8b 45 08             	mov    0x8(%ebp),%eax
    3b7c:	e8 21 ff ff ff       	call   3aa2 <printint>
        ap++;
    3b81:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
      } else {
      ...
      state = 0;
    3b85:	66 bf 00 00          	mov    $0x0,%di
    3b89:	e9 cc 00 00 00       	jmp    3c5a <printf+0x13e>
      } else if(c == 'x' || c == 'p'){
    3b8e:	83 f8 78             	cmp    $0x78,%eax
    3b91:	0f 94 c1             	sete   %cl
    3b94:	83 f8 70             	cmp    $0x70,%eax
    3b97:	0f 94 c2             	sete   %dl
    3b9a:	08 d1                	or     %dl,%cl
    3b9c:	74 27                	je     3bc5 <printf+0xa9>
        printint(fd, *ap, 16, 0);
    3b9e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3ba1:	8b 10                	mov    (%eax),%edx
    3ba3:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3baa:	b9 10 00 00 00       	mov    $0x10,%ecx
    3baf:	8b 45 08             	mov    0x8(%ebp),%eax
    3bb2:	e8 eb fe ff ff       	call   3aa2 <printint>
        ap++;
    3bb7:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
      state = 0;
    3bbb:	bf 00 00 00 00       	mov    $0x0,%edi
    3bc0:	e9 95 00 00 00       	jmp    3c5a <printf+0x13e>
      } else if(c == 's'){
    3bc5:	83 f8 73             	cmp    $0x73,%eax
    3bc8:	75 37                	jne    3c01 <printf+0xe5>
        s = (char*)*ap;
    3bca:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3bcd:	8b 18                	mov    (%eax),%ebx
        ap++;
    3bcf:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
        if(s == 0)
    3bd3:	85 db                	test   %ebx,%ebx
    3bd5:	75 19                	jne    3bf0 <printf+0xd4>
          s = "(null)";
    3bd7:	bb 64 55 00 00       	mov    $0x5564,%ebx
    3bdc:	8b 7d 08             	mov    0x8(%ebp),%edi
    3bdf:	eb 12                	jmp    3bf3 <printf+0xd7>
          putc(fd, *s);
    3be1:	0f be d2             	movsbl %dl,%edx
    3be4:	89 f8                	mov    %edi,%eax
    3be6:	e8 95 fe ff ff       	call   3a80 <putc>
          s++;
    3beb:	83 c3 01             	add    $0x1,%ebx
    3bee:	eb 03                	jmp    3bf3 <printf+0xd7>
    3bf0:	8b 7d 08             	mov    0x8(%ebp),%edi
        while(*s != 0){
    3bf3:	0f b6 13             	movzbl (%ebx),%edx
    3bf6:	84 d2                	test   %dl,%dl
    3bf8:	75 e7                	jne    3be1 <printf+0xc5>
      state = 0;
    3bfa:	bf 00 00 00 00       	mov    $0x0,%edi
    3bff:	eb 59                	jmp    3c5a <printf+0x13e>
      } else if(c == 'c'){
    3c01:	83 f8 63             	cmp    $0x63,%eax
    3c04:	75 19                	jne    3c1f <printf+0x103>
        putc(fd, *ap);
    3c06:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3c09:	0f be 10             	movsbl (%eax),%edx
    3c0c:	8b 45 08             	mov    0x8(%ebp),%eax
    3c0f:	e8 6c fe ff ff       	call   3a80 <putc>
        ap++;
    3c14:	83 45 e4 04          	addl   $0x4,-0x1c(%ebp)
      state = 0;
    3c18:	bf 00 00 00 00       	mov    $0x0,%edi
    3c1d:	eb 3b                	jmp    3c5a <printf+0x13e>
      } else if(c == '%'){
    3c1f:	83 f8 25             	cmp    $0x25,%eax
    3c22:	75 12                	jne    3c36 <printf+0x11a>
        putc(fd, c);
    3c24:	0f be d3             	movsbl %bl,%edx
    3c27:	8b 45 08             	mov    0x8(%ebp),%eax
    3c2a:	e8 51 fe ff ff       	call   3a80 <putc>
      state = 0;
    3c2f:	bf 00 00 00 00       	mov    $0x0,%edi
    3c34:	eb 24                	jmp    3c5a <printf+0x13e>
        putc(fd, '%');
    3c36:	ba 25 00 00 00       	mov    $0x25,%edx
    3c3b:	8b 45 08             	mov    0x8(%ebp),%eax
    3c3e:	e8 3d fe ff ff       	call   3a80 <putc>
        putc(fd, c);
    3c43:	0f be d3             	movsbl %bl,%edx
    3c46:	8b 45 08             	mov    0x8(%ebp),%eax
    3c49:	e8 32 fe ff ff       	call   3a80 <putc>
      state = 0;
    3c4e:	bf 00 00 00 00       	mov    $0x0,%edi
    3c53:	eb 05                	jmp    3c5a <printf+0x13e>
        state = '%';
    3c55:	bf 25 00 00 00       	mov    $0x25,%edi
  for(i = 0; fmt[i]; i++){
    3c5a:	83 c6 01             	add    $0x1,%esi
    3c5d:	89 f0                	mov    %esi,%eax
    3c5f:	03 45 0c             	add    0xc(%ebp),%eax
    3c62:	0f b6 18             	movzbl (%eax),%ebx
    3c65:	84 db                	test   %bl,%bl
    3c67:	0f 85 cd fe ff ff    	jne    3b3a <printf+0x1e>
    }
  }
}
    3c6d:	83 c4 1c             	add    $0x1c,%esp
    3c70:	5b                   	pop    %ebx
    3c71:	5e                   	pop    %esi
    3c72:	5f                   	pop    %edi
    3c73:	5d                   	pop    %ebp
    3c74:	c3                   	ret    
    3c75:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
    ...
    3c84:	56                   	push   %esi
    3c85:	53                   	push   %ebx
    3c86:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
    3c89:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c8c:	a1 20 56 00 00       	mov    0x5620,%eax
    3c91:	eb 15                	jmp    3ca8 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3c93:	8b 10                	mov    (%eax),%edx
    3c95:	39 c2                	cmp    %eax,%edx
    3c97:	77 0d                	ja     3ca6 <free+0x26>
    3c99:	39 c1                	cmp    %eax,%ecx
    3c9b:	77 15                	ja     3cb2 <free+0x32>
    3c9d:	39 d1                	cmp    %edx,%ecx
    3c9f:	90                   	nop
    3ca0:	72 10                	jb     3cb2 <free+0x32>
    3ca2:	89 d0                	mov    %edx,%eax
    3ca4:	eb 02                	jmp    3ca8 <free+0x28>
    3ca6:	89 d0                	mov    %edx,%eax
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3ca8:	39 c1                	cmp    %eax,%ecx
    3caa:	76 e7                	jbe    3c93 <free+0x13>
    3cac:	39 08                	cmp    %ecx,(%eax)
    3cae:	66 90                	xchg   %ax,%ax
    3cb0:	76 e1                	jbe    3c93 <free+0x13>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3cb2:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3cb5:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3cb8:	8b 10                	mov    (%eax),%edx
    3cba:	39 d7                	cmp    %edx,%edi
    3cbc:	75 0f                	jne    3ccd <free+0x4d>
    bp->s.size += p->s.ptr->s.size;
    3cbe:	03 72 04             	add    0x4(%edx),%esi
    3cc1:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3cc4:	8b 10                	mov    (%eax),%edx
    3cc6:	8b 12                	mov    (%edx),%edx
    3cc8:	89 53 f8             	mov    %edx,-0x8(%ebx)
    3ccb:	eb 03                	jmp    3cd0 <free+0x50>
  } else
    bp->s.ptr = p->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    3cd6:	39 ce                	cmp    %ecx,%esi
    3cd8:	75 0d                	jne    3ce7 <free+0x67>
    p->s.size += bp->s.size;
    3cda:	03 53 fc             	add    -0x4(%ebx),%edx
    3cdd:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3ce0:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3ce3:	89 10                	mov    %edx,(%eax)
    3ce5:	eb 02                	jmp    3ce9 <free+0x69>
  } else
    p->s.ptr = bp;
    3ce7:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3ce9:	a3 20 56 00 00       	mov    %eax,0x5620
}
    3cee:	5b                   	pop    %ebx
    3cef:	5e                   	pop    %esi
    3cf0:	5f                   	pop    %edi
...
morecore(uint nu)
{
    ...
    3cf6:	53                   	push   %ebx
    3cf7:	83 ec 14             	sub    $0x14,%esp
    3cfa:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
    3cfc:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    3d01:	77 05                	ja     3d08 <morecore+0x15>
    nu = 4096;
    3d03:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
    3d08:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3d0f:	89 04 24             	mov    %eax,(%esp)
    3d12:	e8 fc fc ff ff       	call   3a13 <sbrk>
  if(p == (char*)-1)
    3d17:	83 f8 ff             	cmp    $0xffffffff,%eax
    3d1a:	74 15                	je     3d31 <morecore+0x3e>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3d1c:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3d1f:	83 c0 08             	add    $0x8,%eax
    3d22:	89 04 24             	mov    %eax,(%esp)
    3d25:	e8 56 ff ff ff       	call   3c80 <free>
  return freep;
    3d2a:	a1 20 56 00 00       	mov    0x5620,%eax
    3d2f:	eb 05                	jmp    3d36 <morecore+0x43>
    return 0;
    3d31:	b8 00 00 00 00       	mov    $0x0,%eax
}
    3d36:	83 c4 14             	add    $0x14,%esp
    3d39:	5b                   	pop    %ebx
    3d3a:	5d                   	pop    %ebp
    3d3b:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    3d46:	8d 58 07             	lea    0x7(%eax),%ebx
    3d49:	c1 eb 03             	shr    $0x3,%ebx
    3d4c:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    3d4f:	8b 0d 20 56 00 00    	mov    0x5620,%ecx
    3d55:	85 c9                	test   %ecx,%ecx
    3d57:	75 23                	jne    3d7c <malloc+0x40>
    base.s.ptr = freep = prevp = &base;
    3d59:	c7 05 20 56 00 00 24 	movl   $0x5624,0x5620
    3d60:	56 00 00 
    3d63:	c7 05 24 56 00 00 24 	movl   $0x5624,0x5624
    3d6a:	56 00 00 
    base.s.size = 0;
    3d6d:	c7 05 28 56 00 00 00 	movl   $0x0,0x5628
    3d74:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3d77:	b9 24 56 00 00       	mov    $0x5624,%ecx
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d7c:	8b 01                	mov    (%ecx),%eax
    if(p->s.size >= nunits){
    3d7e:	8b 50 04             	mov    0x4(%eax),%edx
    3d81:	39 da                	cmp    %ebx,%edx
    3d83:	72 20                	jb     3da5 <malloc+0x69>
      if(p->s.size == nunits)
    3d85:	39 d3                	cmp    %edx,%ebx
    3d87:	75 06                	jne    3d8f <malloc+0x53>
        prevp->s.ptr = p->s.ptr;
    3d89:	8b 10                	mov    (%eax),%edx
    3d8b:	89 11                	mov    %edx,(%ecx)
    3d8d:	eb 0b                	jmp    3d9a <malloc+0x5e>
      else {
        p->s.size -= nunits;
    3d8f:	29 da                	sub    %ebx,%edx
    3d91:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3d94:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3d97:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3d9a:	89 0d 20 56 00 00    	mov    %ecx,0x5620
      return (void*)(p + 1);
    3da0:	83 c0 08             	add    $0x8,%eax
    3da3:	eb 1e                	jmp    3dc3 <malloc+0x87>
    }
    if(p == freep)
    3da5:	3b 05 20 56 00 00    	cmp    0x5620,%eax
    3dab:	75 0b                	jne    3db8 <malloc+0x7c>
      if((p = morecore(nunits)) == 0)
    3dad:	89 d8                	mov    %ebx,%eax
    3daf:	e8 3f ff ff ff       	call   3cf3 <morecore>
    3db4:	85 c0                	test   %eax,%eax
    3db6:	74 06                	je     3dbe <malloc+0x82>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3db8:	89 c1                	mov    %eax,%ecx
    3dba:	8b 00                	mov    (%eax),%eax
        return 0;
  }
    3dbc:	eb c0                	jmp    3d7e <malloc+0x42>
        return 0;
    3dbe:	b8 00 00 00 00       	mov    $0x0,%eax
}
    3dc3:	83 c4 04             	add    $0x4,%esp
    3dc6:	5b                   	pop    %ebx
    3dc7:	5d                   	pop    %ebp
    3dc8:	c3                   	ret    
