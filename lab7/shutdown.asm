...
000000e0 <getprocessesinfo>:
SYSCALL(getprocessesinfo)
  e0:	b8 1b 00 00 00       	mov    $0x1b,%eax
  e5:	cd 40                	int    $0x40
  e7:	c3                   	ret    

000000e8 <getpagetableentry>:
SYSCALL(getpagetableentry)
  e8:	b8 1c 00 00 00       	mov    $0x1c,%eax
  ed:	cd 40                	int    $0x40
  ef:	c3                   	ret    

000000f0 <isphysicalpagefree>:
SYSCALL(isphysicalpagefree)
  f0:	b8 1d 00 00 00       	mov    $0x1d,%eax
  f5:	cd 40                	int    $0x40
  f7:	c3                   	ret    

000000f8 <dumppagetable>:
  f8:	b8 1e 00 00 00       	mov    $0x1e,%eax
  fd:	cd 40                	int    $0x40
  ff:	c3                   	ret    
