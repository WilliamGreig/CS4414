...
000000eb <settickets>:
SYSCALL(settickets)
  eb:	b8 1a 00 00 00       	mov    $0x1a,%eax
  f0:	cd 40                	int    $0x40
  f2:	c3                   	ret    

000000f3 <getprocessesinfo>:
SYSCALL(getprocessesinfo)
  f3:	b8 1b 00 00 00       	mov    $0x1b,%eax
  f8:	cd 40                	int    $0x40
  fa:	c3                   	ret    

000000fb <getpagetableentry>:
SYSCALL(getpagetableentry)
  fb:	b8 1c 00 00 00       	mov    $0x1c,%eax
 100:	cd 40                	int    $0x40
 102:	c3                   	ret    

00000103 <isphysicalpagefree>:
SYSCALL(isphysicalpagefree)
 103:	b8 1d 00 00 00       	mov    $0x1d,%eax
 108:	cd 40                	int    $0x40
 10a:	c3                   	ret    

0000010b <dumppagetable>:
 10b:	b8 1e 00 00 00       	mov    $0x1e,%eax
 110:	cd 40                	int    $0x40
 112:	c3                   	ret    
