...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
   ...
   e:	68 7c 0f 00 00       	push   $0xf7c
  13:	6a 02                	push   $0x2
  15:	e8 b2 0c 00 00       	call   ccc <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  54:	68 19 10 00 00       	push   $0x1019
  59:	6a 02                	push   $0x2
  5b:	e8 6c 0c 00 00       	call   ccc <printf>
  exit();
...
00000084 <runcmd>:
{
  ...
  99:	ff 24 85 34 10 00 00 	jmp    *0x1034(,%eax,4)
    exit();
  a0:	e8 b2 0a 00 00       	call   b57 <exit>
    panic("runcmd");
  a5:	83 ec 0c             	sub    $0xc,%esp
  a8:	68 84 0f 00 00       	push   $0xf84
  ...
  cc:	68 8b 0f 00 00       	push   $0xf8b
  d1:	6a 02                	push   $0x2
  d3:	e8 f4 0b 00 00       	call   ccc <printf>
    break;
 ...
 116:	68 9b 0f 00 00       	push   $0xf9b
 11b:	6a 02                	push   $0x2
 11d:	e8 aa 0b 00 00       	call   ccc <printf>
      exit();
...
execcmd(void)
{
 ...
 235:	e8 b8 0c 00 00       	call   ef2 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
 ...
 25d:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 260:	6a 18                	push   $0x18
 262:	e8 8b 0c 00 00       	call   ef2 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
 ...
 2a5:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2a8:	6a 0c                	push   $0xc
 2aa:	e8 43 0c 00 00       	call   ef2 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
 ...
 2db:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2de:	6a 0c                	push   $0xc
 2e0:	e8 0d 0c 00 00       	call   ef2 <malloc>
...
backcmd(struct cmd *subcmd)
{
 ...
 311:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 314:	6a 08                	push   $0x8
 316:	e8 d7 0b 00 00       	call   ef2 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
 ...
 360:	50                   	push   %eax
 361:	68 e0 10 00 00       	push   $0x10e0
 ...
 3d7:	50                   	push   %eax
 3d8:	68 e0 10 00 00       	push   $0x10e0
 ...
 3ef:	50                   	push   %eax
 3f0:	68 d8 10 00 00       	push   $0x10d8
 ...
 423:	50                   	push   %eax
 424:	68 e0 10 00 00       	push   $0x10e0
...
peek(char **ps, char *es, char *toks)
{
 ...
 464:	50                   	push   %eax
 465:	68 e0 10 00 00       	push   $0x10e0
...
00000758 <parseblock>:
{
 ...
 794:	68 0c 10 00 00       	push   $0x100c
 799:	56                   	push   %esi
 79a:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
 ...
 7f4:	ff 24 85 4c 10 00 00 	jmp    *0x104c(,%eax,4)
  case EXEC:
...
00000876 <parsecmd>:
{
 ...
 8c9:	50                   	push   %eax
 8ca:	68 0e 10 00 00       	push   $0x100e
 8cf:	6a 02                	push   $0x2
 8d1:	e8 f6 03 00 00       	call   ccc <printf>
    panic("syntax");
 8d6:	c7 04 24 d2 0f 00 00 	movl   $0xfd2,(%esp)
...
000008e2 <main>:
{
 ...
 8f6:	6a 02                	push   $0x2
 8f8:	68 1d 10 00 00       	push   $0x101d
 ...
 932:	68 00 11 00 00       	push   $0x1100
 937:	e8 c4 f6 ff ff       	call   0 <getcmd>
 93c:	83 c4 10             	add    $0x10,%esp
 93f:	85 c0                	test   %eax,%eax
 941:	78 70                	js     9b3 <main+0xd1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
 943:	80 3d 00 11 00 00 63 	cmpb   $0x63,0x1100
 94a:	75 d0                	jne    91c <main+0x3a>
 94c:	80 3d 01 11 00 00 64 	cmpb   $0x64,0x1101
 953:	75 c7                	jne    91c <main+0x3a>
 955:	80 3d 02 11 00 00 20 	cmpb   $0x20,0x1102
 95c:	75 be                	jne    91c <main+0x3a>
      buf[strlen(buf)-1] = 0;  // chop \n
 95e:	83 ec 0c             	sub    $0xc,%esp
 961:	68 00 11 00 00       	push   $0x1100
 966:	e8 99 00 00 00       	call   a04 <strlen>
 96b:	c6 80 ff 10 00 00 00 	movb   $0x0,0x10ff(%eax)
      if(chdir(buf+3) < 0)
 972:	c7 04 24 03 11 00 00 	movl   $0x1103,(%esp)
 ...
 988:	68 03 11 00 00       	push   $0x1103
 98d:	68 25 10 00 00       	push   $0x1025
 992:	6a 02                	push   $0x2
 994:	e8 33 03 00 00       	call   ccc <printf>
 999:	83 c4 10             	add    $0x10,%esp
      continue;
 99c:	eb 8c                	jmp    92a <main+0x48>
      runcmd(parsecmd(buf));
 99e:	83 ec 0c             	sub    $0xc,%esp
 9a1:	68 00 11 00 00       	push   $0x1100
...
00000c1f <getprocessesinfo>:
 c1f:	b8 1b 00 00 00       	mov    $0x1b,%eax
 c24:	cd 40                	int    $0x40
 c26:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 c2d:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 c30:	6a 01                	push   $0x1
 c32:	8d 55 f4             	lea    -0xc(%ebp),%edx
 c35:	52                   	push   %edx
 c36:	50                   	push   %eax
 c37:	e8 3b ff ff ff       	call   b77 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 c45:	56                   	push   %esi
 c46:	53                   	push   %ebx
 c47:	83 ec 2c             	sub    $0x2c,%esp
 c4a:	89 45 d0             	mov    %eax,-0x30(%ebp)
 c4d:	89 d0                	mov    %edx,%eax
 c4f:	89 ce                	mov    %ecx,%esi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
 c51:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 c55:	0f 95 c1             	setne  %cl
 c58:	c1 ea 1f             	shr    $0x1f,%edx
 c5b:	84 d1                	test   %dl,%cl
 c5d:	74 44                	je     ca3 <printint+0x62>
    neg = 1;
    x = -xx;
 c5f:	f7 d8                	neg    %eax
 c61:	89 c1                	mov    %eax,%ecx
    neg = 1;
 c63:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
 c6a:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
 ...
 c7d:	0f b6 92 c4 10 00 00 	movzbl 0x10c4(%edx),%edx
 c84:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 c88:	89 ca                	mov    %ecx,%edx
 c8a:	89 c1                	mov    %eax,%ecx
 c8c:	39 d6                	cmp    %edx,%esi
 c8e:	76 df                	jbe    c6f <printint+0x2e>
  if(neg)
 c90:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 c94:	74 31                	je     cc7 <printint+0x86>
    buf[i++] = '-';
 c96:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 c9b:	8d 5f 02             	lea    0x2(%edi),%ebx
 c9e:	8b 75 d0             	mov    -0x30(%ebp),%esi
 ca1:	eb 17                	jmp    cba <printint+0x79>
    x = xx;
 ca3:	89 c1                	mov    %eax,%ecx
  neg = 0;
 ca5:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 cac:	eb bc                	jmp    c6a <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
 cae:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 cb3:	89 f0                	mov    %esi,%eax
 cb5:	e8 6d ff ff ff       	call   c27 <putc>
  while(--i >= 0)
 cba:	83 eb 01             	sub    $0x1,%ebx
 cbd:	79 ef                	jns    cae <printint+0x6d>
}
 cbf:	83 c4 2c             	add    $0x2c,%esp
 cc2:	5b                   	pop    %ebx
 cc3:	5e                   	pop    %esi
 cc4:	5f                   	pop    %edi
 cc5:	5d                   	pop    %ebp
 cc6:	c3                   	ret    
 cc7:	8b 75 d0             	mov    -0x30(%ebp),%esi
 cca:	eb ee                	jmp    cba <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
 ...
 cd2:	83 ec 1c             	sub    $0x1c,%esp
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
 cd5:	8d 45 10             	lea    0x10(%ebp),%eax
 cd8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
 cdb:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
 ce0:	bb 00 00 00 00       	mov    $0x0,%ebx
 ce5:	eb 14                	jmp    cfb <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
 ce7:	89 fa                	mov    %edi,%edx
 ce9:	8b 45 08             	mov    0x8(%ebp),%eax
 cec:	e8 36 ff ff ff       	call   c27 <putc>
 cf1:	eb 05                	jmp    cf8 <printf+0x2c>
      }
    } else if(state == '%'){
 cf3:	83 fe 25             	cmp    $0x25,%esi
 cf6:	74 25                	je     d1d <printf+0x51>
  for(i = 0; fmt[i]; i++){
 cf8:	83 c3 01             	add    $0x1,%ebx
 cfb:	8b 45 0c             	mov    0xc(%ebp),%eax
 cfe:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 d02:	84 c0                	test   %al,%al
 d04:	0f 84 20 01 00 00    	je     e2a <printf+0x15e>
    c = fmt[i] & 0xff;
 d0a:	0f be f8             	movsbl %al,%edi
 d0d:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 d10:	85 f6                	test   %esi,%esi
 d12:	75 df                	jne    cf3 <printf+0x27>
      if(c == '%'){
 d14:	83 f8 25             	cmp    $0x25,%eax
 d17:	75 ce                	jne    ce7 <printf+0x1b>
        state = '%';
 d19:	89 c6                	mov    %eax,%esi
 d1b:	eb db                	jmp    cf8 <printf+0x2c>
      if(c == 'd'){
 d1d:	83 f8 25             	cmp    $0x25,%eax
 d20:	0f 84 cf 00 00 00    	je     df5 <printf+0x129>
 d26:	0f 8c dd 00 00 00    	jl     e09 <printf+0x13d>
 d2c:	83 f8 78             	cmp    $0x78,%eax
 d2f:	0f 8f d4 00 00 00    	jg     e09 <printf+0x13d>
 d35:	83 f8 63             	cmp    $0x63,%eax
 d38:	0f 8c cb 00 00 00    	jl     e09 <printf+0x13d>
 d3e:	83 e8 63             	sub    $0x63,%eax
 d41:	83 f8 15             	cmp    $0x15,%eax
 d44:	0f 87 bf 00 00 00    	ja     e09 <printf+0x13d>
 d4a:	ff 24 85 6c 10 00 00 	jmp    *0x106c(,%eax,4)
        printint(fd, *ap, 10, 1);
 d51:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d54:	8b 17                	mov    (%edi),%edx
 d56:	83 ec 0c             	sub    $0xc,%esp
 d59:	6a 01                	push   $0x1
 d5b:	b9 0a 00 00 00       	mov    $0xa,%ecx
 d60:	8b 45 08             	mov    0x8(%ebp),%eax
 d63:	e8 d9 fe ff ff       	call   c41 <printint>
        ap++;
 ...
 d76:	eb 80                	jmp    cf8 <printf+0x2c>
        printint(fd, *ap, 16, 0);
 d78:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d7b:	8b 17                	mov    (%edi),%edx
 d7d:	83 ec 0c             	sub    $0xc,%esp
 d80:	6a 00                	push   $0x0
 d82:	b9 10 00 00 00       	mov    $0x10,%ecx
 d87:	8b 45 08             	mov    0x8(%ebp),%eax
 d8a:	e8 b2 fe ff ff       	call   c41 <printint>
        ap++;
 d8f:	83 c7 04             	add    $0x4,%edi
 d92:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 d95:	83 c4 10             	add    $0x10,%esp
      state = 0;
 d98:	be 00 00 00 00       	mov    $0x0,%esi
 d9d:	e9 56 ff ff ff       	jmp    cf8 <printf+0x2c>
        s = (char*)*ap;
 da2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 da5:	8b 30                	mov    (%eax),%esi
        ap++;
 da7:	83 c0 04             	add    $0x4,%eax
 daa:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 dad:	85 f6                	test   %esi,%esi
 daf:	75 15                	jne    dc6 <printf+0xfa>
          s = "(null)";
 db1:	be 64 10 00 00       	mov    $0x1064,%esi
 db6:	eb 0e                	jmp    dc6 <printf+0xfa>
          putc(fd, *s);
 db8:	0f be d2             	movsbl %dl,%edx
 dbb:	8b 45 08             	mov    0x8(%ebp),%eax
 dbe:	e8 64 fe ff ff       	call   c27 <putc>
          s++;
 dc3:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 dc6:	0f b6 16             	movzbl (%esi),%edx
 dc9:	84 d2                	test   %dl,%dl
 dcb:	75 eb                	jne    db8 <printf+0xec>
      state = 0;
 dcd:	be 00 00 00 00       	mov    $0x0,%esi
 dd2:	e9 21 ff ff ff       	jmp    cf8 <printf+0x2c>
        putc(fd, *ap);
 dd7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 dda:	0f be 17             	movsbl (%edi),%edx
 ddd:	8b 45 08             	mov    0x8(%ebp),%eax
 de0:	e8 42 fe ff ff       	call   c27 <putc>
        ap++;
 de5:	83 c7 04             	add    $0x4,%edi
 de8:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 deb:	be 00 00 00 00       	mov    $0x0,%esi
 df0:	e9 03 ff ff ff       	jmp    cf8 <printf+0x2c>
        putc(fd, c);
 df5:	89 fa                	mov    %edi,%edx
 df7:	8b 45 08             	mov    0x8(%ebp),%eax
 dfa:	e8 28 fe ff ff       	call   c27 <putc>
      state = 0;
 dff:	be 00 00 00 00       	mov    $0x0,%esi
 e04:	e9 ef fe ff ff       	jmp    cf8 <printf+0x2c>
        putc(fd, '%');
 e09:	ba 25 00 00 00       	mov    $0x25,%edx
 e0e:	8b 45 08             	mov    0x8(%ebp),%eax
 e11:	e8 11 fe ff ff       	call   c27 <putc>
        putc(fd, c);
 e16:	89 fa                	mov    %edi,%edx
 e18:	8b 45 08             	mov    0x8(%ebp),%eax
 e1b:	e8 07 fe ff ff       	call   c27 <putc>
      state = 0;
 e20:	be 00 00 00 00       	mov    $0x0,%esi
 e25:	e9 ce fe ff ff       	jmp    cf8 <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
 ...
 e38:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  bp = (Header*)ap - 1;
 e3b:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 e3e:	a1 c8 11 00 00       	mov    0x11c8,%eax
 e43:	eb 02                	jmp    e47 <free+0x15>
 e45:	89 d0                	mov    %edx,%eax
 e47:	39 c8                	cmp    %ecx,%eax
 e49:	73 04                	jae    e4f <free+0x1d>
 e4b:	39 08                	cmp    %ecx,(%eax)
 e4d:	77 12                	ja     e61 <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 e4f:	8b 10                	mov    (%eax),%edx
 e51:	39 c2                	cmp    %eax,%edx
 e53:	77 f0                	ja     e45 <free+0x13>
 e55:	39 c8                	cmp    %ecx,%eax
 e57:	72 08                	jb     e61 <free+0x2f>
 e59:	39 ca                	cmp    %ecx,%edx
 e5b:	77 04                	ja     e61 <free+0x2f>
 e5d:	89 d0                	mov    %edx,%eax
 e5f:	eb e6                	jmp    e47 <free+0x15>
      break;
  if(bp + bp->s.size == p->s.ptr){
 e61:	8b 73 fc             	mov    -0x4(%ebx),%esi
 e64:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 e67:	8b 10                	mov    (%eax),%edx
 e69:	39 d7                	cmp    %edx,%edi
 e6b:	74 19                	je     e86 <free+0x54>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
 e6d:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
 e70:	8b 50 04             	mov    0x4(%eax),%edx
 e73:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 e76:	39 ce                	cmp    %ecx,%esi
 e78:	74 1b                	je     e95 <free+0x63>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
 e7a:	89 08                	mov    %ecx,(%eax)
  freep = p;
 e7c:	a3 c8 11 00 00       	mov    %eax,0x11c8
}
 e81:	5b                   	pop    %ebx
 e82:	5e                   	pop    %esi
 e83:	5f                   	pop    %edi
 ...
 e85:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
 e86:	03 72 04             	add    0x4(%edx),%esi
 e89:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
 e8c:	8b 10                	mov    (%eax),%edx
 e8e:	8b 12                	mov    (%edx),%edx
 e90:	89 53 f8             	mov    %edx,-0x8(%ebx)
 e93:	eb db                	jmp    e70 <free+0x3e>
    p->s.size += bp->s.size;
 e95:	03 53 fc             	add    -0x4(%ebx),%edx
 e98:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
 e9b:	8b 53 f8             	mov    -0x8(%ebx),%edx
 e9e:	89 10                	mov    %edx,(%eax)
 ea0:	eb da                	jmp    e7c <free+0x4a>
...
morecore(uint nu)
{
 ...
 ea9:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
 eab:	3d ff 0f 00 00       	cmp    $0xfff,%eax
 eb0:	77 05                	ja     eb7 <morecore+0x15>
    nu = 4096;
 eb2:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
 eb7:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 ebe:	83 ec 0c             	sub    $0xc,%esp
 ec1:	50                   	push   %eax
 ec2:	e8 18 fd ff ff       	call   bdf <sbrk>
  if(p == (char*)-1)
 ec7:	83 c4 10             	add    $0x10,%esp
 eca:	83 f8 ff             	cmp    $0xffffffff,%eax
 ecd:	74 1c                	je     eeb <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ecf:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
 ed2:	83 c0 08             	add    $0x8,%eax
 ed5:	83 ec 0c             	sub    $0xc,%esp
 ed8:	50                   	push   %eax
 ed9:	e8 54 ff ff ff       	call   e32 <free>
  return freep;
 ede:	a1 c8 11 00 00       	mov    0x11c8,%eax
 ...
 ef0:	eb f4                	jmp    ee6 <morecore+0x44>
...
malloc(uint nbytes)
{
 ...
 efc:	8d 58 07             	lea    0x7(%eax),%ebx
 eff:	c1 eb 03             	shr    $0x3,%ebx
 f02:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 f05:	8b 0d c8 11 00 00    	mov    0x11c8,%ecx
 f0b:	85 c9                	test   %ecx,%ecx
 f0d:	74 04                	je     f13 <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f0f:	8b 01                	mov    (%ecx),%eax
 f11:	eb 4a                	jmp    f5d <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 f13:	c7 05 c8 11 00 00 cc 	movl   $0x11cc,0x11c8
 f1a:	11 00 00 
 f1d:	c7 05 cc 11 00 00 cc 	movl   $0x11cc,0x11cc
 f24:	11 00 00 
    base.s.size = 0;
 f27:	c7 05 d0 11 00 00 00 	movl   $0x0,0x11d0
 f2e:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 f31:	b9 cc 11 00 00       	mov    $0x11cc,%ecx
 f36:	eb d7                	jmp    f0f <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 f38:	74 19                	je     f53 <malloc+0x61>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 f3a:	29 da                	sub    %ebx,%edx
 f3c:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 f3f:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
 f42:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
 f45:	89 0d c8 11 00 00    	mov    %ecx,0x11c8
      return (void*)(p + 1);
 ...
 f4e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 f51:	c9                   	leave  
 f52:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
 f53:	8b 10                	mov    (%eax),%edx
 f55:	89 11                	mov    %edx,(%ecx)
 f57:	eb ec                	jmp    f45 <malloc+0x53>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f59:	89 c1                	mov    %eax,%ecx
 f5b:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
 f5d:	8b 50 04             	mov    0x4(%eax),%edx
 f60:	39 da                	cmp    %ebx,%edx
 f62:	73 d4                	jae    f38 <malloc+0x46>
    if(p == freep)
 f64:	39 05 c8 11 00 00    	cmp    %eax,0x11c8
 f6a:	75 ed                	jne    f59 <malloc+0x67>
      if((p = morecore(nunits)) == 0)
 f6c:	89 d8                	mov    %ebx,%eax
 f6e:	e8 2f ff ff ff       	call   ea2 <morecore>
 f73:	85 c0                	test   %eax,%eax
 f75:	75 e2                	jne    f59 <malloc+0x67>
 f77:	eb d5                	jmp    f4e <malloc+0x5c>
