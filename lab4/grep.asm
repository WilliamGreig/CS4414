...
00000119 <grep>:
{
 ...
 170:	eb bc                	jmp    12e <grep+0x15>
    if(p == buf)
 172:	81 fe e0 07 00 00    	cmp    $0x7e0,%esi
 ...
 18e:	50                   	push   %eax
 18f:	8d 81 e0 07 00 00    	lea    0x7e0(%ecx),%eax
 195:	50                   	push   %eax
 ...
 1a8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    buf[m] = '\0';
 1ab:	c6 82 e0 07 00 00 00 	movb   $0x0,0x7e0(%edx)
    p = buf;
 1b2:	be e0 07 00 00       	mov    $0x7e0,%esi
    while((q = strchr(p, '\n')) != 0){
 1b7:	e9 75 ff ff ff       	jmp    131 <grep+0x18>
      m -= p - buf;
 1bc:	89 f0                	mov    %esi,%eax
 1be:	2d e0 07 00 00       	sub    $0x7e0,%eax
...
000001ed <main>:
{
 ...
 264:	68 1c 07 00 00       	push   $0x71c
 269:	6a 02                	push   $0x2
 26b:	e8 44 03 00 00       	call   5b4 <printf>
    exit();
 ...
 288:	ff 37                	push   (%edi)
 28a:	68 3c 07 00 00       	push   $0x73c
 28f:	6a 01                	push   $0x1
 291:	e8 1e 03 00 00       	call   5b4 <printf>
      exit();
...
putc(int fd, char c)
{
 ...
 515:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 518:	6a 01                	push   $0x1
 51a:	8d 55 f4             	lea    -0xc(%ebp),%edx
 51d:	52                   	push   %edx
 51e:	50                   	push   %eax
 51f:	e8 3b ff ff ff       	call   45f <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 537:	89 ce                	mov    %ecx,%esi
  ...
  neg = 0;
  if(sgn && xx < 0){
 539:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 53d:	0f 95 c1             	setne  %cl
 540:	c1 ea 1f             	shr    $0x1f,%edx
 543:	84 d1                	test   %dl,%cl
 545:	74 44                	je     58b <printint+0x62>
    neg = 1;
    x = -xx;
 547:	f7 d8                	neg    %eax
 549:	89 c1                	mov    %eax,%ecx
    neg = 1;
 54b:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }
 ...
 55e:	f7 f6                	div    %esi
 560:	89 df                	mov    %ebx,%edi
 562:	83 c3 01             	add    $0x1,%ebx
 565:	0f b6 92 b4 07 00 00 	movzbl 0x7b4(%edx),%edx
 56c:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 570:	89 ca                	mov    %ecx,%edx
 572:	89 c1                	mov    %eax,%ecx
 574:	39 d6                	cmp    %edx,%esi
 576:	76 df                	jbe    557 <printint+0x2e>
  if(neg)
 578:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 57c:	74 31                	je     5af <printint+0x86>
    buf[i++] = '-';
 57e:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 583:	8d 5f 02             	lea    0x2(%edi),%ebx
 586:	8b 75 d0             	mov    -0x30(%ebp),%esi
 589:	eb 17                	jmp    5a2 <printint+0x79>
    x = xx;
 58b:	89 c1                	mov    %eax,%ecx
  neg = 0;
 58d:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 594:	eb bc                	jmp    552 <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
 596:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 59b:	89 f0                	mov    %esi,%eax
 59d:	e8 6d ff ff ff       	call   50f <putc>
  while(--i >= 0)
 5a2:	83 eb 01             	sub    $0x1,%ebx
 5a5:	79 ef                	jns    596 <printint+0x6d>
}
 ...
 5ad:	5d                   	pop    %ebp
 5ae:	c3                   	ret    
 5af:	8b 75 d0             	mov    -0x30(%ebp),%esi
 5b2:	eb ee                	jmp    5a2 <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e8 36 ff ff ff       	call   50f <putc>
 ...
 5ec:	0f 84 20 01 00 00    	je     712 <printf+0x15e>
    c = fmt[i] & 0xff;
 ...
 608:	0f 84 cf 00 00 00    	je     6dd <printf+0x129>
 60e:	0f 8c dd 00 00 00    	jl     6f1 <printf+0x13d>
 614:	83 f8 78             	cmp    $0x78,%eax
 617:	0f 8f d4 00 00 00    	jg     6f1 <printf+0x13d>
 61d:	83 f8 63             	cmp    $0x63,%eax
 620:	0f 8c cb 00 00 00    	jl     6f1 <printf+0x13d>
 626:	83 e8 63             	sub    $0x63,%eax
 629:	83 f8 15             	cmp    $0x15,%eax
 62c:	0f 87 bf 00 00 00    	ja     6f1 <printf+0x13d>
 632:	ff 24 85 5c 07 00 00 	jmp    *0x75c(,%eax,4)
        printint(fd, *ap, 10, 1);
 639:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 63c:	8b 17                	mov    (%edi),%edx
 63e:	83 ec 0c             	sub    $0xc,%esp
 641:	6a 01                	push   $0x1
 643:	b9 0a 00 00 00       	mov    $0xa,%ecx
 648:	8b 45 08             	mov    0x8(%ebp),%eax
 64b:	e8 d9 fe ff ff       	call   529 <printint>
        ap++;
 ...
 656:	83 c4 10             	add    $0x10,%esp
      ...
      state = 0;
 659:	be 00 00 00 00       	mov    $0x0,%esi
 65e:	eb 80                	jmp    5e0 <printf+0x2c>
        printint(fd, *ap, 16, 0);
 ...
 672:	e8 b2 fe ff ff       	call   529 <printint>
        ap++;
 ...
 685:	e9 56 ff ff ff       	jmp    5e0 <printf+0x2c>
        s = (char*)*ap;
 68a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 68d:	8b 30                	mov    (%eax),%esi
        ap++;
 68f:	83 c0 04             	add    $0x4,%eax
 692:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 695:	85 f6                	test   %esi,%esi
 697:	75 15                	jne    6ae <printf+0xfa>
          s = "(null)";
 699:	be 52 07 00 00       	mov    $0x752,%esi
 69e:	eb 0e                	jmp    6ae <printf+0xfa>
          putc(fd, *s);
 6a0:	0f be d2             	movsbl %dl,%edx
 6a3:	8b 45 08             	mov    0x8(%ebp),%eax
 6a6:	e8 64 fe ff ff       	call   50f <putc>
          s++;
 6ab:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 6ae:	0f b6 16             	movzbl (%esi),%edx
 6b1:	84 d2                	test   %dl,%dl
 6b3:	75 eb                	jne    6a0 <printf+0xec>
      state = 0;
 6b5:	be 00 00 00 00       	mov    $0x0,%esi
 6ba:	e9 21 ff ff ff       	jmp    5e0 <printf+0x2c>
        putc(fd, *ap);
 6bf:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 6c2:	0f be 17             	movsbl (%edi),%edx
 6c5:	8b 45 08             	mov    0x8(%ebp),%eax
 6c8:	e8 42 fe ff ff       	call   50f <putc>
        ap++;
 6cd:	83 c7 04             	add    $0x4,%edi
 6d0:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 6d3:	be 00 00 00 00       	mov    $0x0,%esi
 6d8:	e9 03 ff ff ff       	jmp    5e0 <printf+0x2c>
        putc(fd, c);
 6dd:	89 fa                	mov    %edi,%edx
 6df:	8b 45 08             	mov    0x8(%ebp),%eax
 6e2:	e8 28 fe ff ff       	call   50f <putc>
      state = 0;
 6e7:	be 00 00 00 00       	mov    $0x0,%esi
 6ec:	e9 ef fe ff ff       	jmp    5e0 <printf+0x2c>
        putc(fd, '%');
 6f1:	ba 25 00 00 00       	mov    $0x25,%edx
 6f6:	8b 45 08             	mov    0x8(%ebp),%eax
 6f9:	e8 11 fe ff ff       	call   50f <putc>
        putc(fd, c);
 6fe:	89 fa                	mov    %edi,%edx
 700:	8b 45 08             	mov    0x8(%ebp),%eax
 703:	e8 07 fe ff ff       	call   50f <putc>
      state = 0;
 708:	be 00 00 00 00       	mov    $0x0,%esi
 70d:	e9 ce fe ff ff       	jmp    5e0 <printf+0x2c>
    }
  }
}
