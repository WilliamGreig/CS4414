...
80100046:	e8 be 3c 00 00       	call   80103d09 <acquire>
...
8010007c:	e8 ed 3c 00 00       	call   80103d6e <release>
      acquiresleep(&b->lock);
80100081:	8d 43 0c             	lea    0xc(%ebx),%eax
80100084:	89 04 24             	mov    %eax,(%esp)
80100087:	e8 69 3a 00 00       	call   80103af5 <acquiresleep>
      return b;
...
801000ca:	e8 9f 3c 00 00       	call   80103d6e <release>
      acquiresleep(&b->lock);
801000cf:	8d 43 0c             	lea    0xc(%ebx),%eax
801000d2:	89 04 24             	mov    %eax,(%esp)
801000d5:	e8 1b 3a 00 00       	call   80103af5 <acquiresleep>
      return b;
...
80100105:	e8 c3 3a 00 00       	call   80103bcd <initlock>
...
80100143:	e8 7a 39 00 00       	call   80103ac2 <initsleeplock>
...
801001a8:	e8 d2 39 00 00       	call   80103b7f <holdingsleep>
...
801001e4:	e8 96 39 00 00       	call   80103b7f <holdingsleep>
...
801001f4:	e8 4b 39 00 00       	call   80103b44 <releasesleep>

  acquire(&bcache.lock);
801001f9:	c7 04 24 20 a5 10 80 	movl   $0x8010a520,(%esp)
80100200:	e8 04 3b 00 00       	call   80103d09 <acquire>
  b->refcnt--;
...
8010024c:	e8 1d 3b 00 00       	call   80103d6e <release>
}
...
8010028a:	e8 7a 3a 00 00       	call   80103d09 <acquire>
  while(n > 0){
...
801002a5:	75 47                	jne    801002ee <consoleread+0x86>
      if(myproc()->killed){
801002a7:	e8 d9 2f 00 00       	call   80103285 <myproc>
...
801002bf:	e8 9f 34 00 00       	call   80103763 <sleep>
801002c4:	83 c4 10             	add    $0x10,%esp
801002c7:	eb d1                	jmp    8010029a <consoleread+0x32>
        release(&cons.lock);
801002c9:	83 ec 0c             	sub    $0xc,%esp
801002cc:	68 20 ef 10 80       	push   $0x8010ef20
801002d1:	e8 98 3a 00 00       	call   80103d6e <release>
        ilock(ip);
...
80100331:	e8 38 3a 00 00       	call   80103d6e <release>
  ilock(ip);
...
80100373:	e8 8f 02 00 00       	call   80100607 <cprintf>
  cprintf("\n");
80100378:	c7 04 24 cf 72 10 80 	movl   $0x801072cf,(%esp)
...
8010038f:	e8 54 38 00 00       	call   80103be8 <getcallerpcs>
  for(i=0; i<10; i++)
...
801004ae:	e8 7a 39 00 00       	call   80103e2d <memmove>
    pos -= 80;
...
801004cd:	e8 e3 38 00 00       	call   80103db5 <memset>
...
801004fa:	e8 1e 4d 00 00       	call   8010521d <uartputc>
...
80100513:	e8 05 4d 00 00       	call   8010521d <uartputc>
80100518:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010051f:	e8 f9 4c 00 00       	call   8010521d <uartputc>
80100524:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052b:	e8 ed 4c 00 00       	call   8010521d <uartputc>
...
801005c6:	e8 3e 37 00 00       	call   80103d09 <acquire>
  for(i = 0; i < n; i++)
...
801005ed:	e8 7c 37 00 00       	call   80103d6e <release>
  ilock(ip);
...
80100634:	e8 d0 36 00 00       	call   80103d09 <acquire>
...
80100729:	e8 40 36 00 00       	call   80103d6e <release>
...
80100744:	e8 c0 35 00 00       	call   80103d09 <acquire>
  while((c = getc()) >= 0){
...
801007f2:	e8 d4 30 00 00       	call   801038cb <wakeup>
...
8010086f:	e8 fa 34 00 00       	call   80103d6e <release>
  if(doprocdump) {
...
80100883:	e8 e2 30 00 00       	call   8010396a <procdump>
}
...
8010089a:	e8 2e 33 00 00       	call   80103bcd <initlock>
...
801008da:	e8 a6 29 00 00       	call   80103285 <myproc>
...
8010096c:	eb dc                	jmp    8010094a <exec+0x7c>
  if((pgdir = setupkvm()) == 0)
8010096e:	e8 91 5c 00 00       	call   80106604 <setupkvm>
...
80100a02:	e8 79 5a 00 00       	call   80106480 <allocuvm>
...
80100a34:	e8 f2 58 00 00       	call   8010632b <loaduvm>
...
80100a71:	e8 0a 5a 00 00       	call   80106480 <allocuvm>
...
80100a9c:	e8 e1 5a 00 00       	call   80106582 <freevm>
...
80100ab4:	e8 d0 5b 00 00       	call   80106689 <clearpteu>
...
80100ae6:	e8 73 34 00 00       	call   80103f5e <strlen>
...
80100af8:	e8 61 34 00 00       	call   80103f5e <strlen>
...
80100b0a:	e8 0a 5d 00 00       	call   80106819 <copyout>
...
80100b6a:	e8 aa 5c 00 00       	call   80106819 <copyout>
...
80100ba7:	e8 75 33 00 00       	call   80103f21 <safestrcpy>
...
80100bd5:	e8 5c 55 00 00       	call   80106136 <switchuvm>
  freevm(oldpgdir);
80100bda:	89 1c 24             	mov    %ebx,(%esp)
80100bdd:	e8 a0 59 00 00       	call   80106582 <freevm>
  return 0;
...
80100c13:	e8 b5 2f 00 00       	call   80103bcd <initlock>
}
...
80100c29:	e8 db 30 00 00       	call   80103d09 <acquire>
...
80100c58:	e8 11 31 00 00       	call   80103d6e <release>
      return f;
...
80100c6f:	e8 fa 30 00 00       	call   80103d6e <release>
  return 0;
...
80100c8d:	e8 77 30 00 00       	call   80103d09 <acquire>
  if(f->ref < 1)
...
80100caa:	e8 bf 30 00 00       	call   80103d6e <release>
  return f;
}
...
80100cd2:	e8 32 30 00 00       	call   80103d09 <acquire>
  if(f->ref < 1)
...
80100d23:	e8 46 30 00 00       	call   80103d6e <release>
...
80100d67:	e8 02 30 00 00       	call   80103d6e <release>
    return;
...
80100f81:	e8 a7 2e 00 00       	call   80103e2d <memmove>
...
80100f91:	e8 97 2e 00 00       	call   80103e2d <memmove>
    name[len] = 0;
...
80100fd6:	e8 da 2d 00 00       	call   80103db5 <memset>
  log_write(bp);
...
8010120a:	e8 fa 2a 00 00       	call   80103d09 <acquire>
...
80101251:	e8 18 2b 00 00       	call   80103d6e <release>
      return ip;
...
80101287:	e8 e2 2a 00 00       	call   80103d6e <release>
  return ip;
...
801012c5:	e8 63 2b 00 00       	call   80103e2d <memmove>
  brelse(bp);
...
801012eb:	e8 dd 28 00 00       	call   80103bcd <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101310:	e8 ad 27 00 00       	call   80103ac2 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801013df:	e8 d1 29 00 00       	call   80103db5 <memset>
      dip->type = type;
...
8010146e:	e8 ba 29 00 00       	call   80103e2d <memmove>
  log_write(bp);
...
8010154e:	e8 b6 27 00 00       	call   80103d09 <acquire>
  ip->ref++;
...
80101563:	e8 06 28 00 00       	call   80103d6e <release>
}
...
80101588:	e8 68 25 00 00       	call   80103af5 <acquiresleep>
  if(ip->valid == 0){
...
80101602:	e8 26 28 00 00       	call   80103e2d <memmove>
    brelse(bp);
...
80101644:	e8 36 25 00 00       	call   80103b7f <holdingsleep>
...
8010165a:	e8 e5 24 00 00       	call   80103b44 <releasesleep>
}
...
80101686:	e8 6a 24 00 00       	call   80103af5 <acquiresleep>
...
8010169f:	e8 a0 24 00 00       	call   80103b44 <releasesleep>
  acquire(&icache.lock);
801016a4:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801016ab:	e8 59 26 00 00       	call   80103d09 <acquire>
  ip->ref--;
...
801016c0:	e8 a9 26 00 00       	call   80103d6e <release>
}
...
801016d8:	e8 2c 26 00 00       	call   80103d09 <acquire>
    int r = ip->ref;
801016dd:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
801016e0:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801016e7:	e8 82 26 00 00       	call   80103d6e <release>
    if(r == 1){
...
80101818:	e8 10 26 00 00       	call   80103e2d <memmove>
    brelse(bp);
...
80101915:	e8 13 25 00 00       	call   80103e2d <memmove>
    log_write(bp);
...
80101998:	e8 fc 24 00 00       	call   80103e99 <strncmp>
}
8010199d:	c9                   	leave  
8010199e:	c3                   	ret    
...
80101a47:	74 17                	je     80101a60 <namex+0x2d>
    ...
    ip = idup(myproc()->cwd);
80101a49:	e8 37 18 00 00       	call   80103285 <myproc>
...
80101b95:	e8 3e 23 00 00       	call   80103ed8 <strncpy>
  de.inum = inum;
...
80101bc3:	68 c8 70 10 80       	push   $0x801070c8
...
80101cf9:	e8 cf 1e 00 00       	call   80103bcd <initlock>
...
80101d69:	e8 9b 1f 00 00       	call   80103d09 <acquire>
...
80101d98:	e8 2e 1b 00 00       	call   801038cb <wakeup>
...
80101db6:	e8 b3 1f 00 00       	call   80103d6e <release>
...
80101dcd:	e8 9c 1f 00 00       	call   80103d6e <release>
    return;
...
80101e05:	e8 75 1d 00 00       	call   80103b7f <holdingsleep>
...
80101e32:	e8 d2 1e 00 00       	call   80103d09 <acquire>
...
80101e94:	e8 ca 18 00 00       	call   80103763 <sleep>
...
80101eae:	e8 bb 1e 00 00       	call   80103d6e <release>
}
...
80101fc6:	e8 ea 1d 00 00       	call   80103db5 <memset>
...
80102026:	e8 43 1d 00 00       	call   80103d6e <release>
...
8010204e:	68 9c 6b 10 80       	push   $0x80106b9c
...
8010207d:	68 a6 6b 10 80       	push   $0x80106ba6
80102082:	68 40 16 11 80       	push   $0x80111640
80102087:	e8 41 1b 00 00       	call   80103bcd <initlock>
  kmem.use_lock = 0;
...
80102102:	e8 02 1c 00 00       	call   80103d09 <acquire>
...
80102114:	e8 55 1c 00 00       	call   80103d6e <release>
...
80102157:	0f b6 91 e0 6c 10 80 	movzbl -0x7fef9320(%ecx),%edx
8010215e:	0b 15 7c 16 11 80    	or     0x8011167c,%edx
80102164:	89 15 7c 16 11 80    	mov    %edx,0x8011167c
  shift ^= togglecode[data];
8010216a:	0f b6 81 e0 6b 10 80 	movzbl -0x7fef9420(%ecx),%eax
...
8010217e:	8b 04 85 c0 6b 10 80 	mov    -0x7fef9440(,%eax,4),%eax
...
801021b4:	83 e1 7f             	and    $0x7f,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
801021b7:	0f b6 81 e0 6c 10 80 	movzbl -0x7fef9320(%ecx),%eax
...
801024aa:	e8 49 19 00 00       	call   80103df8 <memcmp>
...
80102605:	e8 23 18 00 00       	call   80103e2d <memmove>
...
80102704:	e8 24 17 00 00       	call   80103e2d <memmove>
...
80102771:	68 e0 6d 10 80       	push   $0x80106de0
80102776:	68 a0 16 11 80       	push   $0x801116a0
8010277b:	e8 4d 14 00 00       	call   80103bcd <initlock>
  readsb(dev, &sb);
...
801027bb:	e8 49 15 00 00       	call   80103d09 <acquire>
...
801027d2:	e8 8c 0f 00 00       	call   80103763 <sleep>
...
80102809:	e8 55 0f 00 00       	call   80103763 <sleep>
...
80102820:	e8 49 15 00 00       	call   80103d6e <release>
}
...
80102836:	e8 ce 14 00 00       	call   80103d09 <acquire>
  log.outstanding -= 1;
...
80102870:	e8 f9 14 00 00       	call   80103d6e <release>
  if(do_commit){
...
8010290b:	e8 f9 13 00 00       	call   80103d09 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
8010291d:	68 f3 6d 10 80       	push   $0x80106df3
80102922:	e8 21 da ff ff       	call   80100348 <panic>
    panic("log_write outside of trans");
80102927:	83 ec 0c             	sub    $0xc,%esp
8010292a:	68 09 6e 10 80       	push   $0x80106e09
...
80102966:	e8 03 14 00 00       	call   80103d6e <release>
}
...
80102994:	e8 94 14 00 00       	call   80103e2d <memmove>
...
801029a6:	68 08 6b 10 80       	push   $0x80106b08
...
801029c9:	e8 40 08 00 00       	call   8010320e <mycpu>
...
80102a2d:	e8 38 08 00 00       	call   8010326a <cpuid>
80102a32:	89 c3                	mov    %eax,%ebx
80102a34:	e8 31 08 00 00       	call   8010326a <cpuid>
80102a39:	83 ec 04             	sub    $0x4,%esp
80102a3c:	53                   	push   %ebx
80102a3d:	50                   	push   %eax
80102a3e:	68 24 6e 10 80       	push   $0x80106e24
80102a43:	e8 bf db ff ff       	call   80100607 <cprintf>
  idtinit();       // load idt register
80102a48:	e8 6e 25 00 00       	call   80104fbb <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80102a4d:	e8 bc 07 00 00       	call   8010320e <mycpu>
...
80102a60:	e8 c4 0a 00 00       	call   80103529 <scheduler>
...
80102a68:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a6b:	e8 a1 36 00 00       	call   80106111 <switchkvm>
  seginit();
80102a70:	e8 27 34 00 00       	call   80105e9c <seginit>
  lapicinit();
...
80102ac2:	e8 9b 27 00 00       	call   80105262 <uartinit>
  pinit();         // process table
80102ac7:	e8 28 07 00 00       	call   801031f4 <pinit>
  tvinit();        // trap vectors
80102acc:	e8 e5 23 00 00       	call   80104eb6 <tvinit>
  binit();         // buffer cache
...
80102af7:	e8 ac 07 00 00       	call   801032a8 <userinit>
...
80102b3f:	68 38 6e 10 80       	push   $0x80106e38
...
80102b55:	68 52 6e 10 80       	push   $0x80106e52
80102b5a:	53                   	push   %ebx
80102b5b:	e8 98 12 00 00       	call   80103df8 <memcmp>
...
80102c1f:	68 57 6e 10 80       	push   $0x80106e57
80102c24:	53                   	push   %ebx
80102c25:	e8 ce 11 00 00       	call   80103df8 <memcmp>
...
80102c61:	68 38 6e 10 80       	push   $0x80106e38
...
80102cb5:	68 5c 6e 10 80       	push   $0x80106e5c
...
80102d50:	68 74 6e 10 80       	push   $0x80106e74
...
80102dd7:	68 93 6e 10 80       	push   $0x80106e93
80102ddc:	50                   	push   %eax
80102ddd:	e8 eb 0d 00 00       	call   80103bcd <initlock>
  (*f0)->type = FD_PIPE;
...
80102e61:	e8 a3 0e 00 00       	call   80103d09 <acquire>
  if(writable){
...
80102e83:	e8 43 0a 00 00       	call   801038cb <wakeup>
...
80102ea1:	e8 c8 0e 00 00       	call   80103d6e <release>
...
80102ec2:	e8 04 0a 00 00       	call   801038cb <wakeup>
...
80102ed0:	e8 99 0e 00 00       	call   80103d6e <release>
    kfree((char*)p);
...
80102ef2:	e8 12 0e 00 00       	call   80103d09 <acquire>
  for(i = 0; i < n; i++){
...
80102f0d:	e8 b9 09 00 00       	call   801038cb <wakeup>
  release(&p->lock);
80102f12:	89 1c 24             	mov    %ebx,(%esp)
80102f15:	e8 54 0e 00 00       	call   80103d6e <release>
  return n;
...
80102f61:	e8 1f 03 00 00       	call   80103285 <myproc>
...
80102f70:	e8 f9 0d 00 00       	call   80103d6e <release>
        return -1;
...
80102fb7:	e8 4d 0d 00 00       	call   80103d09 <acquire>
...
80102fcc:	e8 92 07 00 00       	call   80103763 <sleep>
...
80102fea:	74 37                	je     80103023 <piperead+0x7c>
    if(myproc()->killed){
80102fec:	e8 94 02 00 00       	call   80103285 <myproc>
...
80102ffb:	e8 6e 0d 00 00       	call   80103d6e <release>
      return -1;
...
80103040:	e8 86 08 00 00       	call   801038cb <wakeup>
  release(&p->lock);
80103045:	89 1c 24             	mov    %ebx,(%esp)
80103048:	e8 21 0d 00 00       	call   80103d6e <release>
  return i;
...
80103097:	e8 6d 0c 00 00       	call   80103d09 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
801030da:	e8 8f 0c 00 00       	call   80103d6e <release>
...
801030f7:	c7 80 b0 0f 00 00 ab 	movl   $0x80104eab,0xfb0(%eax)
801030fe:	4e 10 80 
  sp -= sizeof *p->context;
...
80103111:	e8 9f 0c 00 00       	call   80103db5 <memset>
...
80103132:	e8 37 0c 00 00       	call   80103d6e <release>
  return 0;
...
80103157:	e8 12 0c 00 00       	call   80103d6e <release>
  if (first) {
...
8010318f <next_random>:
  seed = a * (seed % m);
8010318f:	8b 0d 04 a0 10 80    	mov    0x8010a004,%ecx
80103195:	ba 03 00 00 00       	mov    $0x3,%edx
8010319a:	89 c8                	mov    %ecx,%eax
8010319c:	f7 e2                	mul    %edx
8010319e:	89 c8                	mov    %ecx,%eax
801031a0:	29 d0                	sub    %edx,%eax
801031a2:	d1 e8                	shr    %eax
801031a4:	01 c2                	add    %eax,%edx
801031a6:	c1 ea 1e             	shr    $0x1e,%edx
801031a9:	89 d0                	mov    %edx,%eax
801031ab:	c1 e0 1f             	shl    $0x1f,%eax
801031ae:	29 d0                	sub    %edx,%eax
801031b0:	29 c1                	sub    %eax,%ecx
801031b2:	69 c1 a7 41 00 00    	imul   $0x41a7,%ecx,%eax
801031b8:	a3 04 a0 10 80       	mov    %eax,0x8010a004
}
801031bd:	c3                   	ret    

801031be <random_at_most>:
unsigned random_at_most(unsigned max) {
801031be:	55                   	push   %ebp
801031bf:	89 e5                	mov    %esp,%ebp
801031c1:	56                   	push   %esi
801031c2:	53                   	push   %ebx
  unsigned num_bins = (max + 1);
801031c3:	8b 45 08             	mov    0x8(%ebp),%eax
801031c6:	8d 48 01             	lea    0x1(%eax),%ecx
  unsigned bin_size = num_rand / num_bins;
801031c9:	b8 a1 86 01 00       	mov    $0x186a1,%eax
801031ce:	ba 00 00 00 00       	mov    $0x0,%edx
801031d3:	f7 f1                	div    %ecx
801031d5:	89 d3                	mov    %edx,%ebx
801031d7:	89 c6                	mov    %eax,%esi
    x = next_random();
801031d9:	e8 b1 ff ff ff       	call   8010318f <next_random>
  } while (num_rand - defect <= x);
801031de:	ba a1 86 01 00       	mov    $0x186a1,%edx
801031e3:	29 da                	sub    %ebx,%edx
801031e5:	39 c2                	cmp    %eax,%edx
801031e7:	76 f0                	jbe    801031d9 <random_at_most+0x1b>
  retval = x/bin_size;
801031e9:	ba 00 00 00 00       	mov    $0x0,%edx
801031ee:	f7 f6                	div    %esi
}
801031f0:	5b                   	pop    %ebx
801031f1:	5e                   	pop    %esi
801031f2:	5d                   	pop    %ebp
...
801031f7:	83 ec 10             	sub    $0x10,%esp
  initlock(&ptable.lock, "ptable");
801031fa:	68 98 6e 10 80       	push   $0x80106e98
801031ff:	68 20 1d 11 80       	push   $0x80111d20
80103204:	e8 c4 09 00 00       	call   80103bcd <initlock>
}
...
80103215:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103216:	f6 c4 02             	test   $0x2,%ah
80103219:	75 28                	jne    80103243 <mycpu+0x35>
  apicid = lapicid();
8010321b:	e8 72 f1 ff ff       	call   80102392 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103220:	ba 00 00 00 00       	mov    $0x0,%edx
80103225:	39 15 84 17 11 80    	cmp    %edx,0x80111784
8010322b:	7e 23                	jle    80103250 <mycpu+0x42>
    if (cpus[i].apicid == apicid)
8010322d:	69 ca b0 00 00 00    	imul   $0xb0,%edx,%ecx
80103233:	0f b6 89 a0 17 11 80 	movzbl -0x7feee860(%ecx),%ecx
8010323a:	39 c1                	cmp    %eax,%ecx
8010323c:	74 1f                	je     8010325d <mycpu+0x4f>
  for (i = 0; i < ncpu; ++i) {
8010323e:	83 c2 01             	add    $0x1,%edx
80103241:	eb e2                	jmp    80103225 <mycpu+0x17>
    panic("mycpu called with interrupts enabled\n");
80103243:	83 ec 0c             	sub    $0xc,%esp
80103246:	68 7c 6f 10 80       	push   $0x80106f7c
8010324b:	e8 f8 d0 ff ff       	call   80100348 <panic>
  panic("unknown apicid\n");
80103250:	83 ec 0c             	sub    $0xc,%esp
80103253:	68 9f 6e 10 80       	push   $0x80106e9f
80103258:	e8 eb d0 ff ff       	call   80100348 <panic>
      return &cpus[i];
8010325d:	69 c2 b0 00 00 00    	imul   $0xb0,%edx,%eax
80103263:	05 a0 17 11 80       	add    $0x801117a0,%eax
}
80103268:	c9                   	leave  
80103269:	c3                   	ret    
...
8010326d:	83 ec 08             	sub    $0x8,%esp
  return mycpu()-cpus;
80103270:	e8 99 ff ff ff       	call   8010320e <mycpu>
80103275:	2d a0 17 11 80       	sub    $0x801117a0,%eax
8010327a:	c1 f8 04             	sar    $0x4,%eax
8010327d:	69 c0 a3 8b 2e ba    	imul   $0xba2e8ba3,%eax,%eax
}
80103283:	c9                   	leave  
80103284:	c3                   	ret    
...
80103288:	53                   	push   %ebx
80103289:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010328c:	e8 9d 09 00 00       	call   80103c2e <pushcli>
  c = mycpu();
80103291:	e8 78 ff ff ff       	call   8010320e <mycpu>
  p = c->proc;
80103296:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010329c:	e8 c9 09 00 00       	call   80103c6a <popcli>
}
801032a1:	89 d8                	mov    %ebx,%eax
...
801032ac:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
801032af:	e8 d7 fd ff ff       	call   8010308b <allocproc>
801032b4:	89 c3                	mov    %eax,%ebx
  initproc = p;
801032b6:	a3 54 3e 11 80       	mov    %eax,0x80113e54
  if((p->pgdir = setupkvm()) == 0)
801032bb:	e8 44 33 00 00       	call   80106604 <setupkvm>
801032c0:	89 43 04             	mov    %eax,0x4(%ebx)
801032c3:	85 c0                	test   %eax,%eax
801032c5:	0f 84 c9 00 00 00    	je     80103394 <userinit+0xec>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801032cb:	83 ec 04             	sub    $0x4,%esp
801032ce:	68 2c 00 00 00       	push   $0x2c
801032d3:	68 60 a4 10 80       	push   $0x8010a460
801032d8:	50                   	push   %eax
801032d9:	e8 cc 2f 00 00       	call   801062aa <inituvm>
  p->sz = PGSIZE;
801032de:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
801032e4:	8b 43 18             	mov    0x18(%ebx),%eax
801032e7:	83 c4 0c             	add    $0xc,%esp
801032ea:	6a 4c                	push   $0x4c
801032ec:	6a 00                	push   $0x0
801032ee:	50                   	push   %eax
801032ef:	e8 c1 0a 00 00       	call   80103db5 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
801032f4:	8b 43 18             	mov    0x18(%ebx),%eax
801032f7:	66 c7 40 3c 1b 00    	movw   $0x1b,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
801032fd:	8b 43 18             	mov    0x18(%ebx),%eax
80103300:	66 c7 40 2c 23 00    	movw   $0x23,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103306:	8b 43 18             	mov    0x18(%ebx),%eax
80103309:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
8010330d:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103311:	8b 43 18             	mov    0x18(%ebx),%eax
80103314:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103318:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
8010331c:	8b 43 18             	mov    0x18(%ebx),%eax
8010331f:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
80103326:	8b 43 18             	mov    0x18(%ebx),%eax
80103329:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
80103330:	8b 43 18             	mov    0x18(%ebx),%eax
80103333:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
8010333a:	8d 43 6c             	lea    0x6c(%ebx),%eax
8010333d:	83 c4 0c             	add    $0xc,%esp
80103340:	6a 10                	push   $0x10
80103342:	68 c8 6e 10 80       	push   $0x80106ec8
80103347:	50                   	push   %eax
80103348:	e8 d4 0b 00 00       	call   80103f21 <safestrcpy>
  p->cwd = namei("/");
8010334d:	c7 04 24 d1 6e 10 80 	movl   $0x80106ed1,(%esp)
80103354:	e8 74 e8 ff ff       	call   80101bcd <namei>
80103359:	89 43 68             	mov    %eax,0x68(%ebx)
  p->times_scheduled = 0;
8010335c:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
  p->tickets = 10;
80103363:	c7 83 80 00 00 00 0a 	movl   $0xa,0x80(%ebx)
8010336a:	00 00 00 
  acquire(&ptable.lock);
8010336d:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103374:	e8 90 09 00 00       	call   80103d09 <acquire>
  p->state = RUNNABLE;
80103379:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103380:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103387:	e8 e2 09 00 00       	call   80103d6e <release>
}
8010338c:	83 c4 10             	add    $0x10,%esp
8010338f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103392:	c9                   	leave  
80103393:	c3                   	ret    
    panic("userinit: out of memory?");
80103394:	83 ec 0c             	sub    $0xc,%esp
80103397:	68 af 6e 10 80       	push   $0x80106eaf
8010339c:	e8 a7 cf ff ff       	call   80100348 <panic>
...
801033a6:	8b 75 08             	mov    0x8(%ebp),%esi
  struct proc *curproc = myproc();
801033a9:	e8 d7 fe ff ff       	call   80103285 <myproc>
801033ae:	89 c3                	mov    %eax,%ebx
  sz = curproc->sz;
801033b0:	8b 00                	mov    (%eax),%eax
  if(n > 0){
801033b2:	85 f6                	test   %esi,%esi
801033b4:	7f 1c                	jg     801033d2 <growproc+0x31>
  } else if(n < 0){
801033b6:	78 37                	js     801033ef <growproc+0x4e>
  curproc->sz = sz;
801033b8:	89 03                	mov    %eax,(%ebx)
  switchuvm(curproc);
801033ba:	83 ec 0c             	sub    $0xc,%esp
801033bd:	53                   	push   %ebx
801033be:	e8 73 2d 00 00       	call   80106136 <switchuvm>
  return 0;
801033c3:	83 c4 10             	add    $0x10,%esp
801033c6:	b8 00 00 00 00       	mov    $0x0,%eax
}
801033cb:	8d 65 f8             	lea    -0x8(%ebp),%esp
801033ce:	5b                   	pop    %ebx
801033cf:	5e                   	pop    %esi
801033d0:	5d                   	pop    %ebp
801033d1:	c3                   	ret    
...
801033d5:	01 c6                	add    %eax,%esi
801033d7:	56                   	push   %esi
801033d8:	50                   	push   %eax
801033d9:	ff 73 04             	push   0x4(%ebx)
801033dc:	e8 9f 30 00 00       	call   80106480 <allocuvm>
801033e1:	83 c4 10             	add    $0x10,%esp
801033e4:	85 c0                	test   %eax,%eax
801033e6:	75 d0                	jne    801033b8 <growproc+0x17>
      return -1;
801033e8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801033ed:	eb dc                	jmp    801033cb <growproc+0x2a>
    if((sz = deallocuvm(curproc->pgdir, sz, sz + n)) == 0)
801033ef:	83 ec 04             	sub    $0x4,%esp
801033f2:	01 c6                	add    %eax,%esi
801033f4:	56                   	push   %esi
801033f5:	50                   	push   %eax
801033f6:	ff 73 04             	push   0x4(%ebx)
801033f9:	e8 dc 2f 00 00       	call   801063da <deallocuvm>
801033fe:	83 c4 10             	add    $0x10,%esp
80103401:	85 c0                	test   %eax,%eax
80103403:	75 b3                	jne    801033b8 <growproc+0x17>
      return -1;
80103405:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010340a:	eb bf                	jmp    801033cb <growproc+0x2a>
...
80103412:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *curproc = myproc();
80103415:	e8 6b fe ff ff       	call   80103285 <myproc>
8010341a:	89 c3                	mov    %eax,%ebx
  if((np = allocproc()) == 0){
8010341c:	e8 6a fc ff ff       	call   8010308b <allocproc>
80103421:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103424:	85 c0                	test   %eax,%eax
80103426:	0f 84 f6 00 00 00    	je     80103522 <fork+0x116>
8010342c:	89 c7                	mov    %eax,%edi
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
8010342e:	83 ec 08             	sub    $0x8,%esp
80103431:	ff 33                	push   (%ebx)
80103433:	ff 73 04             	push   0x4(%ebx)
80103436:	e8 7a 32 00 00       	call   801066b5 <copyuvm>
8010343b:	89 47 04             	mov    %eax,0x4(%edi)
8010343e:	83 c4 10             	add    $0x10,%esp
80103441:	85 c0                	test   %eax,%eax
80103443:	74 40                	je     80103485 <fork+0x79>
  np->sz = curproc->sz;
80103445:	8b 03                	mov    (%ebx),%eax
80103447:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010344a:	89 02                	mov    %eax,(%edx)
  np->parent = curproc;
8010344c:	89 5a 14             	mov    %ebx,0x14(%edx)
  *np->tf = *curproc->tf;
8010344f:	8b 73 18             	mov    0x18(%ebx),%esi
80103452:	8b 7a 18             	mov    0x18(%edx),%edi
80103455:	b9 13 00 00 00       	mov    $0x13,%ecx
8010345a:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tickets = curproc->tickets;
8010345c:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
80103462:	89 82 80 00 00 00    	mov    %eax,0x80(%edx)
  np->times_scheduled++;
80103468:	8b 42 7c             	mov    0x7c(%edx),%eax
8010346b:	89 45 e0             	mov    %eax,-0x20(%ebp)
8010346e:	83 c0 01             	add    $0x1,%eax
80103471:	89 42 7c             	mov    %eax,0x7c(%edx)
  np->tf->eax = 0;
80103474:	8b 42 18             	mov    0x18(%edx),%eax
80103477:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
8010347e:	be 00 00 00 00       	mov    $0x0,%esi
80103483:	eb 29                	jmp    801034ae <fork+0xa2>
    kfree(np->kstack);
80103485:	83 ec 0c             	sub    $0xc,%esp
80103488:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
8010348b:	ff 73 08             	push   0x8(%ebx)
8010348e:	e8 f9 ea ff ff       	call   80101f8c <kfree>
    np->kstack = 0;
80103493:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
8010349a:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
801034a1:	83 c4 10             	add    $0x10,%esp
801034a4:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801034a9:	eb 6d                	jmp    80103518 <fork+0x10c>
  for(i = 0; i < NOFILE; i++)
801034ab:	83 c6 01             	add    $0x1,%esi
801034ae:	83 fe 0f             	cmp    $0xf,%esi
801034b1:	7f 1d                	jg     801034d0 <fork+0xc4>
    if(curproc->ofile[i])
801034b3:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
801034b7:	85 c0                	test   %eax,%eax
801034b9:	74 f0                	je     801034ab <fork+0x9f>
      np->ofile[i] = filedup(curproc->ofile[i]);
801034bb:	83 ec 0c             	sub    $0xc,%esp
801034be:	50                   	push   %eax
801034bf:	e8 ba d7 ff ff       	call   80100c7e <filedup>
801034c4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801034c7:	89 44 b2 28          	mov    %eax,0x28(%edx,%esi,4)
801034cb:	83 c4 10             	add    $0x10,%esp
801034ce:	eb db                	jmp    801034ab <fork+0x9f>
  np->cwd = idup(curproc->cwd);
801034d0:	83 ec 0c             	sub    $0xc,%esp
801034d3:	ff 73 68             	push   0x68(%ebx)
801034d6:	e8 64 e0 ff ff       	call   8010153f <idup>
801034db:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801034de:	89 47 68             	mov    %eax,0x68(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801034e1:	83 c3 6c             	add    $0x6c,%ebx
801034e4:	8d 47 6c             	lea    0x6c(%edi),%eax
801034e7:	83 c4 0c             	add    $0xc,%esp
801034ea:	6a 10                	push   $0x10
801034ec:	53                   	push   %ebx
801034ed:	50                   	push   %eax
801034ee:	e8 2e 0a 00 00       	call   80103f21 <safestrcpy>
  pid = np->pid;
801034f3:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
801034f6:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801034fd:	e8 07 08 00 00       	call   80103d09 <acquire>
  np->state = RUNNABLE;
80103502:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103509:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103510:	e8 59 08 00 00       	call   80103d6e <release>
  return pid;
...
80103521:	c3                   	ret    
    return -1;
80103522:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103527:	eb ef                	jmp    80103518 <fork+0x10c>
...
8010352d:	53                   	push   %ebx
  struct cpu *c = mycpu();
8010352e:	e8 db fc ff ff       	call   8010320e <mycpu>
80103533:	89 c6                	mov    %eax,%esi
  c->proc = 0;
80103535:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
8010353c:	00 00 00 
8010353f:	eb 6c                	jmp    801035ad <scheduler+0x84>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103541:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103547:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
8010354d:	73 4e                	jae    8010359d <scheduler+0x74>
      if(p->state != RUNNABLE)
8010354f:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
80103553:	75 ec                	jne    80103541 <scheduler+0x18>
      c->proc = p;
80103555:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
8010355b:	83 ec 0c             	sub    $0xc,%esp
8010355e:	53                   	push   %ebx
8010355f:	e8 d2 2b 00 00       	call   80106136 <switchuvm>
      p->state = RUNNING;
80103564:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      p->times_scheduled += random_at_most(10000);
8010356b:	c7 04 24 10 27 00 00 	movl   $0x2710,(%esp)
80103572:	e8 47 fc ff ff       	call   801031be <random_at_most>
80103577:	01 43 7c             	add    %eax,0x7c(%ebx)
      swtch(&(c->scheduler), p->context);
8010357a:	83 c4 08             	add    $0x8,%esp
8010357d:	ff 73 1c             	push   0x1c(%ebx)
80103580:	8d 46 04             	lea    0x4(%esi),%eax
80103583:	50                   	push   %eax
80103584:	e8 ed 09 00 00       	call   80103f76 <swtch>
      switchkvm();
80103589:	e8 83 2b 00 00       	call   80106111 <switchkvm>
      c->proc = 0;
8010358e:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103595:	00 00 00 
80103598:	83 c4 10             	add    $0x10,%esp
8010359b:	eb a4                	jmp    80103541 <scheduler+0x18>
    release(&ptable.lock);
8010359d:	83 ec 0c             	sub    $0xc,%esp
801035a0:	68 20 1d 11 80       	push   $0x80111d20
801035a5:	e8 c4 07 00 00       	call   80103d6e <release>
    sti();
...
801035b1:	68 20 1d 11 80       	push   $0x80111d20
801035b6:	e8 4e 07 00 00       	call   80103d09 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801035bb:	83 c4 10             	add    $0x10,%esp
801035be:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
801035c3:	eb 82                	jmp    80103547 <scheduler+0x1e>
...
801035ca:	e8 b6 fc ff ff       	call   80103285 <myproc>
801035cf:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
801035d1:	83 ec 0c             	sub    $0xc,%esp
801035d4:	68 20 1d 11 80       	push   $0x80111d20
801035d9:	e8 ec 06 00 00       	call   80103cca <holding>
801035de:	83 c4 10             	add    $0x10,%esp
801035e1:	85 c0                	test   %eax,%eax
801035e3:	74 4f                	je     80103634 <sched+0x6f>
  if(mycpu()->ncli != 1)
801035e5:	e8 24 fc ff ff       	call   8010320e <mycpu>
801035ea:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
801035f1:	75 4e                	jne    80103641 <sched+0x7c>
  if(p->state == RUNNING)
801035f3:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
801035f7:	74 55                	je     8010364e <sched+0x89>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
801035f9:	9c                   	pushf  
801035fa:	58                   	pop    %eax
  if(readeflags()&FL_IF)
801035fb:	f6 c4 02             	test   $0x2,%ah
801035fe:	75 5b                	jne    8010365b <sched+0x96>
  intena = mycpu()->intena;
80103600:	e8 09 fc ff ff       	call   8010320e <mycpu>
80103605:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
8010360b:	e8 fe fb ff ff       	call   8010320e <mycpu>
80103610:	83 ec 08             	sub    $0x8,%esp
80103613:	ff 70 04             	push   0x4(%eax)
80103616:	83 c3 1c             	add    $0x1c,%ebx
80103619:	53                   	push   %ebx
8010361a:	e8 57 09 00 00       	call   80103f76 <swtch>
  mycpu()->intena = intena;
8010361f:	e8 ea fb ff ff       	call   8010320e <mycpu>
80103624:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
8010362a:	83 c4 10             	add    $0x10,%esp
8010362d:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103630:	5b                   	pop    %ebx
80103631:	5e                   	pop    %esi
80103632:	5d                   	pop    %ebp
80103633:	c3                   	ret    
...
80103637:	68 d3 6e 10 80       	push   $0x80106ed3
8010363c:	e8 07 cd ff ff       	call   80100348 <panic>
    panic("sched locks");
80103641:	83 ec 0c             	sub    $0xc,%esp
80103644:	68 e5 6e 10 80       	push   $0x80106ee5
80103649:	e8 fa cc ff ff       	call   80100348 <panic>
    panic("sched running");
8010364e:	83 ec 0c             	sub    $0xc,%esp
80103651:	68 f1 6e 10 80       	push   $0x80106ef1
80103656:	e8 ed cc ff ff       	call   80100348 <panic>
    panic("sched interruptible");
8010365b:	83 ec 0c             	sub    $0xc,%esp
8010365e:	68 ff 6e 10 80       	push   $0x80106eff
...
8010366c:	53                   	push   %ebx
  struct proc *curproc = myproc();
8010366d:	e8 13 fc ff ff       	call   80103285 <myproc>
  if(curproc == initproc)
80103672:	39 05 54 3e 11 80    	cmp    %eax,0x80113e54
80103678:	74 09                	je     80103683 <exit+0x1b>
8010367a:	89 c6                	mov    %eax,%esi
  for(fd = 0; fd < NOFILE; fd++){
8010367c:	bb 00 00 00 00       	mov    $0x0,%ebx
80103681:	eb 24                	jmp    801036a7 <exit+0x3f>
    panic("init exiting");
80103683:	83 ec 0c             	sub    $0xc,%esp
80103686:	68 13 6f 10 80       	push   $0x80106f13
8010368b:	e8 b8 cc ff ff       	call   80100348 <panic>
      fileclose(curproc->ofile[fd]);
80103690:	83 ec 0c             	sub    $0xc,%esp
80103693:	50                   	push   %eax
80103694:	e8 2a d6 ff ff       	call   80100cc3 <fileclose>
      curproc->ofile[fd] = 0;
80103699:	c7 44 9e 28 00 00 00 	movl   $0x0,0x28(%esi,%ebx,4)
801036a0:	00 
801036a1:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
801036a4:	83 c3 01             	add    $0x1,%ebx
801036a7:	83 fb 0f             	cmp    $0xf,%ebx
801036aa:	7f 0a                	jg     801036b6 <exit+0x4e>
    if(curproc->ofile[fd]){
801036ac:	8b 44 9e 28          	mov    0x28(%esi,%ebx,4),%eax
801036b0:	85 c0                	test   %eax,%eax
801036b2:	75 dc                	jne    80103690 <exit+0x28>
801036b4:	eb ee                	jmp    801036a4 <exit+0x3c>
  begin_op();
801036b6:	e8 f5 f0 ff ff       	call   801027b0 <begin_op>
  iput(curproc->cwd);
801036bb:	83 ec 0c             	sub    $0xc,%esp
801036be:	ff 76 68             	push   0x68(%esi)
801036c1:	e8 b0 df ff ff       	call   80101676 <iput>
  end_op();
801036c6:	e8 5f f1 ff ff       	call   8010282a <end_op>
  curproc->cwd = 0;
801036cb:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
801036d2:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801036d9:	e8 2b 06 00 00       	call   80103d09 <acquire>
  wakeup1(curproc->parent);
801036de:	8b 46 14             	mov    0x14(%esi),%eax
801036e1:	e8 7b f9 ff ff       	call   80103061 <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801036e6:	83 c4 10             	add    $0x10,%esp
801036e9:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
801036ee:	eb 06                	jmp    801036f6 <exit+0x8e>
801036f0:	81 c3 84 00 00 00    	add    $0x84,%ebx
801036f6:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
801036fc:	73 1a                	jae    80103718 <exit+0xb0>
    if(p->parent == curproc){
801036fe:	39 73 14             	cmp    %esi,0x14(%ebx)
80103701:	75 ed                	jne    801036f0 <exit+0x88>
      p->parent = initproc;
80103703:	a1 54 3e 11 80       	mov    0x80113e54,%eax
80103708:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
8010370b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010370f:	75 df                	jne    801036f0 <exit+0x88>
        wakeup1(initproc);
80103711:	e8 4b f9 ff ff       	call   80103061 <wakeup1>
80103716:	eb d8                	jmp    801036f0 <exit+0x88>
  curproc->state = ZOMBIE;
80103718:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
8010371f:	e8 a1 fe ff ff       	call   801035c5 <sched>
  panic("zombie exit");
80103724:	83 ec 0c             	sub    $0xc,%esp
80103727:	68 20 6f 10 80       	push   $0x80106f20
...
80103737:	68 20 1d 11 80       	push   $0x80111d20
8010373c:	e8 c8 05 00 00       	call   80103d09 <acquire>
  myproc()->state = RUNNABLE;
80103741:	e8 3f fb ff ff       	call   80103285 <myproc>
80103746:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
8010374d:	e8 73 fe ff ff       	call   801035c5 <sched>
  release(&ptable.lock);
80103752:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103759:	e8 10 06 00 00       	call   80103d6e <release>
}
...
80103768:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
8010376b:	e8 15 fb ff ff       	call   80103285 <myproc>
  if(p == 0)
80103770:	85 c0                	test   %eax,%eax
80103772:	74 66                	je     801037da <sleep+0x77>
80103774:	89 c3                	mov    %eax,%ebx
  if(lk == 0)
80103776:	85 f6                	test   %esi,%esi
80103778:	74 6d                	je     801037e7 <sleep+0x84>
  if(lk != &ptable.lock){  //DOC: sleeplock0
8010377a:	81 fe 20 1d 11 80    	cmp    $0x80111d20,%esi
80103780:	74 18                	je     8010379a <sleep+0x37>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103782:	83 ec 0c             	sub    $0xc,%esp
80103785:	68 20 1d 11 80       	push   $0x80111d20
8010378a:	e8 7a 05 00 00       	call   80103d09 <acquire>
    release(lk);
8010378f:	89 34 24             	mov    %esi,(%esp)
80103792:	e8 d7 05 00 00       	call   80103d6e <release>
80103797:	83 c4 10             	add    $0x10,%esp
  p->chan = chan;
8010379a:	8b 45 08             	mov    0x8(%ebp),%eax
8010379d:	89 43 20             	mov    %eax,0x20(%ebx)
  p->state = SLEEPING;
801037a0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801037a7:	e8 19 fe ff ff       	call   801035c5 <sched>
  p->chan = 0;
801037ac:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  if(lk != &ptable.lock){  //DOC: sleeplock2
801037b3:	81 fe 20 1d 11 80    	cmp    $0x80111d20,%esi
801037b9:	74 18                	je     801037d3 <sleep+0x70>
    release(&ptable.lock);
801037bb:	83 ec 0c             	sub    $0xc,%esp
801037be:	68 20 1d 11 80       	push   $0x80111d20
801037c3:	e8 a6 05 00 00       	call   80103d6e <release>
    acquire(lk);
801037c8:	89 34 24             	mov    %esi,(%esp)
801037cb:	e8 39 05 00 00       	call   80103d09 <acquire>
801037d0:	83 c4 10             	add    $0x10,%esp
}
801037d3:	8d 65 f8             	lea    -0x8(%ebp),%esp
801037d6:	5b                   	pop    %ebx
801037d7:	5e                   	pop    %esi
801037d8:	5d                   	pop    %ebp
801037d9:	c3                   	ret    
...
801037dd:	68 2c 6f 10 80       	push   $0x80106f2c
801037e2:	e8 61 cb ff ff       	call   80100348 <panic>
    panic("sleep without lk");
801037e7:	83 ec 0c             	sub    $0xc,%esp
801037ea:	68 32 6f 10 80       	push   $0x80106f32
...
801037f8:	53                   	push   %ebx
  struct proc *curproc = myproc();
801037f9:	e8 87 fa ff ff       	call   80103285 <myproc>
801037fe:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103800:	83 ec 0c             	sub    $0xc,%esp
80103803:	68 20 1d 11 80       	push   $0x80111d20
80103808:	e8 fc 04 00 00       	call   80103d09 <acquire>
8010380d:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103810:	b8 00 00 00 00       	mov    $0x0,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103815:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
8010381a:	eb 5e                	jmp    8010387a <wait+0x86>
        pid = p->pid;
8010381c:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
8010381f:	83 ec 0c             	sub    $0xc,%esp
80103822:	ff 73 08             	push   0x8(%ebx)
80103825:	e8 62 e7 ff ff       	call   80101f8c <kfree>
        p->kstack = 0;
8010382a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103831:	83 c4 04             	add    $0x4,%esp
80103834:	ff 73 04             	push   0x4(%ebx)
80103837:	e8 46 2d 00 00       	call   80106582 <freevm>
        p->pid = 0;
8010383c:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103843:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
8010384a:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
8010384e:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103855:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010385c:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103863:	e8 06 05 00 00       	call   80103d6e <release>
        return pid;
80103868:	83 c4 10             	add    $0x10,%esp
}
8010386b:	89 f0                	mov    %esi,%eax
8010386d:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103870:	5b                   	pop    %ebx
80103871:	5e                   	pop    %esi
80103872:	5d                   	pop    %ebp
80103873:	c3                   	ret    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103874:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010387a:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80103880:	73 12                	jae    80103894 <wait+0xa0>
      if(p->parent != curproc)
80103882:	39 73 14             	cmp    %esi,0x14(%ebx)
80103885:	75 ed                	jne    80103874 <wait+0x80>
      if(p->state == ZOMBIE){
80103887:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010388b:	74 8f                	je     8010381c <wait+0x28>
      havekids = 1;
8010388d:	b8 01 00 00 00       	mov    $0x1,%eax
80103892:	eb e0                	jmp    80103874 <wait+0x80>
    if(!havekids || curproc->killed){
80103894:	85 c0                	test   %eax,%eax
80103896:	74 06                	je     8010389e <wait+0xaa>
80103898:	83 7e 24 00          	cmpl   $0x0,0x24(%esi)
8010389c:	74 17                	je     801038b5 <wait+0xc1>
      release(&ptable.lock);
8010389e:	83 ec 0c             	sub    $0xc,%esp
801038a1:	68 20 1d 11 80       	push   $0x80111d20
801038a6:	e8 c3 04 00 00       	call   80103d6e <release>
      return -1;
801038ab:	83 c4 10             	add    $0x10,%esp
801038ae:	be ff ff ff ff       	mov    $0xffffffff,%esi
801038b3:	eb b6                	jmp    8010386b <wait+0x77>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
801038b5:	83 ec 08             	sub    $0x8,%esp
801038b8:	68 20 1d 11 80       	push   $0x80111d20
801038bd:	56                   	push   %esi
801038be:	e8 a0 fe ff ff       	call   80103763 <sleep>
    havekids = 0;
801038c3:	83 c4 10             	add    $0x10,%esp
801038c6:	e9 45 ff ff ff       	jmp    80103810 <wait+0x1c>
...
801038ce:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
801038d1:	68 20 1d 11 80       	push   $0x80111d20
801038d6:	e8 2e 04 00 00       	call   80103d09 <acquire>
  wakeup1(chan);
801038db:	8b 45 08             	mov    0x8(%ebp),%eax
801038de:	e8 7e f7 ff ff       	call   80103061 <wakeup1>
  release(&ptable.lock);
801038e3:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801038ea:	e8 7f 04 00 00       	call   80103d6e <release>
}
...
801038fb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;

  acquire(&ptable.lock);
801038fe:	68 20 1d 11 80       	push   $0x80111d20
80103903:	e8 01 04 00 00       	call   80103d09 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103908:	83 c4 10             	add    $0x10,%esp
8010390b:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103910:	eb 0e                	jmp    80103920 <kill+0x2c>
    if(p->pid == pid){
      p->killed = 1;
...
80103919:	eb 1e                	jmp    80103939 <kill+0x45>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010391b:	05 84 00 00 00       	add    $0x84,%eax
80103920:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103925:	73 2c                	jae    80103953 <kill+0x5f>
    if(p->pid == pid){
80103927:	39 58 10             	cmp    %ebx,0x10(%eax)
8010392a:	75 ef                	jne    8010391b <kill+0x27>
      p->killed = 1;
8010392c:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
80103933:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103937:	74 d9                	je     80103912 <kill+0x1e>
      release(&ptable.lock);
80103939:	83 ec 0c             	sub    $0xc,%esp
8010393c:	68 20 1d 11 80       	push   $0x80111d20
80103941:	e8 28 04 00 00       	call   80103d6e <release>
      return 0;
80103946:	83 c4 10             	add    $0x10,%esp
80103949:	b8 00 00 00 00       	mov    $0x0,%eax
    }
  }
  release(&ptable.lock);
  return -1;
}
8010394e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103951:	c9                   	leave  
80103952:	c3                   	ret    
  release(&ptable.lock);
80103953:	83 ec 0c             	sub    $0xc,%esp
80103956:	68 20 1d 11 80       	push   $0x80111d20
8010395b:	e8 0e 04 00 00       	call   80103d6e <release>
  return -1;
80103960:	83 c4 10             	add    $0x10,%esp
80103963:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103968:	eb e4                	jmp    8010394e <kill+0x5a>
...
8010396f:	83 ec 30             	sub    $0x30,%esp
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103972:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80103977:	eb 36                	jmp    801039af <procdump+0x45>
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
80103979:	b8 43 6f 10 80       	mov    $0x80106f43,%eax
    cprintf("%d %s %s", p->pid, state, p->name);
8010397e:	8d 53 6c             	lea    0x6c(%ebx),%edx
80103981:	52                   	push   %edx
80103982:	50                   	push   %eax
80103983:	ff 73 10             	push   0x10(%ebx)
80103986:	68 47 6f 10 80       	push   $0x80106f47
8010398b:	e8 77 cc ff ff       	call   80100607 <cprintf>
    if(p->state == SLEEPING){
80103990:	83 c4 10             	add    $0x10,%esp
80103993:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80103997:	74 3c                	je     801039d5 <procdump+0x6b>
...
8010399c:	68 cf 72 10 80       	push   $0x801072cf
801039a1:	e8 61 cc ff ff       	call   80100607 <cprintf>
801039a6:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039a9:	81 c3 84 00 00 00    	add    $0x84,%ebx
801039af:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
801039b5:	73 61                	jae    80103a18 <procdump+0xae>
    if(p->state == UNUSED)
801039b7:	8b 43 0c             	mov    0xc(%ebx),%eax
801039ba:	85 c0                	test   %eax,%eax
801039bc:	74 eb                	je     801039a9 <procdump+0x3f>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801039be:	83 f8 05             	cmp    $0x5,%eax
801039c1:	77 b6                	ja     80103979 <procdump+0xf>
801039c3:	8b 04 85 a4 6f 10 80 	mov    -0x7fef905c(,%eax,4),%eax
801039ca:	85 c0                	test   %eax,%eax
801039cc:	75 b0                	jne    8010397e <procdump+0x14>
      state = "???";
801039ce:	b8 43 6f 10 80       	mov    $0x80106f43,%eax
801039d3:	eb a9                	jmp    8010397e <procdump+0x14>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801039d5:	8b 43 1c             	mov    0x1c(%ebx),%eax
801039d8:	8b 40 0c             	mov    0xc(%eax),%eax
801039db:	83 c0 08             	add    $0x8,%eax
801039de:	83 ec 08             	sub    $0x8,%esp
801039e1:	8d 55 d0             	lea    -0x30(%ebp),%edx
801039e4:	52                   	push   %edx
801039e5:	50                   	push   %eax
801039e6:	e8 fd 01 00 00       	call   80103be8 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
801039eb:	83 c4 10             	add    $0x10,%esp
801039ee:	be 00 00 00 00       	mov    $0x0,%esi
801039f3:	eb 14                	jmp    80103a09 <procdump+0x9f>
        cprintf(" %p", pc[i]);
801039f5:	83 ec 08             	sub    $0x8,%esp
801039f8:	50                   	push   %eax
801039f9:	68 e1 68 10 80       	push   $0x801068e1
801039fe:	e8 04 cc ff ff       	call   80100607 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80103a03:	83 c6 01             	add    $0x1,%esi
80103a06:	83 c4 10             	add    $0x10,%esp
80103a09:	83 fe 09             	cmp    $0x9,%esi
80103a0c:	7f 8b                	jg     80103999 <procdump+0x2f>
80103a0e:	8b 44 b5 d0          	mov    -0x30(%ebp,%esi,4),%eax
80103a12:	85 c0                	test   %eax,%eax
80103a14:	75 df                	jne    801039f5 <procdump+0x8b>
80103a16:	eb 81                	jmp    80103999 <procdump+0x2f>
  }
}
...
80103a27:	68 04 03 00 00       	push   $0x304
80103a2c:	8d 45 f4             	lea    -0xc(%ebp),%eax
80103a2f:	50                   	push   %eax
80103a30:	6a 00                	push   $0x0
80103a32:	e8 f6 05 00 00       	call   8010402d <argptr>
80103a37:	83 c4 10             	add    $0x10,%esp
80103a3a:	85 c0                	test   %eax,%eax
80103a3c:	78 7d                	js     80103abb <sys_getprocessesinfo+0x9c>
    return -1; //error
  }
  int count_unused = 0;
  struct proc *v;
...
80103a41:	68 20 1d 11 80       	push   $0x80111d20
80103a46:	e8 be 02 00 00       	call   80103d09 <acquire>
  int i = 0;
  for(v = ptable.proc; v < &ptable.proc[NPROC]; v++){
80103a4b:	83 c4 10             	add    $0x10,%esp
  int i = 0;
80103a4e:	ba 00 00 00 00       	mov    $0x0,%edx
  for(v = ptable.proc; v < &ptable.proc[NPROC]; v++){
80103a53:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
  int count_unused = 0;
80103a58:	bb 00 00 00 00       	mov    $0x0,%ebx
  for(v = ptable.proc; v < &ptable.proc[NPROC]; v++){
80103a5d:	eb 08                	jmp    80103a67 <sys_getprocessesinfo+0x48>
      count_unused++;
      p->pids[i] = v->pid;
    ...
    i++;
80103a5f:	83 c2 01             	add    $0x1,%edx
  for(v = ptable.proc; v < &ptable.proc[NPROC]; v++){
80103a62:	05 84 00 00 00       	add    $0x84,%eax
80103a67:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103a6c:	73 2c                	jae    80103a9a <sys_getprocessesinfo+0x7b>
    if(v->state != UNUSED) {
80103a6e:	83 78 0c 00          	cmpl   $0x0,0xc(%eax)
80103a72:	74 eb                	je     80103a5f <sys_getprocessesinfo+0x40>
      count_unused++;
80103a74:	83 c3 01             	add    $0x1,%ebx
      p->pids[i] = v->pid;
80103a77:	8b 4d f4             	mov    -0xc(%ebp),%ecx
80103a7a:	8b 70 10             	mov    0x10(%eax),%esi
80103a7d:	89 74 91 04          	mov    %esi,0x4(%ecx,%edx,4)
      p->times_scheduled[i] = v->times_scheduled;
80103a81:	8b 70 7c             	mov    0x7c(%eax),%esi
80103a84:	89 b4 91 04 01 00 00 	mov    %esi,0x104(%ecx,%edx,4)
      p->tickets[i] = v->tickets;
80103a8b:	8b b0 80 00 00 00    	mov    0x80(%eax),%esi
80103a91:	89 b4 91 04 02 00 00 	mov    %esi,0x204(%ecx,%edx,4)
80103a98:	eb c5                	jmp    80103a5f <sys_getprocessesinfo+0x40>
  }
  p->num_processes = count_unused;
80103a9a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103a9d:	89 18                	mov    %ebx,(%eax)
  release(&ptable.lock);
80103a9f:	83 ec 0c             	sub    $0xc,%esp
80103aa2:	68 20 1d 11 80       	push   $0x80111d20
80103aa7:	e8 c2 02 00 00       	call   80103d6e <release>
  return 0;
...
80103ac0:	eb f2                	jmp    80103ab4 <sys_getprocessesinfo+0x95>

80103ac2 <initsleeplock>:
#include "spinlock.h"
#include "sleeplock.h"
...
80103acc:	68 bc 6f 10 80       	push   $0x80106fbc
80103ad1:	8d 43 04             	lea    0x4(%ebx),%eax
80103ad4:	50                   	push   %eax
80103ad5:	e8 f3 00 00 00       	call   80103bcd <initlock>
  lk->name = name;
80103ada:	8b 45 0c             	mov    0xc(%ebp),%eax
80103add:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
80103ae0:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103ae6:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
}
80103aed:	83 c4 10             	add    $0x10,%esp
80103af0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103af3:	c9                   	leave  
80103af4:	c3                   	ret    

80103af5 <acquiresleep>:
...
80103afa:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103afd:	8d 73 04             	lea    0x4(%ebx),%esi
80103b00:	83 ec 0c             	sub    $0xc,%esp
80103b03:	56                   	push   %esi
80103b04:	e8 00 02 00 00       	call   80103d09 <acquire>
  while (lk->locked) {
80103b09:	83 c4 10             	add    $0x10,%esp
80103b0c:	eb 0d                	jmp    80103b1b <acquiresleep+0x26>
    sleep(lk, &lk->lk);
80103b0e:	83 ec 08             	sub    $0x8,%esp
80103b11:	56                   	push   %esi
80103b12:	53                   	push   %ebx
80103b13:	e8 4b fc ff ff       	call   80103763 <sleep>
80103b18:	83 c4 10             	add    $0x10,%esp
  while (lk->locked) {
80103b1b:	83 3b 00             	cmpl   $0x0,(%ebx)
80103b1e:	75 ee                	jne    80103b0e <acquiresleep+0x19>
  }
  lk->locked = 1;
80103b20:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103b26:	e8 5a f7 ff ff       	call   80103285 <myproc>
80103b2b:	8b 40 10             	mov    0x10(%eax),%eax
80103b2e:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80103b31:	83 ec 0c             	sub    $0xc,%esp
80103b34:	56                   	push   %esi
80103b35:	e8 34 02 00 00       	call   80103d6e <release>
}
80103b3a:	83 c4 10             	add    $0x10,%esp
80103b3d:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103b40:	5b                   	pop    %ebx
80103b41:	5e                   	pop    %esi
80103b42:	5d                   	pop    %ebp
80103b43:	c3                   	ret    

80103b44 <releasesleep>:
...
80103b49:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103b4c:	8d 73 04             	lea    0x4(%ebx),%esi
80103b4f:	83 ec 0c             	sub    $0xc,%esp
80103b52:	56                   	push   %esi
80103b53:	e8 b1 01 00 00       	call   80103d09 <acquire>
  lk->locked = 0;
80103b58:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103b5e:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80103b65:	89 1c 24             	mov    %ebx,(%esp)
80103b68:	e8 5e fd ff ff       	call   801038cb <wakeup>
  release(&lk->lk);
80103b6d:	89 34 24             	mov    %esi,(%esp)
80103b70:	e8 f9 01 00 00       	call   80103d6e <release>
}
...
80103b84:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&lk->lk);
80103b87:	8d 73 04             	lea    0x4(%ebx),%esi
80103b8a:	83 ec 0c             	sub    $0xc,%esp
80103b8d:	56                   	push   %esi
80103b8e:	e8 76 01 00 00       	call   80103d09 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80103b93:	83 c4 10             	add    $0x10,%esp
80103b96:	83 3b 00             	cmpl   $0x0,(%ebx)
80103b99:	75 17                	jne    80103bb2 <holdingsleep+0x33>
80103b9b:	bb 00 00 00 00       	mov    $0x0,%ebx
  release(&lk->lk);
80103ba0:	83 ec 0c             	sub    $0xc,%esp
80103ba3:	56                   	push   %esi
80103ba4:	e8 c5 01 00 00       	call   80103d6e <release>
  return r;
}
80103ba9:	89 d8                	mov    %ebx,%eax
...
80103bb1:	c3                   	ret    
  r = lk->locked && (lk->pid == myproc()->pid);
80103bb2:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80103bb5:	e8 cb f6 ff ff       	call   80103285 <myproc>
80103bba:	3b 58 10             	cmp    0x10(%eax),%ebx
80103bbd:	74 07                	je     80103bc6 <holdingsleep+0x47>
80103bbf:	bb 00 00 00 00       	mov    $0x0,%ebx
80103bc4:	eb da                	jmp    80103ba0 <holdingsleep+0x21>
80103bc6:	bb 01 00 00 00       	mov    $0x1,%ebx
80103bcb:	eb d3                	jmp    80103ba0 <holdingsleep+0x21>
...
80103bd6:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80103bd9:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80103bdf:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80103be6:	5d                   	pop    %ebp
80103be7:	c3                   	ret    

80103be8 <getcallerpcs>:
}
...
80103bf2:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
80103bf5:	b8 00 00 00 00       	mov    $0x0,%eax
80103bfa:	83 f8 09             	cmp    $0x9,%eax
80103bfd:	7f 25                	jg     80103c24 <getcallerpcs+0x3c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80103bff:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80103c05:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80103c0b:	77 17                	ja     80103c24 <getcallerpcs+0x3c>
      break;
    pcs[i] = ebp[1];     // saved %eip
80103c0d:	8b 5a 04             	mov    0x4(%edx),%ebx
80103c10:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
    ebp = (uint*)ebp[0]; // saved %ebp
80103c13:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80103c15:	83 c0 01             	add    $0x1,%eax
80103c18:	eb e0                	jmp    80103bfa <getcallerpcs+0x12>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
80103c1a:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
  for(; i < 10; i++)
80103c21:	83 c0 01             	add    $0x1,%eax
80103c24:	83 f8 09             	cmp    $0x9,%eax
80103c27:	7e f1                	jle    80103c1a <getcallerpcs+0x32>
}
80103c29:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103c2c:	c9                   	leave  
80103c2d:	c3                   	ret    
...
pushcli(void)
{
80103c2e:	55                   	push   %ebp
80103c2f:	89 e5                	mov    %esp,%ebp
80103c31:	53                   	push   %ebx
80103c32:	83 ec 04             	sub    $0x4,%esp
80103c35:	9c                   	pushf  
80103c36:	5b                   	pop    %ebx
  asm volatile("cli");
80103c37:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80103c38:	e8 d1 f5 ff ff       	call   8010320e <mycpu>
80103c3d:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103c44:	74 11                	je     80103c57 <pushcli+0x29>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80103c46:	e8 c3 f5 ff ff       	call   8010320e <mycpu>
80103c4b:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
80103c52:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103c55:	c9                   	leave  
80103c56:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
80103c57:	e8 b2 f5 ff ff       	call   8010320e <mycpu>
80103c5c:	81 e3 00 02 00 00    	and    $0x200,%ebx
80103c62:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80103c68:	eb dc                	jmp    80103c46 <pushcli+0x18>
...
80103c71:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103c72:	f6 c4 02             	test   $0x2,%ah
80103c75:	75 28                	jne    80103c9f <popcli+0x35>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80103c77:	e8 92 f5 ff ff       	call   8010320e <mycpu>
80103c7c:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80103c82:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103c85:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80103c8b:	85 d2                	test   %edx,%edx
80103c8d:	78 1d                	js     80103cac <popcli+0x42>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103c8f:	e8 7a f5 ff ff       	call   8010320e <mycpu>
80103c94:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103c9b:	74 1c                	je     80103cb9 <popcli+0x4f>
    sti();
}
80103c9d:	c9                   	leave  
80103c9e:	c3                   	ret    
...
80103ca2:	68 c7 6f 10 80       	push   $0x80106fc7
80103ca7:	e8 9c c6 ff ff       	call   80100348 <panic>
    panic("popcli");
80103cac:	83 ec 0c             	sub    $0xc,%esp
80103caf:	68 de 6f 10 80       	push   $0x80106fde
80103cb4:	e8 8f c6 ff ff       	call   80100348 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103cb9:	e8 50 f5 ff ff       	call   8010320e <mycpu>
80103cbe:	83 b8 a8 00 00 00 00 	cmpl   $0x0,0xa8(%eax)
80103cc5:	74 d6                	je     80103c9d <popcli+0x33>
  asm volatile("sti");
80103cc7:	fb                   	sti    
}
80103cc8:	eb d3                	jmp    80103c9d <popcli+0x33>
...
80103cd1:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80103cd4:	e8 55 ff ff ff       	call   80103c2e <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80103cd9:	83 3b 00             	cmpl   $0x0,(%ebx)
80103cdc:	75 11                	jne    80103cef <holding+0x25>
80103cde:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
80103ce3:	e8 82 ff ff ff       	call   80103c6a <popcli>
}
...
80103cee:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80103cef:	8b 5b 08             	mov    0x8(%ebx),%ebx
80103cf2:	e8 17 f5 ff ff       	call   8010320e <mycpu>
80103cf7:	39 c3                	cmp    %eax,%ebx
80103cf9:	74 07                	je     80103d02 <holding+0x38>
80103cfb:	bb 00 00 00 00       	mov    $0x0,%ebx
80103d00:	eb e1                	jmp    80103ce3 <holding+0x19>
80103d02:	bb 01 00 00 00       	mov    $0x1,%ebx
80103d07:	eb da                	jmp    80103ce3 <holding+0x19>
...
80103d10:	e8 19 ff ff ff       	call   80103c2e <pushcli>
  if(holding(lk))
80103d15:	83 ec 0c             	sub    $0xc,%esp
80103d18:	ff 75 08             	push   0x8(%ebp)
80103d1b:	e8 aa ff ff ff       	call   80103cca <holding>
80103d20:	83 c4 10             	add    $0x10,%esp
80103d23:	85 c0                	test   %eax,%eax
80103d25:	75 3a                	jne    80103d61 <acquire+0x58>
  while(xchg(&lk->locked, 1) != 0)
80103d27:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80103d2a:	b8 01 00 00 00       	mov    $0x1,%eax
80103d2f:	f0 87 02             	lock xchg %eax,(%edx)
80103d32:	85 c0                	test   %eax,%eax
80103d34:	75 f1                	jne    80103d27 <acquire+0x1e>
  __sync_synchronize();
80103d36:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80103d3b:	8b 5d 08             	mov    0x8(%ebp),%ebx
80103d3e:	e8 cb f4 ff ff       	call   8010320e <mycpu>
80103d43:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80103d46:	8b 45 08             	mov    0x8(%ebp),%eax
80103d49:	83 c0 0c             	add    $0xc,%eax
80103d4c:	83 ec 08             	sub    $0x8,%esp
80103d4f:	50                   	push   %eax
80103d50:	8d 45 08             	lea    0x8(%ebp),%eax
80103d53:	50                   	push   %eax
80103d54:	e8 8f fe ff ff       	call   80103be8 <getcallerpcs>
}
...
80103d64:	68 e5 6f 10 80       	push   $0x80106fe5
80103d69:	e8 da c5 ff ff       	call   80100348 <panic>
...
80103d72:	83 ec 10             	sub    $0x10,%esp
80103d75:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
80103d78:	53                   	push   %ebx
80103d79:	e8 4c ff ff ff       	call   80103cca <holding>
80103d7e:	83 c4 10             	add    $0x10,%esp
80103d81:	85 c0                	test   %eax,%eax
80103d83:	74 23                	je     80103da8 <release+0x3a>
  lk->pcs[0] = 0;
80103d85:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80103d8c:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80103d93:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80103d98:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103d9e:	e8 c7 fe ff ff       	call   80103c6a <popcli>
}
80103da3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103da6:	c9                   	leave  
80103da7:	c3                   	ret    
    panic("release");
80103da8:	83 ec 0c             	sub    $0xc,%esp
80103dab:	68 ed 6f 10 80       	push   $0x80106fed
80103db0:	e8 93 c5 ff ff       	call   80100348 <panic>
...
80103dc3:	f6 c2 03             	test   $0x3,%dl
80103dc6:	75 25                	jne    80103ded <memset+0x38>
80103dc8:	f6 c1 03             	test   $0x3,%cl
80103dcb:	75 20                	jne    80103ded <memset+0x38>
    c &= 0xFF;
80103dcd:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80103dd0:	c1 e9 02             	shr    $0x2,%ecx
80103dd3:	c1 e0 18             	shl    $0x18,%eax
80103dd6:	89 fb                	mov    %edi,%ebx
80103dd8:	c1 e3 10             	shl    $0x10,%ebx
80103ddb:	09 d8                	or     %ebx,%eax
80103ddd:	89 fb                	mov    %edi,%ebx
80103ddf:	c1 e3 08             	shl    $0x8,%ebx
80103de2:	09 d8                	or     %ebx,%eax
80103de4:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80103de6:	89 d7                	mov    %edx,%edi
80103de8:	fc                   	cld    
80103de9:	f3 ab                	rep stos %eax,%es:(%edi)
}
80103deb:	eb 05                	jmp    80103df2 <memset+0x3d>
  asm volatile("cld; rep stosb" :
80103ded:	89 d7                	mov    %edx,%edi
80103def:	fc                   	cld    
80103df0:	f3 aa                	rep stos %al,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80103df2:	89 d0                	mov    %edx,%eax
80103df4:	5b                   	pop    %ebx
80103df5:	5f                   	pop    %edi
80103df6:	5d                   	pop    %ebp
80103df7:	c3                   	ret    
...
80103dfd:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103e00:	8b 55 0c             	mov    0xc(%ebp),%edx
80103e03:	8b 45 10             	mov    0x10(%ebp),%eax
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
80103e06:	eb 08                	jmp    80103e10 <memcmp+0x18>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
80103e08:	83 c1 01             	add    $0x1,%ecx
80103e0b:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80103e0e:	89 f0                	mov    %esi,%eax
80103e10:	8d 70 ff             	lea    -0x1(%eax),%esi
80103e13:	85 c0                	test   %eax,%eax
80103e15:	74 12                	je     80103e29 <memcmp+0x31>
    if(*s1 != *s2)
80103e17:	0f b6 01             	movzbl (%ecx),%eax
80103e1a:	0f b6 1a             	movzbl (%edx),%ebx
80103e1d:	38 d8                	cmp    %bl,%al
80103e1f:	74 e7                	je     80103e08 <memcmp+0x10>
      return *s1 - *s2;
...
80103e32:	8b 75 08             	mov    0x8(%ebp),%esi
80103e35:	8b 55 0c             	mov    0xc(%ebp),%edx
80103e38:	8b 45 10             	mov    0x10(%ebp),%eax
  const char *s;
  char *d;
...
80103e3d:	73 3c                	jae    80103e7b <memmove+0x4e>
80103e3f:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80103e42:	39 f1                	cmp    %esi,%ecx
80103e44:	76 39                	jbe    80103e7f <memmove+0x52>
    s += n;
    d += n;
80103e46:	8d 14 06             	lea    (%esi,%eax,1),%edx
    while(n-- > 0)
80103e49:	eb 0d                	jmp    80103e58 <memmove+0x2b>
      *--d = *--s;
80103e4b:	83 e9 01             	sub    $0x1,%ecx
80103e4e:	83 ea 01             	sub    $0x1,%edx
80103e51:	0f b6 01             	movzbl (%ecx),%eax
80103e54:	88 02                	mov    %al,(%edx)
    while(n-- > 0)
80103e56:	89 d8                	mov    %ebx,%eax
80103e58:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103e5b:	85 c0                	test   %eax,%eax
80103e5d:	75 ec                	jne    80103e4b <memmove+0x1e>
80103e5f:	eb 14                	jmp    80103e75 <memmove+0x48>
  } else
    while(n-- > 0)
      *d++ = *s++;
80103e61:	0f b6 02             	movzbl (%edx),%eax
80103e64:	88 01                	mov    %al,(%ecx)
80103e66:	8d 49 01             	lea    0x1(%ecx),%ecx
80103e69:	8d 52 01             	lea    0x1(%edx),%edx
    while(n-- > 0)
80103e6c:	89 d8                	mov    %ebx,%eax
80103e6e:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103e71:	85 c0                	test   %eax,%eax
80103e73:	75 ec                	jne    80103e61 <memmove+0x34>

  return dst;
}
80103e75:	89 f0                	mov    %esi,%eax
80103e77:	5b                   	pop    %ebx
80103e78:	5e                   	pop    %esi
80103e79:	5d                   	pop    %ebp
80103e7a:	c3                   	ret    
80103e7b:	89 f1                	mov    %esi,%ecx
80103e7d:	eb ef                	jmp    80103e6e <memmove+0x41>
80103e7f:	89 f1                	mov    %esi,%ecx
80103e81:	eb eb                	jmp    80103e6e <memmove+0x41>
...
80103e92:	e8 96 ff ff ff       	call   80103e2d <memmove>
}
80103e97:	c9                   	leave  
80103e98:	c3                   	ret    
...
80103ea0:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103ea3:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80103ea6:	eb 09                	jmp    80103eb1 <strncmp+0x18>
    n--, p++, q++;
80103ea8:	83 e8 01             	sub    $0x1,%eax
80103eab:	83 c2 01             	add    $0x1,%edx
80103eae:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80103eb1:	85 c0                	test   %eax,%eax
80103eb3:	74 0b                	je     80103ec0 <strncmp+0x27>
80103eb5:	0f b6 1a             	movzbl (%edx),%ebx
80103eb8:	84 db                	test   %bl,%bl
80103eba:	74 04                	je     80103ec0 <strncmp+0x27>
80103ebc:	3a 19                	cmp    (%ecx),%bl
80103ebe:	74 e8                	je     80103ea8 <strncmp+0xf>
  if(n == 0)
80103ec0:	85 c0                	test   %eax,%eax
80103ec2:	74 0d                	je     80103ed1 <strncmp+0x38>
    return 0;
  return (uchar)*p - (uchar)*q;
80103ec4:	0f b6 02             	movzbl (%edx),%eax
80103ec7:	0f b6 11             	movzbl (%ecx),%edx
...
80103ed6:	eb f4                	jmp    80103ecc <strncmp+0x33>
...
80103edc:	56                   	push   %esi
80103edd:	53                   	push   %ebx
80103ede:	8b 7d 08             	mov    0x8(%ebp),%edi
...
80103ee4:	8b 45 10             	mov    0x10(%ebp),%eax
  ...
  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80103ee7:	89 fa                	mov    %edi,%edx
80103ee9:	eb 04                	jmp    80103eef <strncpy+0x17>
80103eeb:	89 f1                	mov    %esi,%ecx
80103eed:	89 da                	mov    %ebx,%edx
80103eef:	89 c3                	mov    %eax,%ebx
80103ef1:	83 e8 01             	sub    $0x1,%eax
80103ef4:	85 db                	test   %ebx,%ebx
80103ef6:	7e 11                	jle    80103f09 <strncpy+0x31>
80103ef8:	8d 71 01             	lea    0x1(%ecx),%esi
80103efb:	8d 5a 01             	lea    0x1(%edx),%ebx
80103efe:	0f b6 09             	movzbl (%ecx),%ecx
80103f01:	88 0a                	mov    %cl,(%edx)
80103f03:	84 c9                	test   %cl,%cl
80103f05:	75 e4                	jne    80103eeb <strncpy+0x13>
80103f07:	89 da                	mov    %ebx,%edx
    ;
  while(n-- > 0)
80103f09:	8d 48 ff             	lea    -0x1(%eax),%ecx
80103f0c:	85 c0                	test   %eax,%eax
80103f0e:	7e 0a                	jle    80103f1a <strncpy+0x42>
    *s++ = 0;
80103f10:	c6 02 00             	movb   $0x0,(%edx)
  while(n-- > 0)
80103f13:	89 c8                	mov    %ecx,%eax
    *s++ = 0;
80103f15:	8d 52 01             	lea    0x1(%edx),%edx
80103f18:	eb ef                	jmp    80103f09 <strncpy+0x31>
  return os;
}
80103f1a:	89 f8                	mov    %edi,%eax
80103f1c:	5b                   	pop    %ebx
80103f1d:	5e                   	pop    %esi
80103f1e:	5f                   	pop    %edi
80103f1f:	5d                   	pop    %ebp
...
80103f24:	57                   	push   %edi
80103f25:	56                   	push   %esi
80103f26:	53                   	push   %ebx
80103f27:	8b 7d 08             	mov    0x8(%ebp),%edi
80103f2a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
80103f32:	7e 23                	jle    80103f57 <safestrcpy+0x36>
80103f34:	89 fa                	mov    %edi,%edx
80103f36:	eb 04                	jmp    80103f3c <safestrcpy+0x1b>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80103f38:	89 f1                	mov    %esi,%ecx
80103f3a:	89 da                	mov    %ebx,%edx
80103f3c:	83 e8 01             	sub    $0x1,%eax
80103f3f:	85 c0                	test   %eax,%eax
80103f41:	7e 11                	jle    80103f54 <safestrcpy+0x33>
80103f43:	8d 71 01             	lea    0x1(%ecx),%esi
80103f46:	8d 5a 01             	lea    0x1(%edx),%ebx
80103f49:	0f b6 09             	movzbl (%ecx),%ecx
80103f4c:	88 0a                	mov    %cl,(%edx)
80103f4e:	84 c9                	test   %cl,%cl
80103f50:	75 e6                	jne    80103f38 <safestrcpy+0x17>
80103f52:	89 da                	mov    %ebx,%edx
    ;
  *s = 0;
80103f54:	c6 02 00             	movb   $0x0,(%edx)
  return os;
}
80103f57:	89 f8                	mov    %edi,%eax
80103f59:	5b                   	pop    %ebx
80103f5a:	5e                   	pop    %esi
80103f5b:	5f                   	pop    %edi
80103f5c:	5d                   	pop    %ebp
...
80103f61:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  for(n = 0; s[n]; n++)
80103f64:	b8 00 00 00 00       	mov    $0x0,%eax
80103f69:	eb 03                	jmp    80103f6e <strlen+0x10>
80103f6b:	83 c0 01             	add    $0x1,%eax
80103f6e:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80103f72:	75 f7                	jne    80103f6b <strlen+0xd>
    ;
  return n;
}
80103f74:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80103f76:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80103f7a:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80103f81:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80103f82:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80103f84:	89 d4                	mov    %edx,%esp
...
80103f92:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80103f95:	e8 eb f2 ff ff       	call   80103285 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80103f9a:	8b 00                	mov    (%eax),%eax
80103f9c:	39 d8                	cmp    %ebx,%eax
80103f9e:	76 18                	jbe    80103fb8 <fetchint+0x2d>
80103fa0:	8d 53 04             	lea    0x4(%ebx),%edx
80103fa3:	39 d0                	cmp    %edx,%eax
80103fa5:	72 18                	jb     80103fbf <fetchint+0x34>
    return -1;
  *ip = *(int*)(addr);
80103fa7:	8b 13                	mov    (%ebx),%edx
80103fa9:	8b 45 0c             	mov    0xc(%ebp),%eax
80103fac:	89 10                	mov    %edx,(%eax)
  return 0;
80103fae:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80103fbd:	eb f4                	jmp    80103fb3 <fetchint+0x28>
80103fbf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103fc4:	eb ed                	jmp    80103fb3 <fetchint+0x28>
...
80103fcd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80103fd0:	e8 b0 f2 ff ff       	call   80103285 <myproc>

  if(addr >= curproc->sz)
80103fd5:	39 18                	cmp    %ebx,(%eax)
80103fd7:	76 25                	jbe    80103ffe <fetchstr+0x38>
    return -1;
  *pp = (char*)addr;
...
80103fde:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80103fe0:	89 d8                	mov    %ebx,%eax
80103fe2:	eb 03                	jmp    80103fe7 <fetchstr+0x21>
80103fe4:	83 c0 01             	add    $0x1,%eax
80103fe7:	39 d0                	cmp    %edx,%eax
80103fe9:	73 09                	jae    80103ff4 <fetchstr+0x2e>
    if(*s == 0)
80103feb:	80 38 00             	cmpb   $0x0,(%eax)
80103fee:	75 f4                	jne    80103fe4 <fetchstr+0x1e>
      return s - *pp;
80103ff0:	29 d8                	sub    %ebx,%eax
80103ff2:	eb 05                	jmp    80103ff9 <fetchstr+0x33>
  }
  return -1;
...
80104003:	eb f4                	jmp    80103ff9 <fetchstr+0x33>
...
8010400b:	e8 75 f2 ff ff       	call   80103285 <myproc>
80104010:	8b 50 18             	mov    0x18(%eax),%edx
80104013:	8b 45 08             	mov    0x8(%ebp),%eax
80104016:	c1 e0 02             	shl    $0x2,%eax
80104019:	03 42 44             	add    0x44(%edx),%eax
8010401c:	83 ec 08             	sub    $0x8,%esp
8010401f:	ff 75 0c             	push   0xc(%ebp)
80104022:	83 c0 04             	add    $0x4,%eax
80104025:	50                   	push   %eax
80104026:	e8 60 ff ff ff       	call   80103f8b <fetchint>
}
8010402b:	c9                   	leave  
8010402c:	c3                   	ret    
...
80104030:	56                   	push   %esi
80104031:	53                   	push   %ebx
80104032:	83 ec 10             	sub    $0x10,%esp
80104035:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104038:	e8 48 f2 ff ff       	call   80103285 <myproc>
8010403d:	89 c6                	mov    %eax,%esi
 
  if(argint(n, &i) < 0)
8010403f:	83 ec 08             	sub    $0x8,%esp
80104042:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104045:	50                   	push   %eax
80104046:	ff 75 08             	push   0x8(%ebp)
80104049:	e8 b7 ff ff ff       	call   80104005 <argint>
8010404e:	83 c4 10             	add    $0x10,%esp
80104051:	85 c0                	test   %eax,%eax
80104053:	78 24                	js     80104079 <argptr+0x4c>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104055:	85 db                	test   %ebx,%ebx
80104057:	78 27                	js     80104080 <argptr+0x53>
80104059:	8b 16                	mov    (%esi),%edx
8010405b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010405e:	39 c2                	cmp    %eax,%edx
80104060:	76 25                	jbe    80104087 <argptr+0x5a>
80104062:	01 c3                	add    %eax,%ebx
80104064:	39 da                	cmp    %ebx,%edx
80104066:	72 26                	jb     8010408e <argptr+0x61>
    return -1;
  *pp = (char*)i;
80104068:	8b 55 0c             	mov    0xc(%ebp),%edx
8010406b:	89 02                	mov    %eax,(%edx)
  return 0;
8010406d:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104072:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104075:	5b                   	pop    %ebx
80104076:	5e                   	pop    %esi
80104077:	5d                   	pop    %ebp
80104078:	c3                   	ret    
    return -1;
80104079:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010407e:	eb f2                	jmp    80104072 <argptr+0x45>
    return -1;
80104080:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104085:	eb eb                	jmp    80104072 <argptr+0x45>
80104087:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010408c:	eb e4                	jmp    80104072 <argptr+0x45>
8010408e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104093:	eb dd                	jmp    80104072 <argptr+0x45>
...
8010409f:	ff 75 08             	push   0x8(%ebp)
801040a2:	e8 5e ff ff ff       	call   80104005 <argint>
801040a7:	83 c4 10             	add    $0x10,%esp
801040aa:	85 c0                	test   %eax,%eax
801040ac:	78 13                	js     801040c1 <argstr+0x2c>
    return -1;
  return fetchstr(addr, pp);
801040ae:	83 ec 08             	sub    $0x8,%esp
801040b1:	ff 75 0c             	push   0xc(%ebp)
801040b4:	ff 75 f4             	push   -0xc(%ebp)
801040b7:	e8 0a ff ff ff       	call   80103fc6 <fetchstr>
...
801040c6:	eb f7                	jmp    801040bf <argstr+0x2a>
...
801040cc:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801040cf:	e8 b1 f1 ff ff       	call   80103285 <myproc>
801040d4:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
801040d6:	8b 40 18             	mov    0x18(%eax),%eax
801040d9:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801040dc:	8d 50 ff             	lea    -0x1(%eax),%edx
801040df:	83 fa 1a             	cmp    $0x1a,%edx
801040e2:	77 17                	ja     801040fb <syscall+0x33>
801040e4:	8b 14 85 20 70 10 80 	mov    -0x7fef8fe0(,%eax,4),%edx
801040eb:	85 d2                	test   %edx,%edx
801040ed:	74 0c                	je     801040fb <syscall+0x33>
    curproc->tf->eax = syscalls[num]();
801040ef:	ff d2                	call   *%edx
801040f1:	89 c2                	mov    %eax,%edx
801040f3:	8b 43 18             	mov    0x18(%ebx),%eax
801040f6:	89 50 1c             	mov    %edx,0x1c(%eax)
801040f9:	eb 1f                	jmp    8010411a <syscall+0x52>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
801040fb:	8d 53 6c             	lea    0x6c(%ebx),%edx
    cprintf("%d %s: unknown sys call %d\n",
801040fe:	50                   	push   %eax
801040ff:	52                   	push   %edx
80104100:	ff 73 10             	push   0x10(%ebx)
80104103:	68 f5 6f 10 80       	push   $0x80106ff5
80104108:	e8 fa c4 ff ff       	call   80100607 <cprintf>
    curproc->tf->eax = -1;
8010410d:	8b 43 18             	mov    0x18(%ebx),%eax
80104110:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
...
80104124:	83 ec 18             	sub    $0x18,%esp
80104127:	89 d6                	mov    %edx,%esi
80104129:	89 cb                	mov    %ecx,%ebx
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
8010412b:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010412e:	52                   	push   %edx
8010412f:	50                   	push   %eax
80104130:	e8 d0 fe ff ff       	call   80104005 <argint>
80104135:	83 c4 10             	add    $0x10,%esp
80104138:	85 c0                	test   %eax,%eax
8010413a:	78 35                	js     80104171 <argfd+0x52>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
8010413c:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104140:	77 28                	ja     8010416a <argfd+0x4b>
80104142:	e8 3e f1 ff ff       	call   80103285 <myproc>
80104147:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010414a:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
8010414e:	85 c0                	test   %eax,%eax
80104150:	74 18                	je     8010416a <argfd+0x4b>
    return -1;
  if(pfd)
80104152:	85 f6                	test   %esi,%esi
80104154:	74 02                	je     80104158 <argfd+0x39>
    *pfd = fd;
80104156:	89 16                	mov    %edx,(%esi)
  if(pf)
80104158:	85 db                	test   %ebx,%ebx
8010415a:	74 1c                	je     80104178 <argfd+0x59>
    *pf = f;
8010415c:	89 03                	mov    %eax,(%ebx)
  return 0;
...
8010416f:	eb f2                	jmp    80104163 <argfd+0x44>
    return -1;
80104171:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104176:	eb eb                	jmp    80104163 <argfd+0x44>
  return 0;
80104178:	b8 00 00 00 00       	mov    $0x0,%eax
8010417d:	eb e4                	jmp    80104163 <argfd+0x44>
...
80104186:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
80104188:	e8 f8 f0 ff ff       	call   80103285 <myproc>
8010418d:	89 c2                	mov    %eax,%edx

  for(fd = 0; fd < NOFILE; fd++){
8010418f:	b8 00 00 00 00       	mov    $0x0,%eax
80104194:	83 f8 0f             	cmp    $0xf,%eax
80104197:	7f 12                	jg     801041ab <fdalloc+0x2c>
    if(curproc->ofile[fd] == 0){
80104199:	83 7c 82 28 00       	cmpl   $0x0,0x28(%edx,%eax,4)
8010419e:	74 05                	je     801041a5 <fdalloc+0x26>
  for(fd = 0; fd < NOFILE; fd++){
801041a0:	83 c0 01             	add    $0x1,%eax
801041a3:	eb ef                	jmp    80104194 <fdalloc+0x15>
      curproc->ofile[fd] = f;
801041a5:	89 5c 82 28          	mov    %ebx,0x28(%edx,%eax,4)
      return fd;
801041a9:	eb 05                	jmp    801041b0 <fdalloc+0x31>
    }
  }
  return -1;
...
801041ba:	83 ec 10             	sub    $0x10,%esp
801041bd:	89 c3                	mov    %eax,%ebx
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801041bf:	b8 20 00 00 00       	mov    $0x20,%eax
801041c4:	89 c6                	mov    %eax,%esi
801041c6:	39 43 58             	cmp    %eax,0x58(%ebx)
801041c9:	76 2e                	jbe    801041f9 <isdirempty+0x44>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801041cb:	6a 10                	push   $0x10
801041cd:	50                   	push   %eax
801041ce:	8d 45 e8             	lea    -0x18(%ebp),%eax
801041d1:	50                   	push   %eax
801041d2:	53                   	push   %ebx
801041d3:	e8 89 d5 ff ff       	call   80101761 <readi>
801041d8:	83 c4 10             	add    $0x10,%esp
801041db:	83 f8 10             	cmp    $0x10,%eax
801041de:	75 0c                	jne    801041ec <isdirempty+0x37>
      panic("isdirempty: readi");
    if(de.inum != 0)
801041e0:	66 83 7d e8 00       	cmpw   $0x0,-0x18(%ebp)
801041e5:	75 1e                	jne    80104205 <isdirempty+0x50>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801041e7:	8d 46 10             	lea    0x10(%esi),%eax
801041ea:	eb d8                	jmp    801041c4 <isdirempty+0xf>
      panic("isdirempty: readi");
801041ec:	83 ec 0c             	sub    $0xc,%esp
801041ef:	68 90 70 10 80       	push   $0x80107090
801041f4:	e8 4f c1 ff ff       	call   80100348 <panic>
      return 0;
  }
  return 1;
...
8010420a:	eb f2                	jmp    801041fe <isdirempty+0x49>
...
8010420f:	57                   	push   %edi
80104210:	56                   	push   %esi
80104211:	53                   	push   %ebx
80104212:	83 ec 34             	sub    $0x34,%esp
80104215:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104218:	89 4d d0             	mov    %ecx,-0x30(%ebp)
8010421b:	8b 7d 08             	mov    0x8(%ebp),%edi
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
8010421e:	8d 55 da             	lea    -0x26(%ebp),%edx
80104221:	52                   	push   %edx
80104222:	50                   	push   %eax
80104223:	e8 bd d9 ff ff       	call   80101be5 <nameiparent>
80104228:	89 c6                	mov    %eax,%esi
8010422a:	83 c4 10             	add    $0x10,%esp
8010422d:	85 c0                	test   %eax,%eax
8010422f:	0f 84 33 01 00 00    	je     80104368 <create+0x15c>
    return 0;
  ilock(dp);
80104235:	83 ec 0c             	sub    $0xc,%esp
80104238:	50                   	push   %eax
80104239:	e8 31 d3 ff ff       	call   8010156f <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
8010423e:	83 c4 0c             	add    $0xc,%esp
80104241:	6a 00                	push   $0x0
80104243:	8d 45 da             	lea    -0x26(%ebp),%eax
80104246:	50                   	push   %eax
80104247:	56                   	push   %esi
80104248:	e8 52 d7 ff ff       	call   8010199f <dirlookup>
8010424d:	89 c3                	mov    %eax,%ebx
8010424f:	83 c4 10             	add    $0x10,%esp
80104252:	85 c0                	test   %eax,%eax
80104254:	74 3d                	je     80104293 <create+0x87>
    iunlockput(dp);
80104256:	83 ec 0c             	sub    $0xc,%esp
80104259:	56                   	push   %esi
8010425a:	e8 b7 d4 ff ff       	call   80101716 <iunlockput>
    ilock(ip);
8010425f:	89 1c 24             	mov    %ebx,(%esp)
80104262:	e8 08 d3 ff ff       	call   8010156f <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104267:	83 c4 10             	add    $0x10,%esp
8010426a:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
8010426f:	75 07                	jne    80104278 <create+0x6c>
80104271:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
80104276:	74 11                	je     80104289 <create+0x7d>
      return ip;
    iunlockput(ip);
80104278:	83 ec 0c             	sub    $0xc,%esp
8010427b:	53                   	push   %ebx
8010427c:	e8 95 d4 ff ff       	call   80101716 <iunlockput>
    return 0;
80104281:	83 c4 10             	add    $0x10,%esp
80104284:	bb 00 00 00 00       	mov    $0x0,%ebx
...
80104289:	89 d8                	mov    %ebx,%eax
8010428b:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010428e:	5b                   	pop    %ebx
8010428f:	5e                   	pop    %esi
80104290:	5f                   	pop    %edi
80104291:	5d                   	pop    %ebp
...
80104296:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
8010429a:	50                   	push   %eax
8010429b:	ff 36                	push   (%esi)
8010429d:	e8 ca d0 ff ff       	call   8010136c <ialloc>
801042a2:	89 c3                	mov    %eax,%ebx
801042a4:	83 c4 10             	add    $0x10,%esp
801042a7:	85 c0                	test   %eax,%eax
801042a9:	74 52                	je     801042fd <create+0xf1>
  ilock(ip);
801042ab:	83 ec 0c             	sub    $0xc,%esp
801042ae:	50                   	push   %eax
801042af:	e8 bb d2 ff ff       	call   8010156f <ilock>
  ip->major = major;
801042b4:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
801042b8:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
801042bc:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
801042c0:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
801042c6:	89 1c 24             	mov    %ebx,(%esp)
801042c9:	e8 40 d1 ff ff       	call   8010140e <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
801042ce:	83 c4 10             	add    $0x10,%esp
801042d1:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801042d6:	74 32                	je     8010430a <create+0xfe>
  if(dirlink(dp, name, ip->inum) < 0)
801042d8:	83 ec 04             	sub    $0x4,%esp
801042db:	ff 73 04             	push   0x4(%ebx)
801042de:	8d 45 da             	lea    -0x26(%ebp),%eax
801042e1:	50                   	push   %eax
801042e2:	56                   	push   %esi
801042e3:	e8 34 d8 ff ff       	call   80101b1c <dirlink>
801042e8:	83 c4 10             	add    $0x10,%esp
801042eb:	85 c0                	test   %eax,%eax
801042ed:	78 6c                	js     8010435b <create+0x14f>
  iunlockput(dp);
801042ef:	83 ec 0c             	sub    $0xc,%esp
801042f2:	56                   	push   %esi
801042f3:	e8 1e d4 ff ff       	call   80101716 <iunlockput>
  return ip;
801042f8:	83 c4 10             	add    $0x10,%esp
801042fb:	eb 8c                	jmp    80104289 <create+0x7d>
    panic("create: ialloc");
801042fd:	83 ec 0c             	sub    $0xc,%esp
80104300:	68 a2 70 10 80       	push   $0x801070a2
80104305:	e8 3e c0 ff ff       	call   80100348 <panic>
    dp->nlink++;  // for ".."
8010430a:	0f b7 46 56          	movzwl 0x56(%esi),%eax
8010430e:	83 c0 01             	add    $0x1,%eax
80104311:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104315:	83 ec 0c             	sub    $0xc,%esp
80104318:	56                   	push   %esi
80104319:	e8 f0 d0 ff ff       	call   8010140e <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010431e:	83 c4 0c             	add    $0xc,%esp
80104321:	ff 73 04             	push   0x4(%ebx)
80104324:	68 b2 70 10 80       	push   $0x801070b2
80104329:	53                   	push   %ebx
8010432a:	e8 ed d7 ff ff       	call   80101b1c <dirlink>
8010432f:	83 c4 10             	add    $0x10,%esp
80104332:	85 c0                	test   %eax,%eax
80104334:	78 18                	js     8010434e <create+0x142>
80104336:	83 ec 04             	sub    $0x4,%esp
80104339:	ff 76 04             	push   0x4(%esi)
8010433c:	68 b1 70 10 80       	push   $0x801070b1
80104341:	53                   	push   %ebx
80104342:	e8 d5 d7 ff ff       	call   80101b1c <dirlink>
80104347:	83 c4 10             	add    $0x10,%esp
8010434a:	85 c0                	test   %eax,%eax
8010434c:	79 8a                	jns    801042d8 <create+0xcc>
      panic("create dots");
8010434e:	83 ec 0c             	sub    $0xc,%esp
80104351:	68 b4 70 10 80       	push   $0x801070b4
80104356:	e8 ed bf ff ff       	call   80100348 <panic>
    panic("create: dirlink");
8010435b:	83 ec 0c             	sub    $0xc,%esp
8010435e:	68 c0 70 10 80       	push   $0x801070c0
80104363:	e8 e0 bf ff ff       	call   80100348 <panic>
    return 0;
80104368:	89 c3                	mov    %eax,%ebx
8010436a:	e9 1a ff ff ff       	jmp    80104289 <create+0x7d>

8010436f <sys_writecount>:
  w_count++;
8010436f:	a1 58 3e 11 80       	mov    0x80113e58,%eax
80104374:	83 c0 01             	add    $0x1,%eax
80104377:	a3 58 3e 11 80       	mov    %eax,0x80113e58
}
8010437c:	c3                   	ret    

8010437d <sys_setwritecount>:
sys_setwritecount(void) {
8010437d:	55                   	push   %ebp
8010437e:	89 e5                	mov    %esp,%ebp
80104380:	83 ec 20             	sub    $0x20,%esp
  if(argint(0, &i) < 0){
80104383:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104386:	50                   	push   %eax
80104387:	6a 00                	push   $0x0
80104389:	e8 77 fc ff ff       	call   80104005 <argint>
8010438e:	83 c4 10             	add    $0x10,%esp
80104391:	85 c0                	test   %eax,%eax
80104393:	78 0f                	js     801043a4 <sys_setwritecount+0x27>
  w_count = i;
80104395:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104398:	a3 58 3e 11 80       	mov    %eax,0x80113e58
  return 0;
...
801043a9:	eb f7                	jmp    801043a2 <sys_setwritecount+0x25>
...
801043af:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
801043b2:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801043b5:	ba 00 00 00 00       	mov    $0x0,%edx
801043ba:	b8 00 00 00 00       	mov    $0x0,%eax
801043bf:	e8 5b fd ff ff       	call   8010411f <argfd>
801043c4:	85 c0                	test   %eax,%eax
801043c6:	78 23                	js     801043eb <sys_dup+0x40>
  if((fd=fdalloc(f)) < 0)
801043c8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043cb:	e8 af fd ff ff       	call   8010417f <fdalloc>
801043d0:	89 c3                	mov    %eax,%ebx
801043d2:	85 c0                	test   %eax,%eax
801043d4:	78 1c                	js     801043f2 <sys_dup+0x47>
  filedup(f);
801043d6:	83 ec 0c             	sub    $0xc,%esp
801043d9:	ff 75 f4             	push   -0xc(%ebp)
801043dc:	e8 9d c8 ff ff       	call   80100c7e <filedup>
  return fd;
...
801043f0:	eb f2                	jmp    801043e4 <sys_dup+0x39>
    return -1;
801043f2:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801043f7:	eb eb                	jmp    801043e4 <sys_dup+0x39>
...
801043ff:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104402:	ba 00 00 00 00       	mov    $0x0,%edx
80104407:	b8 00 00 00 00       	mov    $0x0,%eax
8010440c:	e8 0e fd ff ff       	call   8010411f <argfd>
80104411:	85 c0                	test   %eax,%eax
80104413:	78 43                	js     80104458 <sys_read+0x5f>
80104415:	83 ec 08             	sub    $0x8,%esp
80104418:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010441b:	50                   	push   %eax
8010441c:	6a 02                	push   $0x2
8010441e:	e8 e2 fb ff ff       	call   80104005 <argint>
80104423:	83 c4 10             	add    $0x10,%esp
80104426:	85 c0                	test   %eax,%eax
80104428:	78 2e                	js     80104458 <sys_read+0x5f>
8010442a:	83 ec 04             	sub    $0x4,%esp
8010442d:	ff 75 f0             	push   -0x10(%ebp)
80104430:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104433:	50                   	push   %eax
80104434:	6a 01                	push   $0x1
80104436:	e8 f2 fb ff ff       	call   8010402d <argptr>
8010443b:	83 c4 10             	add    $0x10,%esp
8010443e:	85 c0                	test   %eax,%eax
80104440:	78 16                	js     80104458 <sys_read+0x5f>
  return fileread(f, p, n);
80104442:	83 ec 04             	sub    $0x4,%esp
80104445:	ff 75 f0             	push   -0x10(%ebp)
80104448:	ff 75 ec             	push   -0x14(%ebp)
8010444b:	ff 75 f4             	push   -0xc(%ebp)
8010444e:	e8 7d c9 ff ff       	call   80100dd0 <fileread>
...
8010445d:	eb f7                	jmp    80104456 <sys_read+0x5d>
...
801044a1:	e8 87 fb ff ff       	call   8010402d <argptr>
801044a6:	83 c4 10             	add    $0x10,%esp
801044a9:	85 c0                	test   %eax,%eax
801044ab:	78 16                	js     801044c3 <sys_write+0x64>
...
801044b9:	e8 97 c9 ff ff       	call   80100e55 <filewrite>
...
801044c8:	eb f7                	jmp    801044c1 <sys_write+0x62>
...
801044cd:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
801044d0:	8d 4d f0             	lea    -0x10(%ebp),%ecx
801044d3:	8d 55 f4             	lea    -0xc(%ebp),%edx
801044d6:	b8 00 00 00 00       	mov    $0x0,%eax
801044db:	e8 3f fc ff ff       	call   8010411f <argfd>
801044e0:	85 c0                	test   %eax,%eax
801044e2:	78 25                	js     80104509 <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
801044e4:	e8 9c ed ff ff       	call   80103285 <myproc>
801044e9:	8b 55 f4             	mov    -0xc(%ebp),%edx
801044ec:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
801044f3:	00 
  fileclose(f);
801044f4:	83 ec 0c             	sub    $0xc,%esp
801044f7:	ff 75 f0             	push   -0x10(%ebp)
801044fa:	e8 c4 c7 ff ff       	call   80100cc3 <fileclose>
  return 0;
801044ff:	83 c4 10             	add    $0x10,%esp
80104502:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104507:	c9                   	leave  
80104508:	c3                   	ret    
    return -1;
80104509:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010450e:	eb f7                	jmp    80104507 <sys_close+0x3d>
...
80104516:	8d 4d f4             	lea    -0xc(%ebp),%ecx
80104519:	ba 00 00 00 00       	mov    $0x0,%edx
8010451e:	b8 00 00 00 00       	mov    $0x0,%eax
80104523:	e8 f7 fb ff ff       	call   8010411f <argfd>
80104528:	85 c0                	test   %eax,%eax
8010452a:	78 2a                	js     80104556 <sys_fstat+0x46>
8010452c:	83 ec 04             	sub    $0x4,%esp
8010452f:	6a 14                	push   $0x14
80104531:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104534:	50                   	push   %eax
80104535:	6a 01                	push   $0x1
80104537:	e8 f1 fa ff ff       	call   8010402d <argptr>
8010453c:	83 c4 10             	add    $0x10,%esp
8010453f:	85 c0                	test   %eax,%eax
80104541:	78 13                	js     80104556 <sys_fstat+0x46>
  return filestat(f, st);
80104543:	83 ec 08             	sub    $0x8,%esp
80104546:	ff 75 f0             	push   -0x10(%ebp)
80104549:	ff 75 f4             	push   -0xc(%ebp)
8010454c:	e8 38 c8 ff ff       	call   80100d89 <filestat>
...
8010455b:	eb f7                	jmp    80104554 <sys_fstat+0x44>
...
8010456b:	e8 25 fb ff ff       	call   80104095 <argstr>
80104570:	83 c4 10             	add    $0x10,%esp
80104573:	85 c0                	test   %eax,%eax
80104575:	0f 88 d3 00 00 00    	js     8010464e <sys_link+0xf1>
8010457b:	83 ec 08             	sub    $0x8,%esp
8010457e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104581:	50                   	push   %eax
80104582:	6a 01                	push   $0x1
80104584:	e8 0c fb ff ff       	call   80104095 <argstr>
80104589:	83 c4 10             	add    $0x10,%esp
8010458c:	85 c0                	test   %eax,%eax
8010458e:	0f 88 ba 00 00 00    	js     8010464e <sys_link+0xf1>
  begin_op();
80104594:	e8 17 e2 ff ff       	call   801027b0 <begin_op>
  if((ip = namei(old)) == 0){
80104599:	83 ec 0c             	sub    $0xc,%esp
8010459c:	ff 75 e0             	push   -0x20(%ebp)
8010459f:	e8 29 d6 ff ff       	call   80101bcd <namei>
801045a4:	89 c3                	mov    %eax,%ebx
801045a6:	83 c4 10             	add    $0x10,%esp
801045a9:	85 c0                	test   %eax,%eax
801045ab:	0f 84 a4 00 00 00    	je     80104655 <sys_link+0xf8>
  ilock(ip);
801045b1:	83 ec 0c             	sub    $0xc,%esp
801045b4:	50                   	push   %eax
801045b5:	e8 b5 cf ff ff       	call   8010156f <ilock>
  if(ip->type == T_DIR){
801045ba:	83 c4 10             	add    $0x10,%esp
801045bd:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801045c2:	0f 84 99 00 00 00    	je     80104661 <sys_link+0x104>
  ip->nlink++;
801045c8:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801045cc:	83 c0 01             	add    $0x1,%eax
801045cf:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801045d3:	83 ec 0c             	sub    $0xc,%esp
801045d6:	53                   	push   %ebx
801045d7:	e8 32 ce ff ff       	call   8010140e <iupdate>
  iunlock(ip);
801045dc:	89 1c 24             	mov    %ebx,(%esp)
801045df:	e8 4d d0 ff ff       	call   80101631 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801045e4:	83 c4 08             	add    $0x8,%esp
801045e7:	8d 45 ea             	lea    -0x16(%ebp),%eax
801045ea:	50                   	push   %eax
801045eb:	ff 75 e4             	push   -0x1c(%ebp)
801045ee:	e8 f2 d5 ff ff       	call   80101be5 <nameiparent>
801045f3:	89 c6                	mov    %eax,%esi
801045f5:	83 c4 10             	add    $0x10,%esp
801045f8:	85 c0                	test   %eax,%eax
801045fa:	0f 84 85 00 00 00    	je     80104685 <sys_link+0x128>
  ilock(dp);
80104600:	83 ec 0c             	sub    $0xc,%esp
80104603:	50                   	push   %eax
80104604:	e8 66 cf ff ff       	call   8010156f <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104609:	83 c4 10             	add    $0x10,%esp
8010460c:	8b 03                	mov    (%ebx),%eax
8010460e:	39 06                	cmp    %eax,(%esi)
80104610:	75 67                	jne    80104679 <sys_link+0x11c>
80104612:	83 ec 04             	sub    $0x4,%esp
80104615:	ff 73 04             	push   0x4(%ebx)
80104618:	8d 45 ea             	lea    -0x16(%ebp),%eax
8010461b:	50                   	push   %eax
8010461c:	56                   	push   %esi
8010461d:	e8 fa d4 ff ff       	call   80101b1c <dirlink>
80104622:	83 c4 10             	add    $0x10,%esp
80104625:	85 c0                	test   %eax,%eax
80104627:	78 50                	js     80104679 <sys_link+0x11c>
  iunlockput(dp);
80104629:	83 ec 0c             	sub    $0xc,%esp
8010462c:	56                   	push   %esi
8010462d:	e8 e4 d0 ff ff       	call   80101716 <iunlockput>
  iput(ip);
80104632:	89 1c 24             	mov    %ebx,(%esp)
80104635:	e8 3c d0 ff ff       	call   80101676 <iput>
  end_op();
8010463a:	e8 eb e1 ff ff       	call   8010282a <end_op>
  return 0;
...
80104653:	eb f2                	jmp    80104647 <sys_link+0xea>
    end_op();
80104655:	e8 d0 e1 ff ff       	call   8010282a <end_op>
    return -1;
8010465a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010465f:	eb e6                	jmp    80104647 <sys_link+0xea>
    iunlockput(ip);
80104661:	83 ec 0c             	sub    $0xc,%esp
80104664:	53                   	push   %ebx
80104665:	e8 ac d0 ff ff       	call   80101716 <iunlockput>
    end_op();
8010466a:	e8 bb e1 ff ff       	call   8010282a <end_op>
    return -1;
8010466f:	83 c4 10             	add    $0x10,%esp
80104672:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104677:	eb ce                	jmp    80104647 <sys_link+0xea>
    iunlockput(dp);
80104679:	83 ec 0c             	sub    $0xc,%esp
8010467c:	56                   	push   %esi
8010467d:	e8 94 d0 ff ff       	call   80101716 <iunlockput>
    goto bad;
...
80104689:	e8 e1 ce ff ff       	call   8010156f <ilock>
  ip->nlink--;
8010468e:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104692:	83 e8 01             	sub    $0x1,%eax
80104695:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
80104699:	89 1c 24             	mov    %ebx,(%esp)
8010469c:	e8 6d cd ff ff       	call   8010140e <iupdate>
  iunlockput(ip);
801046a1:	89 1c 24             	mov    %ebx,(%esp)
801046a4:	e8 6d d0 ff ff       	call   80101716 <iunlockput>
  end_op();
801046a9:	e8 7c e1 ff ff       	call   8010282a <end_op>
  return -1;
801046ae:	83 c4 10             	add    $0x10,%esp
801046b1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046b6:	eb 8f                	jmp    80104647 <sys_link+0xea>

801046b8 <sys_unlink>:
{
801046b8:	55                   	push   %ebp
801046b9:	89 e5                	mov    %esp,%ebp
801046bb:	57                   	push   %edi
801046bc:	56                   	push   %esi
801046bd:	53                   	push   %ebx
801046be:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
801046c1:	8d 45 c4             	lea    -0x3c(%ebp),%eax
801046c4:	50                   	push   %eax
801046c5:	6a 00                	push   $0x0
801046c7:	e8 c9 f9 ff ff       	call   80104095 <argstr>
801046cc:	83 c4 10             	add    $0x10,%esp
801046cf:	85 c0                	test   %eax,%eax
801046d1:	0f 88 83 01 00 00    	js     8010485a <sys_unlink+0x1a2>
  begin_op();
801046d7:	e8 d4 e0 ff ff       	call   801027b0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801046dc:	83 ec 08             	sub    $0x8,%esp
801046df:	8d 45 ca             	lea    -0x36(%ebp),%eax
801046e2:	50                   	push   %eax
801046e3:	ff 75 c4             	push   -0x3c(%ebp)
801046e6:	e8 fa d4 ff ff       	call   80101be5 <nameiparent>
801046eb:	89 c6                	mov    %eax,%esi
801046ed:	83 c4 10             	add    $0x10,%esp
801046f0:	85 c0                	test   %eax,%eax
801046f2:	0f 84 ed 00 00 00    	je     801047e5 <sys_unlink+0x12d>
  ilock(dp);
801046f8:	83 ec 0c             	sub    $0xc,%esp
801046fb:	50                   	push   %eax
801046fc:	e8 6e ce ff ff       	call   8010156f <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104701:	83 c4 08             	add    $0x8,%esp
80104704:	68 b2 70 10 80       	push   $0x801070b2
80104709:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010470c:	50                   	push   %eax
8010470d:	e8 78 d2 ff ff       	call   8010198a <namecmp>
80104712:	83 c4 10             	add    $0x10,%esp
80104715:	85 c0                	test   %eax,%eax
80104717:	0f 84 fc 00 00 00    	je     80104819 <sys_unlink+0x161>
8010471d:	83 ec 08             	sub    $0x8,%esp
80104720:	68 b1 70 10 80       	push   $0x801070b1
80104725:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104728:	50                   	push   %eax
80104729:	e8 5c d2 ff ff       	call   8010198a <namecmp>
8010472e:	83 c4 10             	add    $0x10,%esp
80104731:	85 c0                	test   %eax,%eax
80104733:	0f 84 e0 00 00 00    	je     80104819 <sys_unlink+0x161>
...
80104745:	e8 55 d2 ff ff       	call   8010199f <dirlookup>
8010474a:	89 c3                	mov    %eax,%ebx
8010474c:	83 c4 10             	add    $0x10,%esp
8010474f:	85 c0                	test   %eax,%eax
80104751:	0f 84 c2 00 00 00    	je     80104819 <sys_unlink+0x161>
  ilock(ip);
80104757:	83 ec 0c             	sub    $0xc,%esp
8010475a:	50                   	push   %eax
8010475b:	e8 0f ce ff ff       	call   8010156f <ilock>
  if(ip->nlink < 1)
80104760:	83 c4 10             	add    $0x10,%esp
80104763:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104768:	0f 8e 83 00 00 00    	jle    801047f1 <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010476e:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104773:	0f 84 85 00 00 00    	je     801047fe <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
80104779:	83 ec 04             	sub    $0x4,%esp
8010477c:	6a 10                	push   $0x10
8010477e:	6a 00                	push   $0x0
80104780:	8d 7d d8             	lea    -0x28(%ebp),%edi
80104783:	57                   	push   %edi
80104784:	e8 2c f6 ff ff       	call   80103db5 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104789:	6a 10                	push   $0x10
8010478b:	ff 75 c0             	push   -0x40(%ebp)
8010478e:	57                   	push   %edi
8010478f:	56                   	push   %esi
80104790:	e8 c9 d0 ff ff       	call   8010185e <writei>
80104795:	83 c4 20             	add    $0x20,%esp
80104798:	83 f8 10             	cmp    $0x10,%eax
8010479b:	0f 85 90 00 00 00    	jne    80104831 <sys_unlink+0x179>
  if(ip->type == T_DIR){
801047a1:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801047a6:	0f 84 92 00 00 00    	je     8010483e <sys_unlink+0x186>
  iunlockput(dp);
801047ac:	83 ec 0c             	sub    $0xc,%esp
801047af:	56                   	push   %esi
801047b0:	e8 61 cf ff ff       	call   80101716 <iunlockput>
  ip->nlink--;
801047b5:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801047b9:	83 e8 01             	sub    $0x1,%eax
801047bc:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801047c0:	89 1c 24             	mov    %ebx,(%esp)
801047c3:	e8 46 cc ff ff       	call   8010140e <iupdate>
  iunlockput(ip);
801047c8:	89 1c 24             	mov    %ebx,(%esp)
801047cb:	e8 46 cf ff ff       	call   80101716 <iunlockput>
  end_op();
801047d0:	e8 55 e0 ff ff       	call   8010282a <end_op>
  return 0;
801047d5:	83 c4 10             	add    $0x10,%esp
801047d8:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
801047e4:	c3                   	ret    
    end_op();
801047e5:	e8 40 e0 ff ff       	call   8010282a <end_op>
    return -1;
801047ea:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801047ef:	eb ec                	jmp    801047dd <sys_unlink+0x125>
    panic("unlink: nlink < 1");
801047f1:	83 ec 0c             	sub    $0xc,%esp
801047f4:	68 d0 70 10 80       	push   $0x801070d0
801047f9:	e8 4a bb ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801047fe:	89 d8                	mov    %ebx,%eax
80104800:	e8 b0 f9 ff ff       	call   801041b5 <isdirempty>
80104805:	85 c0                	test   %eax,%eax
80104807:	0f 85 6c ff ff ff    	jne    80104779 <sys_unlink+0xc1>
    iunlockput(ip);
8010480d:	83 ec 0c             	sub    $0xc,%esp
80104810:	53                   	push   %ebx
80104811:	e8 00 cf ff ff       	call   80101716 <iunlockput>
    goto bad;
...
8010482f:	eb ac                	jmp    801047dd <sys_unlink+0x125>
    panic("unlink: writei");
80104831:	83 ec 0c             	sub    $0xc,%esp
80104834:	68 e2 70 10 80       	push   $0x801070e2
80104839:	e8 0a bb ff ff       	call   80100348 <panic>
    dp->nlink--;
8010483e:	0f b7 46 56          	movzwl 0x56(%esi),%eax
80104842:	83 e8 01             	sub    $0x1,%eax
80104845:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104849:	83 ec 0c             	sub    $0xc,%esp
8010484c:	56                   	push   %esi
8010484d:	e8 bc cb ff ff       	call   8010140e <iupdate>
80104852:	83 c4 10             	add    $0x10,%esp
80104855:	e9 52 ff ff ff       	jmp    801047ac <sys_unlink+0xf4>
    return -1;
8010485a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010485f:	e9 79 ff ff ff       	jmp    801047dd <sys_unlink+0x125>
...
8010486a:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
8010486d:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104870:	50                   	push   %eax
80104871:	6a 00                	push   $0x0
80104873:	e8 1d f8 ff ff       	call   80104095 <argstr>
80104878:	83 c4 10             	add    $0x10,%esp
8010487b:	85 c0                	test   %eax,%eax
8010487d:	0f 88 a0 00 00 00    	js     80104923 <sys_open+0xbf>
80104883:	83 ec 08             	sub    $0x8,%esp
80104886:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104889:	50                   	push   %eax
8010488a:	6a 01                	push   $0x1
8010488c:	e8 74 f7 ff ff       	call   80104005 <argint>
80104891:	83 c4 10             	add    $0x10,%esp
80104894:	85 c0                	test   %eax,%eax
80104896:	0f 88 87 00 00 00    	js     80104923 <sys_open+0xbf>
    return -1;
...
8010489c:	e8 0f df ff ff       	call   801027b0 <begin_op>
  ...
  if(omode & O_CREATE){
801048a1:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
801048a5:	0f 84 8b 00 00 00    	je     80104936 <sys_open+0xd2>
    ip = create(path, T_FILE, 0, 0);
801048ab:	83 ec 0c             	sub    $0xc,%esp
801048ae:	6a 00                	push   $0x0
801048b0:	b9 00 00 00 00       	mov    $0x0,%ecx
801048b5:	ba 02 00 00 00       	mov    $0x2,%edx
801048ba:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801048bd:	e8 4a f9 ff ff       	call   8010420c <create>
801048c2:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801048c4:	83 c4 10             	add    $0x10,%esp
801048c7:	85 c0                	test   %eax,%eax
801048c9:	74 5f                	je     8010492a <sys_open+0xc6>
      end_op();
      return -1;
    }
  }
...
801048cb:	e8 4d c3 ff ff       	call   80100c1d <filealloc>
801048d0:	89 c3                	mov    %eax,%ebx
801048d2:	85 c0                	test   %eax,%eax
801048d4:	0f 84 b5 00 00 00    	je     8010498f <sys_open+0x12b>
801048da:	e8 a0 f8 ff ff       	call   8010417f <fdalloc>
801048df:	89 c7                	mov    %eax,%edi
801048e1:	85 c0                	test   %eax,%eax
801048e3:	0f 88 a6 00 00 00    	js     8010498f <sys_open+0x12b>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801048ed:	e8 3f cd ff ff       	call   80101631 <iunlock>
  end_op();
801048f2:	e8 33 df ff ff       	call   8010282a <end_op>

  f->type = FD_INODE;
801048f7:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
801048fd:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
80104900:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80104907:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010490a:	83 c4 10             	add    $0x10,%esp
8010490d:	a8 01                	test   $0x1,%al
8010490f:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80104913:	a8 03                	test   $0x3,%al
80104915:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
80104919:	89 f8                	mov    %edi,%eax
8010491b:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010491e:	5b                   	pop    %ebx
8010491f:	5e                   	pop    %esi
80104920:	5f                   	pop    %edi
80104921:	5d                   	pop    %ebp
80104922:	c3                   	ret    
    return -1;
80104923:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104928:	eb ef                	jmp    80104919 <sys_open+0xb5>
      end_op();
8010492a:	e8 fb de ff ff       	call   8010282a <end_op>
      return -1;
8010492f:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104934:	eb e3                	jmp    80104919 <sys_open+0xb5>
    if((ip = namei(path)) == 0){
80104936:	83 ec 0c             	sub    $0xc,%esp
80104939:	ff 75 e4             	push   -0x1c(%ebp)
8010493c:	e8 8c d2 ff ff       	call   80101bcd <namei>
80104941:	89 c6                	mov    %eax,%esi
80104943:	83 c4 10             	add    $0x10,%esp
80104946:	85 c0                	test   %eax,%eax
80104948:	74 39                	je     80104983 <sys_open+0x11f>
    ilock(ip);
8010494a:	83 ec 0c             	sub    $0xc,%esp
8010494d:	50                   	push   %eax
8010494e:	e8 1c cc ff ff       	call   8010156f <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104953:	83 c4 10             	add    $0x10,%esp
80104956:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
8010495b:	0f 85 6a ff ff ff    	jne    801048cb <sys_open+0x67>
80104961:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80104965:	0f 84 60 ff ff ff    	je     801048cb <sys_open+0x67>
      iunlockput(ip);
8010496b:	83 ec 0c             	sub    $0xc,%esp
8010496e:	56                   	push   %esi
8010496f:	e8 a2 cd ff ff       	call   80101716 <iunlockput>
      end_op();
80104974:	e8 b1 de ff ff       	call   8010282a <end_op>
      return -1;
80104979:	83 c4 10             	add    $0x10,%esp
8010497c:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104981:	eb 96                	jmp    80104919 <sys_open+0xb5>
      end_op();
80104983:	e8 a2 de ff ff       	call   8010282a <end_op>
      return -1;
80104988:	bf ff ff ff ff       	mov    $0xffffffff,%edi
8010498d:	eb 8a                	jmp    80104919 <sys_open+0xb5>
    if(f)
8010498f:	85 db                	test   %ebx,%ebx
80104991:	74 0c                	je     8010499f <sys_open+0x13b>
      fileclose(f);
80104993:	83 ec 0c             	sub    $0xc,%esp
80104996:	53                   	push   %ebx
80104997:	e8 27 c3 ff ff       	call   80100cc3 <fileclose>
8010499c:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010499f:	83 ec 0c             	sub    $0xc,%esp
801049a2:	56                   	push   %esi
801049a3:	e8 6e cd ff ff       	call   80101716 <iunlockput>
    end_op();
801049a8:	e8 7d de ff ff       	call   8010282a <end_op>
    return -1;
801049ad:	83 c4 10             	add    $0x10,%esp
801049b0:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801049b5:	e9 5f ff ff ff       	jmp    80104919 <sys_open+0xb5>
...
801049fc:	e8 15 cd ff ff       	call   80101716 <iunlockput>
  end_op();
80104a01:	e8 24 de ff ff       	call   8010282a <end_op>
  return 0;
...
80104a1a:	eb f2                	jmp    80104a0e <sys_mkdir+0x54>
...
80104a8a:	e8 87 cc ff ff       	call   80101716 <iunlockput>
  end_op();
80104a8f:	e8 96 dd ff ff       	call   8010282a <end_op>
  return 0;
...
80104a9d:	c3                   	ret    
    end_op();
80104a9e:	e8 87 dd ff ff       	call   8010282a <end_op>
    return -1;
80104aa3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104aa8:	eb f2                	jmp    80104a9c <sys_mknod+0x80>
...
80104aaf:	83 ec 10             	sub    $0x10,%esp
  char *path;
  struct inode *ip;
  struct proc *curproc = myproc();
80104ab2:	e8 ce e7 ff ff       	call   80103285 <myproc>
80104ab7:	89 c6                	mov    %eax,%esi
  
  begin_op();
80104ab9:	e8 f2 dc ff ff       	call   801027b0 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
80104abe:	83 ec 08             	sub    $0x8,%esp
80104ac1:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104ac4:	50                   	push   %eax
80104ac5:	6a 00                	push   $0x0
80104ac7:	e8 c9 f5 ff ff       	call   80104095 <argstr>
80104acc:	83 c4 10             	add    $0x10,%esp
80104acf:	85 c0                	test   %eax,%eax
80104ad1:	78 52                	js     80104b25 <sys_chdir+0x7b>
80104ad3:	83 ec 0c             	sub    $0xc,%esp
80104ad6:	ff 75 f4             	push   -0xc(%ebp)
80104ad9:	e8 ef d0 ff ff       	call   80101bcd <namei>
80104ade:	89 c3                	mov    %eax,%ebx
80104ae0:	83 c4 10             	add    $0x10,%esp
80104ae3:	85 c0                	test   %eax,%eax
80104ae5:	74 3e                	je     80104b25 <sys_chdir+0x7b>
    end_op();
    return -1;
  }
  ilock(ip);
...
80104aeb:	e8 7f ca ff ff       	call   8010156f <ilock>
  if(ip->type != T_DIR){
80104af0:	83 c4 10             	add    $0x10,%esp
80104af3:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104af8:	75 37                	jne    80104b31 <sys_chdir+0x87>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80104afe:	e8 2e cb ff ff       	call   80101631 <iunlock>
  iput(curproc->cwd);
80104b03:	83 c4 04             	add    $0x4,%esp
80104b06:	ff 76 68             	push   0x68(%esi)
80104b09:	e8 68 cb ff ff       	call   80101676 <iput>
  end_op();
80104b0e:	e8 17 dd ff ff       	call   8010282a <end_op>
  curproc->cwd = ip;
80104b13:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
...
80104b24:	c3                   	ret    
    end_op();
80104b25:	e8 00 dd ff ff       	call   8010282a <end_op>
    return -1;
80104b2a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b2f:	eb ed                	jmp    80104b1e <sys_chdir+0x74>
    iunlockput(ip);
80104b31:	83 ec 0c             	sub    $0xc,%esp
80104b34:	53                   	push   %ebx
80104b35:	e8 dc cb ff ff       	call   80101716 <iunlockput>
    end_op();
80104b3a:	e8 eb dc ff ff       	call   8010282a <end_op>
    return -1;
80104b3f:	83 c4 10             	add    $0x10,%esp
80104b42:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b47:	eb d5                	jmp    80104b1e <sys_chdir+0x74>
...
80104b4d:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
...
80104b59:	e8 37 f5 ff ff       	call   80104095 <argstr>
80104b5e:	83 c4 10             	add    $0x10,%esp
80104b61:	85 c0                	test   %eax,%eax
80104b63:	78 38                	js     80104b9d <sys_exec+0x54>
80104b65:	83 ec 08             	sub    $0x8,%esp
80104b68:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80104b6e:	50                   	push   %eax
80104b6f:	6a 01                	push   $0x1
80104b71:	e8 8f f4 ff ff       	call   80104005 <argint>
80104b76:	83 c4 10             	add    $0x10,%esp
80104b79:	85 c0                	test   %eax,%eax
80104b7b:	78 20                	js     80104b9d <sys_exec+0x54>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80104b7d:	83 ec 04             	sub    $0x4,%esp
80104b80:	68 80 00 00 00       	push   $0x80
80104b85:	6a 00                	push   $0x0
80104b87:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104b8d:	50                   	push   %eax
80104b8e:	e8 22 f2 ff ff       	call   80103db5 <memset>
80104b93:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104b96:	bb 00 00 00 00       	mov    $0x0,%ebx
80104b9b:	eb 2c                	jmp    80104bc9 <sys_exec+0x80>
    return -1;
80104b9d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104ba2:	eb 78                	jmp    80104c1c <sys_exec+0xd3>
    if(i >= NELEM(argv))
      return -1;
    ...
    if(uarg == 0){
      argv[i] = 0;
80104ba4:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104bab:	00 00 00 00 
      break;
    }
...
80104bb2:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104bb8:	50                   	push   %eax
80104bb9:	ff 75 f4             	push   -0xc(%ebp)
80104bbc:	e8 0d bd ff ff       	call   801008ce <exec>
80104bc1:	83 c4 10             	add    $0x10,%esp
80104bc4:	eb 56                	jmp    80104c1c <sys_exec+0xd3>
  for(i=0;; i++){
80104bc6:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104bc9:	83 fb 1f             	cmp    $0x1f,%ebx
80104bcc:	77 49                	ja     80104c17 <sys_exec+0xce>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
...
80104c04:	e8 bd f3 ff ff       	call   80103fc6 <fetchstr>
80104c09:	83 c4 10             	add    $0x10,%esp
80104c0c:	85 c0                	test   %eax,%eax
80104c0e:	79 b6                	jns    80104bc6 <sys_exec+0x7d>
      return -1;
80104c10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c15:	eb 05                	jmp    80104c1c <sys_exec+0xd3>
      return -1;
80104c17:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80104c1c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104c1f:	c9                   	leave  
80104c20:	c3                   	ret    
      return -1;
80104c21:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104c26:	eb f4                	jmp    80104c1c <sys_exec+0xd3>
...
80104c37:	e8 f1 f3 ff ff       	call   8010402d <argptr>
80104c3c:	83 c4 10             	add    $0x10,%esp
80104c3f:	85 c0                	test   %eax,%eax
80104c41:	78 79                	js     80104cbc <sys_pipe+0x94>
    return -1;
...
80104c4e:	e8 19 e1 ff ff       	call   80102d6c <pipealloc>
80104c53:	83 c4 10             	add    $0x10,%esp
80104c56:	85 c0                	test   %eax,%eax
80104c58:	78 69                	js     80104cc3 <sys_pipe+0x9b>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104c5a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c5d:	e8 1d f5 ff ff       	call   8010417f <fdalloc>
80104c62:	89 c3                	mov    %eax,%ebx
80104c64:	85 c0                	test   %eax,%eax
80104c66:	78 21                	js     80104c89 <sys_pipe+0x61>
80104c68:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104c6b:	e8 0f f5 ff ff       	call   8010417f <fdalloc>
80104c70:	85 c0                	test   %eax,%eax
80104c72:	78 15                	js     80104c89 <sys_pipe+0x61>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80104c8b:	79 20                	jns    80104cad <sys_pipe+0x85>
    fileclose(rf);
80104c8d:	83 ec 0c             	sub    $0xc,%esp
80104c90:	ff 75 f0             	push   -0x10(%ebp)
80104c93:	e8 2b c0 ff ff       	call   80100cc3 <fileclose>
    fileclose(wf);
80104c98:	83 c4 04             	add    $0x4,%esp
80104c9b:	ff 75 ec             	push   -0x14(%ebp)
80104c9e:	e8 20 c0 ff ff       	call   80100cc3 <fileclose>
    return -1;
80104ca3:	83 c4 10             	add    $0x10,%esp
80104ca6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cab:	eb d7                	jmp    80104c84 <sys_pipe+0x5c>
      myproc()->ofile[fd0] = 0;
80104cad:	e8 d3 e5 ff ff       	call   80103285 <myproc>
80104cb2:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80104cb9:	00 
80104cba:	eb d1                	jmp    80104c8d <sys_pipe+0x65>
    return -1;
80104cbc:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cc1:	eb c1                	jmp    80104c84 <sys_pipe+0x5c>
    return -1;
80104cc3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cc8:	eb ba                	jmp    80104c84 <sys_pipe+0x5c>

80104cca <sys_settickets>:
#include "param.h"
#include "memlayout.h"
#include "mmu.h"
#include "proc.h"
...
80104ccd:	83 ec 20             	sub    $0x20,%esp
  int i;
  if(argint(0, &i) < 0){
80104cd0:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104cd3:	50                   	push   %eax
80104cd4:	6a 00                	push   $0x0
80104cd6:	e8 2a f3 ff ff       	call   80104005 <argint>
80104cdb:	83 c4 10             	add    $0x10,%esp
80104cde:	85 c0                	test   %eax,%eax
80104ce0:	78 15                	js     80104cf7 <sys_settickets+0x2d>
    return -1;
  }
  myproc()->tickets = i;
80104ce2:	e8 9e e5 ff ff       	call   80103285 <myproc>
80104ce7:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104cea:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  return 0;
...
80104cfc:	eb f7                	jmp    80104cf5 <sys_settickets+0x2b>
...
80104d01:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104d04:	e8 03 e7 ff ff       	call   8010340c <fork>
}
80104d09:	c9                   	leave  
80104d0a:	c3                   	ret    
...
80104d0e:	83 ec 08             	sub    $0x8,%esp
  exit();
80104d11:	e8 52 e9 ff ff       	call   80103668 <exit>
...
80104d20:	83 ec 08             	sub    $0x8,%esp
  return wait();
80104d23:	e8 cc ea ff ff       	call   801037f4 <wait>
}
80104d28:	c9                   	leave  
80104d29:	c3                   	ret    
...
80104d2d:	83 ec 20             	sub    $0x20,%esp
  int pid;

  if(argint(0, &pid) < 0)
80104d30:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d33:	50                   	push   %eax
80104d34:	6a 00                	push   $0x0
80104d36:	e8 ca f2 ff ff       	call   80104005 <argint>
80104d3b:	83 c4 10             	add    $0x10,%esp
80104d3e:	85 c0                	test   %eax,%eax
80104d40:	78 10                	js     80104d52 <sys_kill+0x28>
    return -1;
  return kill(pid);
80104d42:	83 ec 0c             	sub    $0xc,%esp
80104d45:	ff 75 f4             	push   -0xc(%ebp)
80104d48:	e8 a7 eb ff ff       	call   801038f4 <kill>
...
80104d57:	eb f7                	jmp    80104d50 <sys_kill+0x26>
...
80104d5c:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104d5f:	e8 21 e5 ff ff       	call   80103285 <myproc>
80104d64:	8b 40 10             	mov    0x10(%eax),%eax
}
80104d67:	c9                   	leave  
80104d68:	c3                   	ret    
...
80104d6d:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  int n;
...
80104d74:	6a 00                	push   $0x0
80104d76:	e8 8a f2 ff ff       	call   80104005 <argint>
80104d7b:	83 c4 10             	add    $0x10,%esp
80104d7e:	85 c0                	test   %eax,%eax
80104d80:	78 20                	js     80104da2 <sys_sbrk+0x39>
    return -1;
  addr = myproc()->sz;
80104d82:	e8 fe e4 ff ff       	call   80103285 <myproc>
80104d87:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104d89:	83 ec 0c             	sub    $0xc,%esp
80104d8c:	ff 75 f4             	push   -0xc(%ebp)
80104d8f:	e8 0d e6 ff ff       	call   801033a1 <growproc>
80104d94:	83 c4 10             	add    $0x10,%esp
80104d97:	85 c0                	test   %eax,%eax
80104d99:	78 0e                	js     80104da9 <sys_sbrk+0x40>
    return -1;
  return addr;
}
80104d9b:	89 d8                	mov    %ebx,%eax
80104d9d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104da0:	c9                   	leave  
80104da1:	c3                   	ret    
    return -1;
80104da2:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104da7:	eb f2                	jmp    80104d9b <sys_sbrk+0x32>
    return -1;
80104da9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104dae:	eb eb                	jmp    80104d9b <sys_sbrk+0x32>
...
80104dbd:	e8 43 f2 ff ff       	call   80104005 <argint>
80104dc2:	83 c4 10             	add    $0x10,%esp
80104dc5:	85 c0                	test   %eax,%eax
80104dc7:	78 75                	js     80104e3e <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104dc9:	83 ec 0c             	sub    $0xc,%esp
80104dcc:	68 80 3e 11 80       	push   $0x80113e80
80104dd1:	e8 33 ef ff ff       	call   80103d09 <acquire>
  ticks0 = ticks;
80104dd6:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  while(ticks - ticks0 < n){
80104ddc:	83 c4 10             	add    $0x10,%esp
80104ddf:	a1 60 3e 11 80       	mov    0x80113e60,%eax
80104de4:	29 d8                	sub    %ebx,%eax
80104de6:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104de9:	73 39                	jae    80104e24 <sys_sleep+0x74>
    if(myproc()->killed){
80104deb:	e8 95 e4 ff ff       	call   80103285 <myproc>
80104df0:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104df4:	75 17                	jne    80104e0d <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104df6:	83 ec 08             	sub    $0x8,%esp
80104df9:	68 80 3e 11 80       	push   $0x80113e80
80104dfe:	68 60 3e 11 80       	push   $0x80113e60
80104e03:	e8 5b e9 ff ff       	call   80103763 <sleep>
80104e08:	83 c4 10             	add    $0x10,%esp
80104e0b:	eb d2                	jmp    80104ddf <sys_sleep+0x2f>
      release(&tickslock);
80104e0d:	83 ec 0c             	sub    $0xc,%esp
80104e10:	68 80 3e 11 80       	push   $0x80113e80
80104e15:	e8 54 ef ff ff       	call   80103d6e <release>
      return -1;
80104e1a:	83 c4 10             	add    $0x10,%esp
80104e1d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e22:	eb 15                	jmp    80104e39 <sys_sleep+0x89>
  }
  release(&tickslock);
80104e24:	83 ec 0c             	sub    $0xc,%esp
80104e27:	68 80 3e 11 80       	push   $0x80113e80
80104e2c:	e8 3d ef ff ff       	call   80103d6e <release>
  return 0;
80104e31:	83 c4 10             	add    $0x10,%esp
80104e34:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104e39:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104e3c:	c9                   	leave  
80104e3d:	c3                   	ret    
    return -1;
80104e3e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e43:	eb f4                	jmp    80104e39 <sys_sleep+0x89>
...
80104e49:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80104e4c:	68 80 3e 11 80       	push   $0x80113e80
80104e51:	e8 b3 ee ff ff       	call   80103d09 <acquire>
  xticks = ticks;
80104e56:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  release(&tickslock);
80104e5c:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80104e63:	e8 06 ef ff ff       	call   80103d6e <release>
  return xticks;
}
80104e68:	89 d8                	mov    %ebx,%eax
80104e6a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104e6d:	c9                   	leave  
80104e6e:	c3                   	ret    
...
80104e72:	83 ec 08             	sub    $0x8,%esp
  yield();
80104e75:	e8 b7 e8 ff ff       	call   80103731 <yield>
  return 0;
}
...
80104e84:	83 ec 08             	sub    $0x8,%esp
  shutdown();
80104e87:	e8 6f d3 ff ff       	call   801021fb <shutdown>
  return 0;
}
...
80104ea2:	54                   	push   %esp
  call trap
80104ea3:	e8 37 01 00 00       	call   80104fdf <trap>
  addl $4, %esp
...
80104ec2:	eb 76                	jmp    80104f3a <tvinit+0x84>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104ec4:	8b 0c 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%ecx
80104ecb:	66 89 0c c5 c0 3e 11 	mov    %cx,-0x7feec140(,%eax,8)
80104ed2:	80 
80104ed3:	66 c7 04 c5 c2 3e 11 	movw   $0x8,-0x7feec13e(,%eax,8)
80104eda:	80 08 00 
80104edd:	0f b6 14 c5 c4 3e 11 	movzbl -0x7feec13c(,%eax,8),%edx
80104ee4:	80 
80104ee5:	83 e2 e0             	and    $0xffffffe0,%edx
80104ee8:	88 14 c5 c4 3e 11 80 	mov    %dl,-0x7feec13c(,%eax,8)
80104eef:	c6 04 c5 c4 3e 11 80 	movb   $0x0,-0x7feec13c(,%eax,8)
80104ef6:	00 
80104ef7:	0f b6 14 c5 c5 3e 11 	movzbl -0x7feec13b(,%eax,8),%edx
80104efe:	80 
80104eff:	83 e2 f0             	and    $0xfffffff0,%edx
80104f02:	83 ca 0e             	or     $0xe,%edx
80104f05:	88 14 c5 c5 3e 11 80 	mov    %dl,-0x7feec13b(,%eax,8)
80104f0c:	89 d3                	mov    %edx,%ebx
80104f0e:	83 e3 ef             	and    $0xffffffef,%ebx
80104f11:	88 1c c5 c5 3e 11 80 	mov    %bl,-0x7feec13b(,%eax,8)
80104f18:	83 e2 8f             	and    $0xffffff8f,%edx
80104f1b:	88 14 c5 c5 3e 11 80 	mov    %dl,-0x7feec13b(,%eax,8)
80104f22:	83 ca 80             	or     $0xffffff80,%edx
80104f25:	88 14 c5 c5 3e 11 80 	mov    %dl,-0x7feec13b(,%eax,8)
80104f2c:	c1 e9 10             	shr    $0x10,%ecx
80104f2f:	66 89 0c c5 c6 3e 11 	mov    %cx,-0x7feec13a(,%eax,8)
80104f36:	80 
  for(i = 0; i < 256; i++)
80104f37:	83 c0 01             	add    $0x1,%eax
80104f3a:	3d ff 00 00 00       	cmp    $0xff,%eax
80104f3f:	7e 83                	jle    80104ec4 <tvinit+0xe>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104f41:	8b 15 0c a1 10 80    	mov    0x8010a10c,%edx
80104f47:	66 89 15 c0 40 11 80 	mov    %dx,0x801140c0
80104f4e:	66 c7 05 c2 40 11 80 	movw   $0x8,0x801140c2
80104f55:	08 00 
80104f57:	0f b6 05 c4 40 11 80 	movzbl 0x801140c4,%eax
80104f5e:	83 e0 e0             	and    $0xffffffe0,%eax
80104f61:	a2 c4 40 11 80       	mov    %al,0x801140c4
80104f66:	c6 05 c4 40 11 80 00 	movb   $0x0,0x801140c4
80104f6d:	0f b6 05 c5 40 11 80 	movzbl 0x801140c5,%eax
80104f74:	83 c8 0f             	or     $0xf,%eax
80104f77:	a2 c5 40 11 80       	mov    %al,0x801140c5
80104f7c:	83 e0 ef             	and    $0xffffffef,%eax
80104f7f:	a2 c5 40 11 80       	mov    %al,0x801140c5
80104f84:	89 c1                	mov    %eax,%ecx
80104f86:	83 c9 60             	or     $0x60,%ecx
80104f89:	88 0d c5 40 11 80    	mov    %cl,0x801140c5
80104f8f:	83 c8 e0             	or     $0xffffffe0,%eax
80104f92:	a2 c5 40 11 80       	mov    %al,0x801140c5
80104f97:	c1 ea 10             	shr    $0x10,%edx
80104f9a:	66 89 15 c6 40 11 80 	mov    %dx,0x801140c6

  initlock(&tickslock, "time");
80104fa1:	83 ec 08             	sub    $0x8,%esp
80104fa4:	68 f1 70 10 80       	push   $0x801070f1
80104fa9:	68 80 3e 11 80       	push   $0x80113e80
80104fae:	e8 1a ec ff ff       	call   80103bcd <initlock>
}
...
80104fbe:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80104fc1:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80104fc7:	b8 c0 3e 11 80       	mov    $0x80113ec0,%eax
80104fcc:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80104fd0:	c1 e8 10             	shr    $0x10,%eax
80104fd3:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80104fd7:	8d 45 fa             	lea    -0x6(%ebp),%eax
80104fda:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80104fdd:	c9                   	leave  
80104fde:	c3                   	ret    
...
80104fe5:	83 ec 1c             	sub    $0x1c,%esp
80104fe8:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80104feb:	8b 43 30             	mov    0x30(%ebx),%eax
80104fee:	83 f8 40             	cmp    $0x40,%eax
80104ff1:	74 13                	je     80105006 <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80104ff3:	83 e8 20             	sub    $0x20,%eax
80104ff6:	83 f8 1f             	cmp    $0x1f,%eax
80104ff9:	0f 87 3a 01 00 00    	ja     80105139 <trap+0x15a>
80104fff:	ff 24 85 98 71 10 80 	jmp    *-0x7fef8e68(,%eax,4)
    if(myproc()->killed)
80105006:	e8 7a e2 ff ff       	call   80103285 <myproc>
8010500b:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
8010500f:	75 1f                	jne    80105030 <trap+0x51>
    myproc()->tf = tf;
80105011:	e8 6f e2 ff ff       	call   80103285 <myproc>
80105016:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105019:	e8 aa f0 ff ff       	call   801040c8 <syscall>
    if(myproc()->killed)
8010501e:	e8 62 e2 ff ff       	call   80103285 <myproc>
80105023:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105027:	74 7e                	je     801050a7 <trap+0xc8>
      exit();
80105029:	e8 3a e6 ff ff       	call   80103668 <exit>
    return;
8010502e:	eb 77                	jmp    801050a7 <trap+0xc8>
      exit();
80105030:	e8 33 e6 ff ff       	call   80103668 <exit>
80105035:	eb da                	jmp    80105011 <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105037:	e8 2e e2 ff ff       	call   8010326a <cpuid>
8010503c:	85 c0                	test   %eax,%eax
8010503e:	74 6f                	je     801050af <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80105040:	e8 63 d3 ff ff       	call   801023a8 <lapiceoi>
  }
...
80105045:	e8 3b e2 ff ff       	call   80103285 <myproc>
8010504a:	85 c0                	test   %eax,%eax
8010504c:	74 1c                	je     8010506a <trap+0x8b>
8010504e:	e8 32 e2 ff ff       	call   80103285 <myproc>
80105053:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105057:	74 11                	je     8010506a <trap+0x8b>
80105059:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
8010505d:	83 e0 03             	and    $0x3,%eax
80105060:	66 83 f8 03          	cmp    $0x3,%ax
80105064:	0f 84 62 01 00 00    	je     801051cc <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
8010506a:	e8 16 e2 ff ff       	call   80103285 <myproc>
8010506f:	85 c0                	test   %eax,%eax
80105071:	74 0f                	je     80105082 <trap+0xa3>
80105073:	e8 0d e2 ff ff       	call   80103285 <myproc>
80105078:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
8010507c:	0f 84 54 01 00 00    	je     801051d6 <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105082:	e8 fe e1 ff ff       	call   80103285 <myproc>
80105087:	85 c0                	test   %eax,%eax
80105089:	74 1c                	je     801050a7 <trap+0xc8>
8010508b:	e8 f5 e1 ff ff       	call   80103285 <myproc>
80105090:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80105094:	74 11                	je     801050a7 <trap+0xc8>
80105096:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
8010509a:	83 e0 03             	and    $0x3,%eax
8010509d:	66 83 f8 03          	cmp    $0x3,%ax
801050a1:	0f 84 43 01 00 00    	je     801051ea <trap+0x20b>
    exit();
}
...
801050b2:	68 80 3e 11 80       	push   $0x80113e80
801050b7:	e8 4d ec ff ff       	call   80103d09 <acquire>
      ticks++;
801050bc:	83 05 60 3e 11 80 01 	addl   $0x1,0x80113e60
      wakeup(&ticks);
801050c3:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
801050ca:	e8 fc e7 ff ff       	call   801038cb <wakeup>
      release(&tickslock);
801050cf:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
801050d6:	e8 93 ec ff ff       	call   80103d6e <release>
801050db:	83 c4 10             	add    $0x10,%esp
801050de:	e9 5d ff ff ff       	jmp    80105040 <trap+0x61>
    ideintr();
801050e3:	e8 74 cc ff ff       	call   80101d5c <ideintr>
    lapiceoi();
801050e8:	e8 bb d2 ff ff       	call   801023a8 <lapiceoi>
    break;
801050ed:	e9 53 ff ff ff       	jmp    80105045 <trap+0x66>
    kbdintr();
801050f2:	e8 ef d0 ff ff       	call   801021e6 <kbdintr>
    lapiceoi();
801050f7:	e8 ac d2 ff ff       	call   801023a8 <lapiceoi>
    break;
801050fc:	e9 44 ff ff ff       	jmp    80105045 <trap+0x66>
    uartintr();
80105101:	e8 fe 01 00 00       	call   80105304 <uartintr>
    lapiceoi();
80105106:	e8 9d d2 ff ff       	call   801023a8 <lapiceoi>
    break;
8010510b:	e9 35 ff ff ff       	jmp    80105045 <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105110:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80105113:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105117:	e8 4e e1 ff ff       	call   8010326a <cpuid>
8010511c:	57                   	push   %edi
8010511d:	0f b7 f6             	movzwl %si,%esi
80105120:	56                   	push   %esi
80105121:	50                   	push   %eax
80105122:	68 fc 70 10 80       	push   $0x801070fc
80105127:	e8 db b4 ff ff       	call   80100607 <cprintf>
    lapiceoi();
8010512c:	e8 77 d2 ff ff       	call   801023a8 <lapiceoi>
    break;
80105131:	83 c4 10             	add    $0x10,%esp
80105134:	e9 0c ff ff ff       	jmp    80105045 <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
80105139:	e8 47 e1 ff ff       	call   80103285 <myproc>
8010513e:	85 c0                	test   %eax,%eax
80105140:	74 5f                	je     801051a1 <trap+0x1c2>
80105142:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105146:	74 59                	je     801051a1 <trap+0x1c2>
...
80105148:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010514b:	8b 43 38             	mov    0x38(%ebx),%eax
8010514e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105151:	e8 14 e1 ff ff       	call   8010326a <cpuid>
80105156:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105159:	8b 53 34             	mov    0x34(%ebx),%edx
8010515c:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010515f:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
80105162:	e8 1e e1 ff ff       	call   80103285 <myproc>
80105167:	8d 48 6c             	lea    0x6c(%eax),%ecx
8010516a:	89 4d d8             	mov    %ecx,-0x28(%ebp)
8010516d:	e8 13 e1 ff ff       	call   80103285 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105172:	57                   	push   %edi
80105173:	ff 75 e4             	push   -0x1c(%ebp)
80105176:	ff 75 e0             	push   -0x20(%ebp)
80105179:	ff 75 dc             	push   -0x24(%ebp)
8010517c:	56                   	push   %esi
8010517d:	ff 75 d8             	push   -0x28(%ebp)
80105180:	ff 70 10             	push   0x10(%eax)
80105183:	68 54 71 10 80       	push   $0x80107154
80105188:	e8 7a b4 ff ff       	call   80100607 <cprintf>
    myproc()->killed = 1;
8010518d:	83 c4 20             	add    $0x20,%esp
80105190:	e8 f0 e0 ff ff       	call   80103285 <myproc>
80105195:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
8010519c:	e9 a4 fe ff ff       	jmp    80105045 <trap+0x66>
801051a1:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801051a4:	8b 73 38             	mov    0x38(%ebx),%esi
801051a7:	e8 be e0 ff ff       	call   8010326a <cpuid>
801051ac:	83 ec 0c             	sub    $0xc,%esp
801051af:	57                   	push   %edi
801051b0:	56                   	push   %esi
801051b1:	50                   	push   %eax
801051b2:	ff 73 30             	push   0x30(%ebx)
801051b5:	68 20 71 10 80       	push   $0x80107120
801051ba:	e8 48 b4 ff ff       	call   80100607 <cprintf>
      panic("trap");
801051bf:	83 c4 14             	add    $0x14,%esp
801051c2:	68 f6 70 10 80       	push   $0x801070f6
801051c7:	e8 7c b1 ff ff       	call   80100348 <panic>
    exit();
801051cc:	e8 97 e4 ff ff       	call   80103668 <exit>
801051d1:	e9 94 fe ff ff       	jmp    8010506a <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
801051d6:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
801051da:	0f 85 a2 fe ff ff    	jne    80105082 <trap+0xa3>
    yield();
801051e0:	e8 4c e5 ff ff       	call   80103731 <yield>
801051e5:	e9 98 fe ff ff       	jmp    80105082 <trap+0xa3>
    exit();
801051ea:	e8 79 e4 ff ff       	call   80103668 <exit>
801051ef:	e9 b3 fe ff ff       	jmp    801050a7 <trap+0xc8>
...
{
  if(!uart)
801051f4:	83 3d c0 46 11 80 00 	cmpl   $0x0,0x801146c0
801051fb:	74 14                	je     80105211 <uartgetc+0x1d>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
...
80105205:	74 10                	je     80105217 <uartgetc+0x23>
...
8010521d <uartputc>:
  if(!uart)
8010521d:	83 3d c0 46 11 80 00 	cmpl   $0x0,0x801146c0
80105224:	74 3b                	je     80105261 <uartputc+0x44>
{
...
80105232:	eb 10                	jmp    80105244 <uartputc+0x27>
    microdelay(10);
80105234:	83 ec 0c             	sub    $0xc,%esp
80105237:	6a 0a                	push   $0xa
80105239:	e8 8b d1 ff ff       	call   801023c9 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010523e:	83 c3 01             	add    $0x1,%ebx
80105241:	83 c4 10             	add    $0x10,%esp
80105244:	83 fb 7f             	cmp    $0x7f,%ebx
80105247:	7f 0a                	jg     80105253 <uartputc+0x36>
80105249:	ba fd 03 00 00       	mov    $0x3fd,%edx
8010524e:	ec                   	in     (%dx),%al
8010524f:	a8 20                	test   $0x20,%al
80105251:	74 e1                	je     80105234 <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80105267:	b9 00 00 00 00       	mov    $0x0,%ecx
8010526c:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105271:	89 c8                	mov    %ecx,%eax
80105273:	ee                   	out    %al,(%dx)
80105274:	be fb 03 00 00       	mov    $0x3fb,%esi
80105279:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
8010527e:	89 f2                	mov    %esi,%edx
80105280:	ee                   	out    %al,(%dx)
80105281:	b8 0c 00 00 00       	mov    $0xc,%eax
80105286:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010528b:	ee                   	out    %al,(%dx)
8010528c:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105291:	89 c8                	mov    %ecx,%eax
80105293:	89 da                	mov    %ebx,%edx
80105295:	ee                   	out    %al,(%dx)
80105296:	b8 03 00 00 00       	mov    $0x3,%eax
8010529b:	89 f2                	mov    %esi,%edx
8010529d:	ee                   	out    %al,(%dx)
8010529e:	ba fc 03 00 00       	mov    $0x3fc,%edx
...
801052b3:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
801052b4:	3c ff                	cmp    $0xff,%al
801052b6:	74 45                	je     801052fd <uartinit+0x9b>
  uart = 1;
801052b8:	c7 05 c0 46 11 80 01 	movl   $0x1,0x801146c0
801052bf:	00 00 00 
801052c2:	ba fa 03 00 00       	mov    $0x3fa,%edx
801052c7:	ec                   	in     (%dx),%al
801052c8:	ba f8 03 00 00       	mov    $0x3f8,%edx
801052cd:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
801052ce:	83 ec 08             	sub    $0x8,%esp
801052d1:	6a 00                	push   $0x0
801052d3:	6a 04                	push   $0x4
801052d5:	e8 87 cc ff ff       	call   80101f61 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
801052da:	83 c4 10             	add    $0x10,%esp
801052dd:	bb 18 72 10 80       	mov    $0x80107218,%ebx
801052e2:	eb 12                	jmp    801052f6 <uartinit+0x94>
    uartputc(*p);
801052e4:	83 ec 0c             	sub    $0xc,%esp
801052e7:	0f be c0             	movsbl %al,%eax
801052ea:	50                   	push   %eax
801052eb:	e8 2d ff ff ff       	call   8010521d <uartputc>
  for(p="xv6...\n"; *p; p++)
801052f0:	83 c3 01             	add    $0x1,%ebx
801052f3:	83 c4 10             	add    $0x10,%esp
801052f6:	0f b6 03             	movzbl (%ebx),%eax
801052f9:	84 c0                	test   %al,%al
801052fb:	75 e7                	jne    801052e4 <uartinit+0x82>
}
801052fd:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105300:	5b                   	pop    %ebx
80105301:	5e                   	pop    %esi
80105302:	5d                   	pop    %ebp
80105303:	c3                   	ret    
...
8010530a:	68 f4 51 10 80       	push   $0x801051f4
8010530f:	e8 1f b4 ff ff       	call   80100733 <consoleintr>
}
...
8010531b:	6a 00                	push   $0x0
  jmp alltraps
8010531d:	e9 71 fb ff ff       	jmp    80104e93 <alltraps>
...
80105324:	6a 01                	push   $0x1
  jmp alltraps
80105326:	e9 68 fb ff ff       	jmp    80104e93 <alltraps>
...
8010532d:	6a 02                	push   $0x2
  jmp alltraps
8010532f:	e9 5f fb ff ff       	jmp    80104e93 <alltraps>
...
80105336:	6a 03                	push   $0x3
  jmp alltraps
80105338:	e9 56 fb ff ff       	jmp    80104e93 <alltraps>
...
8010533f:	6a 04                	push   $0x4
  jmp alltraps
80105341:	e9 4d fb ff ff       	jmp    80104e93 <alltraps>
...
80105348:	6a 05                	push   $0x5
  jmp alltraps
8010534a:	e9 44 fb ff ff       	jmp    80104e93 <alltraps>
...
80105351:	6a 06                	push   $0x6
  jmp alltraps
80105353:	e9 3b fb ff ff       	jmp    80104e93 <alltraps>
...
8010535a:	6a 07                	push   $0x7
  jmp alltraps
8010535c:	e9 32 fb ff ff       	jmp    80104e93 <alltraps>
...
80105361:	6a 08                	push   $0x8
  jmp alltraps
80105363:	e9 2b fb ff ff       	jmp    80104e93 <alltraps>
...
8010536a:	6a 09                	push   $0x9
  jmp alltraps
8010536c:	e9 22 fb ff ff       	jmp    80104e93 <alltraps>
...
80105371:	6a 0a                	push   $0xa
  jmp alltraps
80105373:	e9 1b fb ff ff       	jmp    80104e93 <alltraps>
...
80105378:	6a 0b                	push   $0xb
  jmp alltraps
8010537a:	e9 14 fb ff ff       	jmp    80104e93 <alltraps>
...
8010537f:	6a 0c                	push   $0xc
  jmp alltraps
80105381:	e9 0d fb ff ff       	jmp    80104e93 <alltraps>
...
80105386:	6a 0d                	push   $0xd
  jmp alltraps
80105388:	e9 06 fb ff ff       	jmp    80104e93 <alltraps>
...
8010538d:	6a 0e                	push   $0xe
  jmp alltraps
8010538f:	e9 ff fa ff ff       	jmp    80104e93 <alltraps>
...
80105396:	6a 0f                	push   $0xf
  jmp alltraps
80105398:	e9 f6 fa ff ff       	jmp    80104e93 <alltraps>
...
8010539f:	6a 10                	push   $0x10
  jmp alltraps
801053a1:	e9 ed fa ff ff       	jmp    80104e93 <alltraps>
...
801053a6:	6a 11                	push   $0x11
  jmp alltraps
801053a8:	e9 e6 fa ff ff       	jmp    80104e93 <alltraps>
...
801053af:	6a 12                	push   $0x12
  jmp alltraps
801053b1:	e9 dd fa ff ff       	jmp    80104e93 <alltraps>
...
801053b8:	6a 13                	push   $0x13
  jmp alltraps
801053ba:	e9 d4 fa ff ff       	jmp    80104e93 <alltraps>
...
801053c1:	6a 14                	push   $0x14
  jmp alltraps
801053c3:	e9 cb fa ff ff       	jmp    80104e93 <alltraps>
...
801053ca:	6a 15                	push   $0x15
  jmp alltraps
801053cc:	e9 c2 fa ff ff       	jmp    80104e93 <alltraps>
...
801053d3:	6a 16                	push   $0x16
  jmp alltraps
801053d5:	e9 b9 fa ff ff       	jmp    80104e93 <alltraps>
...
801053dc:	6a 17                	push   $0x17
  jmp alltraps
801053de:	e9 b0 fa ff ff       	jmp    80104e93 <alltraps>
...
801053e5:	6a 18                	push   $0x18
  jmp alltraps
801053e7:	e9 a7 fa ff ff       	jmp    80104e93 <alltraps>
...
801053ee:	6a 19                	push   $0x19
  jmp alltraps
801053f0:	e9 9e fa ff ff       	jmp    80104e93 <alltraps>
...
801053f7:	6a 1a                	push   $0x1a
  jmp alltraps
801053f9:	e9 95 fa ff ff       	jmp    80104e93 <alltraps>
...
80105400:	6a 1b                	push   $0x1b
  jmp alltraps
80105402:	e9 8c fa ff ff       	jmp    80104e93 <alltraps>
...
80105409:	6a 1c                	push   $0x1c
  jmp alltraps
8010540b:	e9 83 fa ff ff       	jmp    80104e93 <alltraps>
...
80105412:	6a 1d                	push   $0x1d
  jmp alltraps
80105414:	e9 7a fa ff ff       	jmp    80104e93 <alltraps>
...
8010541b:	6a 1e                	push   $0x1e
  jmp alltraps
8010541d:	e9 71 fa ff ff       	jmp    80104e93 <alltraps>
...
80105424:	6a 1f                	push   $0x1f
  jmp alltraps
80105426:	e9 68 fa ff ff       	jmp    80104e93 <alltraps>
...
8010542d:	6a 20                	push   $0x20
  jmp alltraps
8010542f:	e9 5f fa ff ff       	jmp    80104e93 <alltraps>
...
80105436:	6a 21                	push   $0x21
  jmp alltraps
80105438:	e9 56 fa ff ff       	jmp    80104e93 <alltraps>
...
8010543f:	6a 22                	push   $0x22
  jmp alltraps
80105441:	e9 4d fa ff ff       	jmp    80104e93 <alltraps>
...
80105448:	6a 23                	push   $0x23
  jmp alltraps
8010544a:	e9 44 fa ff ff       	jmp    80104e93 <alltraps>
...
80105451:	6a 24                	push   $0x24
  jmp alltraps
80105453:	e9 3b fa ff ff       	jmp    80104e93 <alltraps>
...
8010545a:	6a 25                	push   $0x25
  jmp alltraps
8010545c:	e9 32 fa ff ff       	jmp    80104e93 <alltraps>
...
80105463:	6a 26                	push   $0x26
  jmp alltraps
80105465:	e9 29 fa ff ff       	jmp    80104e93 <alltraps>
...
8010546c:	6a 27                	push   $0x27
  jmp alltraps
8010546e:	e9 20 fa ff ff       	jmp    80104e93 <alltraps>
...
80105490:	6a 2b                	push   $0x2b
  jmp alltraps
80105492:	e9 fc f9 ff ff       	jmp    80104e93 <alltraps>
...
80105499:	6a 2c                	push   $0x2c
  jmp alltraps
8010549b:	e9 f3 f9 ff ff       	jmp    80104e93 <alltraps>
...
801054a2:	6a 2d                	push   $0x2d
  jmp alltraps
801054a4:	e9 ea f9 ff ff       	jmp    80104e93 <alltraps>
...
801054ab:	6a 2e                	push   $0x2e
  jmp alltraps
801054ad:	e9 e1 f9 ff ff       	jmp    80104e93 <alltraps>
...
801054b4:	6a 2f                	push   $0x2f
  jmp alltraps
801054b6:	e9 d8 f9 ff ff       	jmp    80104e93 <alltraps>
...
801054bd:	6a 30                	push   $0x30
  jmp alltraps
801054bf:	e9 cf f9 ff ff       	jmp    80104e93 <alltraps>
...
801054c6:	6a 31                	push   $0x31
  jmp alltraps
801054c8:	e9 c6 f9 ff ff       	jmp    80104e93 <alltraps>
...
801054cf:	6a 32                	push   $0x32
  jmp alltraps
801054d1:	e9 bd f9 ff ff       	jmp    80104e93 <alltraps>
...
801054d8:	6a 33                	push   $0x33
  jmp alltraps
801054da:	e9 b4 f9 ff ff       	jmp    80104e93 <alltraps>
...
801054e1:	6a 34                	push   $0x34
  jmp alltraps
801054e3:	e9 ab f9 ff ff       	jmp    80104e93 <alltraps>
...
801054ea:	6a 35                	push   $0x35
  jmp alltraps
801054ec:	e9 a2 f9 ff ff       	jmp    80104e93 <alltraps>
...
801054f3:	6a 36                	push   $0x36
  jmp alltraps
801054f5:	e9 99 f9 ff ff       	jmp    80104e93 <alltraps>
...
801054fc:	6a 37                	push   $0x37
  jmp alltraps
801054fe:	e9 90 f9 ff ff       	jmp    80104e93 <alltraps>
...
80105505:	6a 38                	push   $0x38
  jmp alltraps
80105507:	e9 87 f9 ff ff       	jmp    80104e93 <alltraps>
...
8010550e:	6a 39                	push   $0x39
  jmp alltraps
80105510:	e9 7e f9 ff ff       	jmp    80104e93 <alltraps>
...
80105517:	6a 3a                	push   $0x3a
  jmp alltraps
80105519:	e9 75 f9 ff ff       	jmp    80104e93 <alltraps>
...
80105520:	6a 3b                	push   $0x3b
  jmp alltraps
80105522:	e9 6c f9 ff ff       	jmp    80104e93 <alltraps>
...
80105529:	6a 3c                	push   $0x3c
  jmp alltraps
8010552b:	e9 63 f9 ff ff       	jmp    80104e93 <alltraps>
...
80105532:	6a 3d                	push   $0x3d
  jmp alltraps
80105534:	e9 5a f9 ff ff       	jmp    80104e93 <alltraps>
...
8010553b:	6a 3e                	push   $0x3e
  jmp alltraps
8010553d:	e9 51 f9 ff ff       	jmp    80104e93 <alltraps>
...
80105544:	6a 3f                	push   $0x3f
  jmp alltraps
80105546:	e9 48 f9 ff ff       	jmp    80104e93 <alltraps>
...
8010554d:	6a 40                	push   $0x40
  jmp alltraps
8010554f:	e9 3f f9 ff ff       	jmp    80104e93 <alltraps>
...
80105556:	6a 41                	push   $0x41
  jmp alltraps
80105558:	e9 36 f9 ff ff       	jmp    80104e93 <alltraps>
...
8010555f:	6a 42                	push   $0x42
  jmp alltraps
80105561:	e9 2d f9 ff ff       	jmp    80104e93 <alltraps>
...
80105568:	6a 43                	push   $0x43
  jmp alltraps
8010556a:	e9 24 f9 ff ff       	jmp    80104e93 <alltraps>
...
80105571:	6a 44                	push   $0x44
  jmp alltraps
80105573:	e9 1b f9 ff ff       	jmp    80104e93 <alltraps>
...
8010557a:	6a 45                	push   $0x45
  jmp alltraps
8010557c:	e9 12 f9 ff ff       	jmp    80104e93 <alltraps>
...
80105583:	6a 46                	push   $0x46
  jmp alltraps
80105585:	e9 09 f9 ff ff       	jmp    80104e93 <alltraps>
...
8010558c:	6a 47                	push   $0x47
  jmp alltraps
8010558e:	e9 00 f9 ff ff       	jmp    80104e93 <alltraps>
...
80105595:	6a 48                	push   $0x48
  jmp alltraps
80105597:	e9 f7 f8 ff ff       	jmp    80104e93 <alltraps>
...
8010559e:	6a 49                	push   $0x49
  jmp alltraps
801055a0:	e9 ee f8 ff ff       	jmp    80104e93 <alltraps>
...
801055a7:	6a 4a                	push   $0x4a
  jmp alltraps
801055a9:	e9 e5 f8 ff ff       	jmp    80104e93 <alltraps>
...
801055b0:	6a 4b                	push   $0x4b
  jmp alltraps
801055b2:	e9 dc f8 ff ff       	jmp    80104e93 <alltraps>
...
801055b9:	6a 4c                	push   $0x4c
  jmp alltraps
801055bb:	e9 d3 f8 ff ff       	jmp    80104e93 <alltraps>
...
801055c2:	6a 4d                	push   $0x4d
  jmp alltraps
801055c4:	e9 ca f8 ff ff       	jmp    80104e93 <alltraps>
...
801055cb:	6a 4e                	push   $0x4e
  jmp alltraps
801055cd:	e9 c1 f8 ff ff       	jmp    80104e93 <alltraps>
...
801055d4:	6a 4f                	push   $0x4f
  jmp alltraps
801055d6:	e9 b8 f8 ff ff       	jmp    80104e93 <alltraps>
...
801055dd:	6a 50                	push   $0x50
  jmp alltraps
801055df:	e9 af f8 ff ff       	jmp    80104e93 <alltraps>
...
801055e6:	6a 51                	push   $0x51
  jmp alltraps
801055e8:	e9 a6 f8 ff ff       	jmp    80104e93 <alltraps>
...
801055ef:	6a 52                	push   $0x52
  jmp alltraps
801055f1:	e9 9d f8 ff ff       	jmp    80104e93 <alltraps>
...
801055f8:	6a 53                	push   $0x53
  jmp alltraps
801055fa:	e9 94 f8 ff ff       	jmp    80104e93 <alltraps>
...
80105601:	6a 54                	push   $0x54
  jmp alltraps
80105603:	e9 8b f8 ff ff       	jmp    80104e93 <alltraps>
...
8010560a:	6a 55                	push   $0x55
  jmp alltraps
8010560c:	e9 82 f8 ff ff       	jmp    80104e93 <alltraps>
...
80105613:	6a 56                	push   $0x56
  jmp alltraps
80105615:	e9 79 f8 ff ff       	jmp    80104e93 <alltraps>
...
8010561c:	6a 57                	push   $0x57
  jmp alltraps
8010561e:	e9 70 f8 ff ff       	jmp    80104e93 <alltraps>
...
80105625:	6a 58                	push   $0x58
  jmp alltraps
80105627:	e9 67 f8 ff ff       	jmp    80104e93 <alltraps>
...
8010562e:	6a 59                	push   $0x59
  jmp alltraps
80105630:	e9 5e f8 ff ff       	jmp    80104e93 <alltraps>
...
80105637:	6a 5a                	push   $0x5a
  jmp alltraps
80105639:	e9 55 f8 ff ff       	jmp    80104e93 <alltraps>
...
80105640:	6a 5b                	push   $0x5b
  jmp alltraps
80105642:	e9 4c f8 ff ff       	jmp    80104e93 <alltraps>
...
80105649:	6a 5c                	push   $0x5c
  jmp alltraps
8010564b:	e9 43 f8 ff ff       	jmp    80104e93 <alltraps>
...
80105652:	6a 5d                	push   $0x5d
  jmp alltraps
80105654:	e9 3a f8 ff ff       	jmp    80104e93 <alltraps>
...
8010565b:	6a 5e                	push   $0x5e
  jmp alltraps
8010565d:	e9 31 f8 ff ff       	jmp    80104e93 <alltraps>
...
80105664:	6a 5f                	push   $0x5f
  jmp alltraps
80105666:	e9 28 f8 ff ff       	jmp    80104e93 <alltraps>
...
8010566d:	6a 60                	push   $0x60
  jmp alltraps
8010566f:	e9 1f f8 ff ff       	jmp    80104e93 <alltraps>
...
80105676:	6a 61                	push   $0x61
  jmp alltraps
80105678:	e9 16 f8 ff ff       	jmp    80104e93 <alltraps>
...
8010567f:	6a 62                	push   $0x62
  jmp alltraps
80105681:	e9 0d f8 ff ff       	jmp    80104e93 <alltraps>
...
80105688:	6a 63                	push   $0x63
  jmp alltraps
8010568a:	e9 04 f8 ff ff       	jmp    80104e93 <alltraps>
...
80105691:	6a 64                	push   $0x64
  jmp alltraps
80105693:	e9 fb f7 ff ff       	jmp    80104e93 <alltraps>
...
8010569a:	6a 65                	push   $0x65
  jmp alltraps
8010569c:	e9 f2 f7 ff ff       	jmp    80104e93 <alltraps>
...
801056a3:	6a 66                	push   $0x66
  jmp alltraps
801056a5:	e9 e9 f7 ff ff       	jmp    80104e93 <alltraps>
...
801056ac:	6a 67                	push   $0x67
  jmp alltraps
801056ae:	e9 e0 f7 ff ff       	jmp    80104e93 <alltraps>
...
801056b5:	6a 68                	push   $0x68
  jmp alltraps
801056b7:	e9 d7 f7 ff ff       	jmp    80104e93 <alltraps>
...
801056be:	6a 69                	push   $0x69
  jmp alltraps
801056c0:	e9 ce f7 ff ff       	jmp    80104e93 <alltraps>
...
801056c7:	6a 6a                	push   $0x6a
  jmp alltraps
801056c9:	e9 c5 f7 ff ff       	jmp    80104e93 <alltraps>
...
801056d0:	6a 6b                	push   $0x6b
  jmp alltraps
801056d2:	e9 bc f7 ff ff       	jmp    80104e93 <alltraps>
...
801056d9:	6a 6c                	push   $0x6c
  jmp alltraps
801056db:	e9 b3 f7 ff ff       	jmp    80104e93 <alltraps>
...
801056e2:	6a 6d                	push   $0x6d
  jmp alltraps
801056e4:	e9 aa f7 ff ff       	jmp    80104e93 <alltraps>
...
801056eb:	6a 6e                	push   $0x6e
  jmp alltraps
801056ed:	e9 a1 f7 ff ff       	jmp    80104e93 <alltraps>
...
801056f4:	6a 6f                	push   $0x6f
  jmp alltraps
801056f6:	e9 98 f7 ff ff       	jmp    80104e93 <alltraps>
...
801056fd:	6a 70                	push   $0x70
  jmp alltraps
801056ff:	e9 8f f7 ff ff       	jmp    80104e93 <alltraps>
...
80105706:	6a 71                	push   $0x71
  jmp alltraps
80105708:	e9 86 f7 ff ff       	jmp    80104e93 <alltraps>
...
8010570f:	6a 72                	push   $0x72
  jmp alltraps
80105711:	e9 7d f7 ff ff       	jmp    80104e93 <alltraps>
...
80105718:	6a 73                	push   $0x73
  jmp alltraps
8010571a:	e9 74 f7 ff ff       	jmp    80104e93 <alltraps>
...
80105721:	6a 74                	push   $0x74
  jmp alltraps
80105723:	e9 6b f7 ff ff       	jmp    80104e93 <alltraps>
...
8010572a:	6a 75                	push   $0x75
  jmp alltraps
8010572c:	e9 62 f7 ff ff       	jmp    80104e93 <alltraps>
...
80105733:	6a 76                	push   $0x76
  jmp alltraps
80105735:	e9 59 f7 ff ff       	jmp    80104e93 <alltraps>
...
8010573c:	6a 77                	push   $0x77
  jmp alltraps
8010573e:	e9 50 f7 ff ff       	jmp    80104e93 <alltraps>
...
80105745:	6a 78                	push   $0x78
  jmp alltraps
80105747:	e9 47 f7 ff ff       	jmp    80104e93 <alltraps>
...
8010574e:	6a 79                	push   $0x79
  jmp alltraps
80105750:	e9 3e f7 ff ff       	jmp    80104e93 <alltraps>
...
80105757:	6a 7a                	push   $0x7a
  jmp alltraps
80105759:	e9 35 f7 ff ff       	jmp    80104e93 <alltraps>
...
80105760:	6a 7b                	push   $0x7b
  jmp alltraps
80105762:	e9 2c f7 ff ff       	jmp    80104e93 <alltraps>
...
80105769:	6a 7c                	push   $0x7c
  jmp alltraps
8010576b:	e9 23 f7 ff ff       	jmp    80104e93 <alltraps>
...
80105772:	6a 7d                	push   $0x7d
  jmp alltraps
80105774:	e9 1a f7 ff ff       	jmp    80104e93 <alltraps>
...
8010577b:	6a 7e                	push   $0x7e
  jmp alltraps
8010577d:	e9 11 f7 ff ff       	jmp    80104e93 <alltraps>
...
80105784:	6a 7f                	push   $0x7f
  jmp alltraps
80105786:	e9 08 f7 ff ff       	jmp    80104e93 <alltraps>
...
8010578d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105792:	e9 fc f6 ff ff       	jmp    80104e93 <alltraps>
...
80105799:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010579e:	e9 f0 f6 ff ff       	jmp    80104e93 <alltraps>
...
801057a5:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801057aa:	e9 e4 f6 ff ff       	jmp    80104e93 <alltraps>
...
801057b1:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801057b6:	e9 d8 f6 ff ff       	jmp    80104e93 <alltraps>
...
801057bd:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801057c2:	e9 cc f6 ff ff       	jmp    80104e93 <alltraps>
...
801057c9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801057ce:	e9 c0 f6 ff ff       	jmp    80104e93 <alltraps>
...
801057d5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801057da:	e9 b4 f6 ff ff       	jmp    80104e93 <alltraps>
...
801057e1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801057e6:	e9 a8 f6 ff ff       	jmp    80104e93 <alltraps>
...
801057ed:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801057f2:	e9 9c f6 ff ff       	jmp    80104e93 <alltraps>
...
801057f9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801057fe:	e9 90 f6 ff ff       	jmp    80104e93 <alltraps>
...
80105805:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010580a:	e9 84 f6 ff ff       	jmp    80104e93 <alltraps>
...
80105811:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105816:	e9 78 f6 ff ff       	jmp    80104e93 <alltraps>
...
8010581d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105822:	e9 6c f6 ff ff       	jmp    80104e93 <alltraps>
...
80105829:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010582e:	e9 60 f6 ff ff       	jmp    80104e93 <alltraps>
...
80105835:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010583a:	e9 54 f6 ff ff       	jmp    80104e93 <alltraps>
...
80105841:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105846:	e9 48 f6 ff ff       	jmp    80104e93 <alltraps>
...
8010584d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105852:	e9 3c f6 ff ff       	jmp    80104e93 <alltraps>
...
80105859:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010585e:	e9 30 f6 ff ff       	jmp    80104e93 <alltraps>
...
80105865:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010586a:	e9 24 f6 ff ff       	jmp    80104e93 <alltraps>
...
80105871:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105876:	e9 18 f6 ff ff       	jmp    80104e93 <alltraps>
...
8010587d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105882:	e9 0c f6 ff ff       	jmp    80104e93 <alltraps>
...
80105889:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010588e:	e9 00 f6 ff ff       	jmp    80104e93 <alltraps>
...
80105895:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010589a:	e9 f4 f5 ff ff       	jmp    80104e93 <alltraps>
...
801058a1:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801058a6:	e9 e8 f5 ff ff       	jmp    80104e93 <alltraps>
...
801058ad:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801058b2:	e9 dc f5 ff ff       	jmp    80104e93 <alltraps>
...
801058b9:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801058be:	e9 d0 f5 ff ff       	jmp    80104e93 <alltraps>
...
801058c5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801058ca:	e9 c4 f5 ff ff       	jmp    80104e93 <alltraps>
...
801058d1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801058d6:	e9 b8 f5 ff ff       	jmp    80104e93 <alltraps>
...
801058dd:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801058e2:	e9 ac f5 ff ff       	jmp    80104e93 <alltraps>
...
801058e9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801058ee:	e9 a0 f5 ff ff       	jmp    80104e93 <alltraps>
...
801058f5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801058fa:	e9 94 f5 ff ff       	jmp    80104e93 <alltraps>
...
80105901:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105906:	e9 88 f5 ff ff       	jmp    80104e93 <alltraps>
...
8010590d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105912:	e9 7c f5 ff ff       	jmp    80104e93 <alltraps>
...
80105919:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010591e:	e9 70 f5 ff ff       	jmp    80104e93 <alltraps>
...
80105925:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010592a:	e9 64 f5 ff ff       	jmp    80104e93 <alltraps>
...
80105931:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105936:	e9 58 f5 ff ff       	jmp    80104e93 <alltraps>
...
8010593d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105942:	e9 4c f5 ff ff       	jmp    80104e93 <alltraps>
...
80105949:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010594e:	e9 40 f5 ff ff       	jmp    80104e93 <alltraps>
...
80105955:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010595a:	e9 34 f5 ff ff       	jmp    80104e93 <alltraps>
...
80105961:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105966:	e9 28 f5 ff ff       	jmp    80104e93 <alltraps>
...
8010596d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105972:	e9 1c f5 ff ff       	jmp    80104e93 <alltraps>
...
80105979:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010597e:	e9 10 f5 ff ff       	jmp    80104e93 <alltraps>
...
80105985:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010598a:	e9 04 f5 ff ff       	jmp    80104e93 <alltraps>
...
80105991:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105996:	e9 f8 f4 ff ff       	jmp    80104e93 <alltraps>
...
8010599d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801059a2:	e9 ec f4 ff ff       	jmp    80104e93 <alltraps>
...
801059a9:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801059ae:	e9 e0 f4 ff ff       	jmp    80104e93 <alltraps>
...
801059b5:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801059ba:	e9 d4 f4 ff ff       	jmp    80104e93 <alltraps>
...
801059c1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801059c6:	e9 c8 f4 ff ff       	jmp    80104e93 <alltraps>
...
801059cd:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801059d2:	e9 bc f4 ff ff       	jmp    80104e93 <alltraps>
...
801059d9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801059de:	e9 b0 f4 ff ff       	jmp    80104e93 <alltraps>
...
801059e5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801059ea:	e9 a4 f4 ff ff       	jmp    80104e93 <alltraps>
...
801059f1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801059f6:	e9 98 f4 ff ff       	jmp    80104e93 <alltraps>
...
801059fd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105a02:	e9 8c f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a09:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105a0e:	e9 80 f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a15:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105a1a:	e9 74 f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a21:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105a26:	e9 68 f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a2d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105a32:	e9 5c f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a39:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105a3e:	e9 50 f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a45:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105a4a:	e9 44 f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a51:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80105a56:	e9 38 f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a5d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105a62:	e9 2c f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a69:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105a6e:	e9 20 f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a75:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80105a7a:	e9 14 f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a81:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80105a86:	e9 08 f4 ff ff       	jmp    80104e93 <alltraps>
...
80105a8d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105a92:	e9 fc f3 ff ff       	jmp    80104e93 <alltraps>
...
80105a99:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80105a9e:	e9 f0 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105aa5:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80105aaa:	e9 e4 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105ab1:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80105ab6:	e9 d8 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105abd:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105ac2:	e9 cc f3 ff ff       	jmp    80104e93 <alltraps>
...
80105ac9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80105ace:	e9 c0 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105ad5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80105ada:	e9 b4 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105ae1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80105ae6:	e9 a8 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105aed:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80105af2:	e9 9c f3 ff ff       	jmp    80104e93 <alltraps>
...
80105af9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80105afe:	e9 90 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b05:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80105b0a:	e9 84 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b11:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80105b16:	e9 78 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b1d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105b22:	e9 6c f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b29:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105b2e:	e9 60 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b35:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105b3a:	e9 54 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b41:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105b46:	e9 48 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b4d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105b52:	e9 3c f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b59:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105b5e:	e9 30 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b65:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105b6a:	e9 24 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b71:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105b76:	e9 18 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b7d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105b82:	e9 0c f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b89:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105b8e:	e9 00 f3 ff ff       	jmp    80104e93 <alltraps>
...
80105b95:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105b9a:	e9 f4 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105ba1:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105ba6:	e9 e8 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105bad:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105bb2:	e9 dc f2 ff ff       	jmp    80104e93 <alltraps>
...
80105bb9:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105bbe:	e9 d0 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105bc5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105bca:	e9 c4 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105bd1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105bd6:	e9 b8 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105bdd:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105be2:	e9 ac f2 ff ff       	jmp    80104e93 <alltraps>
...
80105be9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105bee:	e9 a0 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105bf5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105bfa:	e9 94 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c01:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105c06:	e9 88 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c0d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105c12:	e9 7c f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c19:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105c1e:	e9 70 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c25:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105c2a:	e9 64 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c31:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105c36:	e9 58 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c3d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105c42:	e9 4c f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c49:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105c4e:	e9 40 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c55:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105c5a:	e9 34 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c61:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105c66:	e9 28 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c6d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105c72:	e9 1c f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c79:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105c7e:	e9 10 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c85:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105c8a:	e9 04 f2 ff ff       	jmp    80104e93 <alltraps>
...
80105c91:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105c96:	e9 f8 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105c9d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105ca2:	e9 ec f1 ff ff       	jmp    80104e93 <alltraps>
...
80105ca9:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105cae:	e9 e0 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105cb5:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105cba:	e9 d4 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105cc1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105cc6:	e9 c8 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105ccd:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105cd2:	e9 bc f1 ff ff       	jmp    80104e93 <alltraps>
...
80105cd9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105cde:	e9 b0 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105ce5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105cea:	e9 a4 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105cf1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105cf6:	e9 98 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105cfd:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105d02:	e9 8c f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d09:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105d0e:	e9 80 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d15:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105d1a:	e9 74 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d21:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105d26:	e9 68 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d2d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105d32:	e9 5c f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d39:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105d3e:	e9 50 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d45:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105d4a:	e9 44 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d51:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105d56:	e9 38 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d5d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105d62:	e9 2c f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d69:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105d6e:	e9 20 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d75:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105d7a:	e9 14 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105d81:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105d86:	e9 08 f1 ff ff       	jmp    80104e93 <alltraps>
...
80105da4:	74 35                	je     80105ddb <walkpgdir+0x50>
...
80105da6:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if (a > KERNBASE)
80105dac:	81 fe 00 00 00 80    	cmp    $0x80000000,%esi
80105db2:	77 1a                	ja     80105dce <walkpgdir+0x43>
    return (char*)a + KERNBASE;
...
80105dd1:	68 38 6e 10 80       	push   $0x80106e38
80105dd6:	e8 6d a5 ff ff       	call   80100348 <panic>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80105ddb:	85 c9                	test   %ecx,%ecx
80105ddd:	74 33                	je     80105e12 <walkpgdir+0x87>
80105ddf:	e8 e5 c2 ff ff       	call   801020c9 <kalloc>
80105de4:	89 c6                	mov    %eax,%esi
80105de6:	85 c0                	test   %eax,%eax
80105de8:	74 28                	je     80105e12 <walkpgdir+0x87>
    memset(pgtab, 0, PGSIZE);
80105dea:	83 ec 04             	sub    $0x4,%esp
80105ded:	68 00 10 00 00       	push   $0x1000
80105df2:	6a 00                	push   $0x0
80105df4:	50                   	push   %eax
80105df5:	e8 bb df ff ff       	call   80103db5 <memset>
    if (a < (void*) KERNBASE)
80105dfa:	83 c4 10             	add    $0x10,%esp
80105dfd:	81 fe ff ff ff 7f    	cmp    $0x7fffffff,%esi
80105e03:	76 14                	jbe    80105e19 <walkpgdir+0x8e>
    return (uint)a - KERNBASE;
80105e05:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105e0b:	83 c8 07             	or     $0x7,%eax
80105e0e:	89 07                	mov    %eax,(%edi)
80105e10:	eb a8                	jmp    80105dba <walkpgdir+0x2f>
      return 0;
80105e12:	b8 00 00 00 00       	mov    $0x0,%eax
80105e17:	eb ad                	jmp    80105dc6 <walkpgdir+0x3b>
        panic("V2P on address < KERNBASE "
80105e19:	83 ec 0c             	sub    $0xc,%esp
80105e1c:	68 08 6b 10 80       	push   $0x80106b08
80105e21:	e8 22 a5 ff ff       	call   80100348 <panic>
...
80105e2c:	83 ec 1c             	sub    $0x1c,%esp
80105e2f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105e32:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105e35:	89 d3                	mov    %edx,%ebx
80105e37:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105e3d:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105e41:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105e47:	b9 01 00 00 00       	mov    $0x1,%ecx
80105e4c:	89 da                	mov    %ebx,%edx
80105e4e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e51:	e8 35 ff ff ff       	call   80105d8b <walkpgdir>
80105e56:	85 c0                	test   %eax,%eax
80105e58:	74 2e                	je     80105e88 <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105e5a:	f6 00 01             	testb  $0x1,(%eax)
80105e5d:	75 1c                	jne    80105e7b <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105e5f:	89 f2                	mov    %esi,%edx
80105e61:	0b 55 0c             	or     0xc(%ebp),%edx
80105e64:	83 ca 01             	or     $0x1,%edx
80105e67:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105e69:	39 fb                	cmp    %edi,%ebx
80105e6b:	74 28                	je     80105e95 <mappages+0x6f>
      break;
    a += PGSIZE;
80105e6d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105e73:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105e79:	eb cc                	jmp    80105e47 <mappages+0x21>
      panic("remap");
80105e7b:	83 ec 0c             	sub    $0xc,%esp
80105e7e:	68 20 72 10 80       	push   $0x80107220
80105e83:	e8 c0 a4 ff ff       	call   80100348 <panic>
      return -1;
...
80105e9a:	eb f1                	jmp    80105e8d <mappages+0x67>
...
80105ea2:	83 ec 1c             	sub    $0x1c,%esp
  c = &cpus[cpuid()];
80105ea5:	e8 c0 d3 ff ff       	call   8010326a <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105eaa:	69 f8 b0 00 00 00    	imul   $0xb0,%eax,%edi
80105eb0:	66 c7 87 18 18 11 80 	movw   $0xffff,-0x7feee7e8(%edi)
80105eb7:	ff ff 
80105eb9:	66 c7 87 1a 18 11 80 	movw   $0x0,-0x7feee7e6(%edi)
80105ec0:	00 00 
80105ec2:	c6 87 1c 18 11 80 00 	movb   $0x0,-0x7feee7e4(%edi)
80105ec9:	0f b6 8f 1d 18 11 80 	movzbl -0x7feee7e3(%edi),%ecx
80105ed0:	83 e1 f0             	and    $0xfffffff0,%ecx
80105ed3:	89 ce                	mov    %ecx,%esi
80105ed5:	83 ce 0a             	or     $0xa,%esi
80105ed8:	89 f2                	mov    %esi,%edx
80105eda:	88 97 1d 18 11 80    	mov    %dl,-0x7feee7e3(%edi)
80105ee0:	83 c9 1a             	or     $0x1a,%ecx
80105ee3:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105ee9:	83 e1 9f             	and    $0xffffff9f,%ecx
80105eec:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105ef2:	83 c9 80             	or     $0xffffff80,%ecx
80105ef5:	88 8f 1d 18 11 80    	mov    %cl,-0x7feee7e3(%edi)
80105efb:	0f b6 8f 1e 18 11 80 	movzbl -0x7feee7e2(%edi),%ecx
80105f02:	83 c9 0f             	or     $0xf,%ecx
80105f05:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105f0b:	89 ce                	mov    %ecx,%esi
80105f0d:	83 e6 ef             	and    $0xffffffef,%esi
80105f10:	89 f2                	mov    %esi,%edx
80105f12:	88 97 1e 18 11 80    	mov    %dl,-0x7feee7e2(%edi)
80105f18:	83 e1 cf             	and    $0xffffffcf,%ecx
80105f1b:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105f21:	89 ce                	mov    %ecx,%esi
80105f23:	83 ce 40             	or     $0x40,%esi
80105f26:	89 f2                	mov    %esi,%edx
80105f28:	88 97 1e 18 11 80    	mov    %dl,-0x7feee7e2(%edi)
80105f2e:	83 c9 c0             	or     $0xffffffc0,%ecx
80105f31:	88 8f 1e 18 11 80    	mov    %cl,-0x7feee7e2(%edi)
80105f37:	c6 87 1f 18 11 80 00 	movb   $0x0,-0x7feee7e1(%edi)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105f3e:	66 c7 87 20 18 11 80 	movw   $0xffff,-0x7feee7e0(%edi)
80105f45:	ff ff 
80105f47:	66 c7 87 22 18 11 80 	movw   $0x0,-0x7feee7de(%edi)
80105f4e:	00 00 
80105f50:	c6 87 24 18 11 80 00 	movb   $0x0,-0x7feee7dc(%edi)
80105f57:	0f b6 8f 25 18 11 80 	movzbl -0x7feee7db(%edi),%ecx
80105f5e:	83 e1 f0             	and    $0xfffffff0,%ecx
80105f61:	89 ce                	mov    %ecx,%esi
80105f63:	83 ce 02             	or     $0x2,%esi
80105f66:	89 f2                	mov    %esi,%edx
80105f68:	88 97 25 18 11 80    	mov    %dl,-0x7feee7db(%edi)
80105f6e:	83 c9 12             	or     $0x12,%ecx
80105f71:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105f77:	83 e1 9f             	and    $0xffffff9f,%ecx
80105f7a:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105f80:	83 c9 80             	or     $0xffffff80,%ecx
80105f83:	88 8f 25 18 11 80    	mov    %cl,-0x7feee7db(%edi)
80105f89:	0f b6 8f 26 18 11 80 	movzbl -0x7feee7da(%edi),%ecx
80105f90:	83 c9 0f             	or     $0xf,%ecx
80105f93:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105f99:	89 ce                	mov    %ecx,%esi
80105f9b:	83 e6 ef             	and    $0xffffffef,%esi
80105f9e:	89 f2                	mov    %esi,%edx
80105fa0:	88 97 26 18 11 80    	mov    %dl,-0x7feee7da(%edi)
80105fa6:	83 e1 cf             	and    $0xffffffcf,%ecx
80105fa9:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105faf:	89 ce                	mov    %ecx,%esi
80105fb1:	83 ce 40             	or     $0x40,%esi
80105fb4:	89 f2                	mov    %esi,%edx
80105fb6:	88 97 26 18 11 80    	mov    %dl,-0x7feee7da(%edi)
80105fbc:	83 c9 c0             	or     $0xffffffc0,%ecx
80105fbf:	88 8f 26 18 11 80    	mov    %cl,-0x7feee7da(%edi)
80105fc5:	c6 87 27 18 11 80 00 	movb   $0x0,-0x7feee7d9(%edi)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80105fcc:	66 c7 87 28 18 11 80 	movw   $0xffff,-0x7feee7d8(%edi)
80105fd3:	ff ff 
80105fd5:	66 c7 87 2a 18 11 80 	movw   $0x0,-0x7feee7d6(%edi)
80105fdc:	00 00 
80105fde:	c6 87 2c 18 11 80 00 	movb   $0x0,-0x7feee7d4(%edi)
80105fe5:	0f b6 9f 2d 18 11 80 	movzbl -0x7feee7d3(%edi),%ebx
80105fec:	83 e3 f0             	and    $0xfffffff0,%ebx
80105fef:	89 de                	mov    %ebx,%esi
80105ff1:	83 ce 0a             	or     $0xa,%esi
80105ff4:	89 f2                	mov    %esi,%edx
80105ff6:	88 97 2d 18 11 80    	mov    %dl,-0x7feee7d3(%edi)
80105ffc:	89 de                	mov    %ebx,%esi
80105ffe:	83 ce 1a             	or     $0x1a,%esi
80106001:	89 f2                	mov    %esi,%edx
80106003:	88 97 2d 18 11 80    	mov    %dl,-0x7feee7d3(%edi)
80106009:	83 cb 7a             	or     $0x7a,%ebx
8010600c:	88 9f 2d 18 11 80    	mov    %bl,-0x7feee7d3(%edi)
80106012:	c6 87 2d 18 11 80 fa 	movb   $0xfa,-0x7feee7d3(%edi)
80106019:	0f b6 9f 2e 18 11 80 	movzbl -0x7feee7d2(%edi),%ebx
80106020:	83 cb 0f             	or     $0xf,%ebx
80106023:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
80106029:	89 de                	mov    %ebx,%esi
8010602b:	83 e6 ef             	and    $0xffffffef,%esi
8010602e:	89 f2                	mov    %esi,%edx
80106030:	88 97 2e 18 11 80    	mov    %dl,-0x7feee7d2(%edi)
80106036:	83 e3 cf             	and    $0xffffffcf,%ebx
80106039:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
8010603f:	89 de                	mov    %ebx,%esi
80106041:	83 ce 40             	or     $0x40,%esi
80106044:	89 f2                	mov    %esi,%edx
80106046:	88 97 2e 18 11 80    	mov    %dl,-0x7feee7d2(%edi)
8010604c:	83 cb c0             	or     $0xffffffc0,%ebx
8010604f:	88 9f 2e 18 11 80    	mov    %bl,-0x7feee7d2(%edi)
80106055:	c6 87 2f 18 11 80 00 	movb   $0x0,-0x7feee7d1(%edi)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010605c:	66 c7 87 30 18 11 80 	movw   $0xffff,-0x7feee7d0(%edi)
80106063:	ff ff 
80106065:	66 c7 87 32 18 11 80 	movw   $0x0,-0x7feee7ce(%edi)
8010606c:	00 00 
8010606e:	c6 87 34 18 11 80 00 	movb   $0x0,-0x7feee7cc(%edi)
80106075:	0f b6 9f 35 18 11 80 	movzbl -0x7feee7cb(%edi),%ebx
8010607c:	83 e3 f0             	and    $0xfffffff0,%ebx
8010607f:	89 de                	mov    %ebx,%esi
80106081:	83 ce 02             	or     $0x2,%esi
80106084:	89 f2                	mov    %esi,%edx
80106086:	88 97 35 18 11 80    	mov    %dl,-0x7feee7cb(%edi)
8010608c:	89 de                	mov    %ebx,%esi
8010608e:	83 ce 12             	or     $0x12,%esi
80106091:	89 f2                	mov    %esi,%edx
80106093:	88 97 35 18 11 80    	mov    %dl,-0x7feee7cb(%edi)
80106099:	83 cb 72             	or     $0x72,%ebx
8010609c:	88 9f 35 18 11 80    	mov    %bl,-0x7feee7cb(%edi)
801060a2:	c6 87 35 18 11 80 f2 	movb   $0xf2,-0x7feee7cb(%edi)
801060a9:	0f b6 9f 36 18 11 80 	movzbl -0x7feee7ca(%edi),%ebx
801060b0:	83 cb 0f             	or     $0xf,%ebx
801060b3:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
801060b9:	89 de                	mov    %ebx,%esi
801060bb:	83 e6 ef             	and    $0xffffffef,%esi
801060be:	89 f2                	mov    %esi,%edx
801060c0:	88 97 36 18 11 80    	mov    %dl,-0x7feee7ca(%edi)
801060c6:	83 e3 cf             	and    $0xffffffcf,%ebx
801060c9:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
801060cf:	89 de                	mov    %ebx,%esi
801060d1:	83 ce 40             	or     $0x40,%esi
801060d4:	89 f2                	mov    %esi,%edx
801060d6:	88 97 36 18 11 80    	mov    %dl,-0x7feee7ca(%edi)
801060dc:	83 cb c0             	or     $0xffffffc0,%ebx
801060df:	88 9f 36 18 11 80    	mov    %bl,-0x7feee7ca(%edi)
801060e5:	c6 87 37 18 11 80 00 	movb   $0x0,-0x7feee7c9(%edi)
  lgdt(c->gdt, sizeof(c->gdt));
801060ec:	8d 97 10 18 11 80    	lea    -0x7feee7f0(%edi),%edx
  pd[0] = size-1;
...
80106109:	83 c4 1c             	add    $0x1c,%esp
8010610c:	5b                   	pop    %ebx
8010610d:	5e                   	pop    %esi
8010610e:	5f                   	pop    %edi
8010610f:	5d                   	pop    %ebp
...
80106111:	a1 c4 46 11 80       	mov    0x801146c4,%eax
    if (a < (void*) KERNBASE)
80106116:	3d ff ff ff 7f       	cmp    $0x7fffffff,%eax
8010611b:	76 09                	jbe    80106126 <switchkvm+0x15>
    return (uint)a - KERNBASE;
8010611d:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106129:	83 ec 14             	sub    $0x14,%esp
        panic("V2P on address < KERNBASE "
8010612c:	68 08 6b 10 80       	push   $0x80106b08
...
80106144:	0f 84 2c 01 00 00    	je     80106276 <switchuvm+0x140>
    panic("switchuvm: no process");
  if(p->kstack == 0)
8010614a:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
8010614e:	0f 84 2f 01 00 00    	je     80106283 <switchuvm+0x14d>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80106154:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80106158:	0f 84 32 01 00 00    	je     80106290 <switchuvm+0x15a>
    panic("switchuvm: no pgdir");

  pushcli();
8010615e:	e8 cb da ff ff       	call   80103c2e <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106163:	e8 a6 d0 ff ff       	call   8010320e <mycpu>
80106168:	89 c3                	mov    %eax,%ebx
8010616a:	e8 9f d0 ff ff       	call   8010320e <mycpu>
8010616f:	8d 78 08             	lea    0x8(%eax),%edi
80106172:	e8 97 d0 ff ff       	call   8010320e <mycpu>
80106177:	83 c0 08             	add    $0x8,%eax
8010617a:	c1 e8 10             	shr    $0x10,%eax
8010617d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106180:	e8 89 d0 ff ff       	call   8010320e <mycpu>
...
801061af:	89 d1                	mov    %edx,%ecx
801061b1:	83 c9 09             	or     $0x9,%ecx
801061b4:	88 8b 9d 00 00 00    	mov    %cl,0x9d(%ebx)
801061ba:	83 ca 19             	or     $0x19,%edx
801061bd:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
801061c3:	83 e2 9f             	and    $0xffffff9f,%edx
801061c6:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
801061cc:	83 ca 80             	or     $0xffffff80,%edx
801061cf:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
801061d5:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
801061dc:	89 d1                	mov    %edx,%ecx
801061de:	83 e1 f0             	and    $0xfffffff0,%ecx
801061e1:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
801061e7:	89 d1                	mov    %edx,%ecx
801061e9:	83 e1 e0             	and    $0xffffffe0,%ecx
801061ec:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
801061f2:	83 e2 c0             	and    $0xffffffc0,%edx
801061f5:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
801061fb:	83 ca 40             	or     $0x40,%edx
801061fe:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80106204:	83 e2 7f             	and    $0x7f,%edx
80106207:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
8010620d:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106213:	e8 f6 cf ff ff       	call   8010320e <mycpu>
80106218:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010621f:	83 e2 ef             	and    $0xffffffef,%edx
80106222:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106228:	e8 e1 cf ff ff       	call   8010320e <mycpu>
8010622d:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106233:	8b 5e 08             	mov    0x8(%esi),%ebx
80106236:	e8 d3 cf ff ff       	call   8010320e <mycpu>
8010623b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106241:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106244:	e8 c5 cf ff ff       	call   8010320e <mycpu>
80106249:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
8010624f:	b8 28 00 00 00       	mov    $0x28,%eax
80106254:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106257:	8b 46 04             	mov    0x4(%esi),%eax
    if (a < (void*) KERNBASE)
8010625a:	3d ff ff ff 7f       	cmp    $0x7fffffff,%eax
8010625f:	76 3c                	jbe    8010629d <switchuvm+0x167>
    return (uint)a - KERNBASE;
80106261:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106266:	0f 22 d8             	mov    %eax,%cr3
  popcli();
80106269:	e8 fc d9 ff ff       	call   80103c6a <popcli>
}
...
801062b8:	77 57                	ja     80106311 <inituvm+0x67>
    panic("inituvm: more than a page");
  mem = kalloc();
801062ba:	e8 0a be ff ff       	call   801020c9 <kalloc>
...
801062cc:	e8 e4 da ff ff       	call   80103db5 <memset>
    if (a < (void*) KERNBASE)
801062d1:	83 c4 10             	add    $0x10,%esp
801062d4:	81 fb ff ff ff 7f    	cmp    $0x7fffffff,%ebx
801062da:	76 42                	jbe    8010631e <inituvm+0x74>
    return (uint)a - KERNBASE;
801062dc:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801062e2:	83 ec 08             	sub    $0x8,%esp
801062e5:	6a 06                	push   $0x6
801062e7:	50                   	push   %eax
801062e8:	b9 00 10 00 00       	mov    $0x1000,%ecx
801062ed:	ba 00 00 00 00       	mov    $0x0,%edx
801062f2:	8b 45 08             	mov    0x8(%ebp),%eax
801062f5:	e8 2c fb ff ff       	call   80105e26 <mappages>
  memmove(mem, init, sz);
801062fa:	83 c4 0c             	add    $0xc,%esp
801062fd:	56                   	push   %esi
801062fe:	ff 75 0c             	push   0xc(%ebp)
80106301:	53                   	push   %ebx
80106302:	e8 26 db ff ff       	call   80103e2d <memmove>
}
...
80106314:	68 65 72 10 80       	push   $0x80107265
80106319:	e8 2a a0 ff ff       	call   80100348 <panic>
        panic("V2P on address < KERNBASE "
8010631e:	83 ec 0c             	sub    $0xc,%esp
80106321:	68 08 6b 10 80       	push   $0x80106b08
...
80106334:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80106337:	8b 5d 0c             	mov    0xc(%ebp),%ebx
8010633a:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
80106340:	74 43                	je     80106385 <loaduvm+0x5a>
    panic("loaduvm: addr must be page aligned");
80106342:	83 ec 0c             	sub    $0xc,%esp
80106345:	68 20 73 10 80       	push   $0x80107320
8010634a:	e8 f9 9f ff ff       	call   80100348 <panic>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
8010634f:	83 ec 0c             	sub    $0xc,%esp
80106352:	68 7f 72 10 80       	push   $0x8010727f
...
8010635e:	03 55 14             	add    0x14(%ebp),%edx
    if (a > KERNBASE)
80106361:	3d 00 00 00 80       	cmp    $0x80000000,%eax
80106366:	77 51                	ja     801063b9 <loaduvm+0x8e>
    return (char*)a + KERNBASE;
80106368:	05 00 00 00 80       	add    $0x80000000,%eax
8010636d:	56                   	push   %esi
8010636e:	52                   	push   %edx
8010636f:	50                   	push   %eax
80106370:	ff 75 10             	push   0x10(%ebp)
80106373:	e8 e9 b3 ff ff       	call   80101761 <readi>
80106378:	83 c4 10             	add    $0x10,%esp
8010637b:	39 f0                	cmp    %esi,%eax
8010637d:	75 54                	jne    801063d3 <loaduvm+0xa8>
  for(i = 0; i < sz; i += PGSIZE){
8010637f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106385:	39 fb                	cmp    %edi,%ebx
80106387:	73 3d                	jae    801063c6 <loaduvm+0x9b>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106389:	89 da                	mov    %ebx,%edx
8010638b:	03 55 0c             	add    0xc(%ebp),%edx
8010638e:	b9 00 00 00 00       	mov    $0x0,%ecx
80106393:	8b 45 08             	mov    0x8(%ebp),%eax
80106396:	e8 f0 f9 ff ff       	call   80105d8b <walkpgdir>
8010639b:	85 c0                	test   %eax,%eax
8010639d:	74 b0                	je     8010634f <loaduvm+0x24>
    pa = PTE_ADDR(*pte);
8010639f:	8b 00                	mov    (%eax),%eax
801063a1:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
801063a6:	89 fe                	mov    %edi,%esi
801063a8:	29 de                	sub    %ebx,%esi
801063aa:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
801063b0:	76 aa                	jbe    8010635c <loaduvm+0x31>
      n = PGSIZE;
801063b2:	be 00 10 00 00       	mov    $0x1000,%esi
801063b7:	eb a3                	jmp    8010635c <loaduvm+0x31>
        panic("P2V on address > KERNBASE");
801063b9:	83 ec 0c             	sub    $0xc,%esp
801063bc:	68 38 6e 10 80       	push   $0x80106e38
801063c1:	e8 82 9f ff ff       	call   80100348 <panic>
      return -1;
  }
  return 0;
...
801063d8:	eb f1                	jmp    801063cb <loaduvm+0xa0>
...
801063e3:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
801063e6:	39 7d 10             	cmp    %edi,0x10(%ebp)
801063e9:	73 11                	jae    801063fc <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
801063eb:	8b 45 10             	mov    0x10(%ebp),%eax
801063ee:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801063f4:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801063fa:	eb 19                	jmp    80106415 <deallocuvm+0x3b>
    return oldsz;
801063fc:	89 f8                	mov    %edi,%eax
801063fe:	eb 78                	jmp    80106478 <deallocuvm+0x9e>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106400:	c1 eb 16             	shr    $0x16,%ebx
80106403:	83 c3 01             	add    $0x1,%ebx
80106406:	c1 e3 16             	shl    $0x16,%ebx
80106409:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010640f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106415:	39 fb                	cmp    %edi,%ebx
80106417:	73 5c                	jae    80106475 <deallocuvm+0x9b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106419:	b9 00 00 00 00       	mov    $0x0,%ecx
8010641e:	89 da                	mov    %ebx,%edx
80106420:	8b 45 08             	mov    0x8(%ebp),%eax
80106423:	e8 63 f9 ff ff       	call   80105d8b <walkpgdir>
80106428:	89 c6                	mov    %eax,%esi
    if(!pte)
8010642a:	85 c0                	test   %eax,%eax
8010642c:	74 d2                	je     80106400 <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
8010642e:	8b 00                	mov    (%eax),%eax
80106430:	a8 01                	test   $0x1,%al
80106432:	74 db                	je     8010640f <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106434:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106439:	74 20                	je     8010645b <deallocuvm+0x81>
    if (a > KERNBASE)
8010643b:	3d 00 00 00 80       	cmp    $0x80000000,%eax
80106440:	77 26                	ja     80106468 <deallocuvm+0x8e>
    return (char*)a + KERNBASE;
...
8010644b:	e8 3c bb ff ff       	call   80101f8c <kfree>
      *pte = 0;
80106450:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80106456:	83 c4 10             	add    $0x10,%esp
80106459:	eb b4                	jmp    8010640f <deallocuvm+0x35>
        panic("kfree");
8010645b:	83 ec 0c             	sub    $0xc,%esp
8010645e:	68 96 6b 10 80       	push   $0x80106b96
80106463:	e8 e0 9e ff ff       	call   80100348 <panic>
        panic("P2V on address > KERNBASE");
80106468:	83 ec 0c             	sub    $0xc,%esp
8010646b:	68 38 6e 10 80       	push   $0x80106e38
80106470:	e8 d3 9e ff ff       	call   80100348 <panic>
    }
  }
  return newsz;
80106475:	8b 45 10             	mov    0x10(%ebp),%eax
}
...
80106486:	83 ec 1c             	sub    $0x1c,%esp
80106489:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
8010648c:	89 7d e4             	mov    %edi,-0x1c(%ebp)
8010648f:	85 ff                	test   %edi,%edi
80106491:	0f 88 d9 00 00 00    	js     80106570 <allocuvm+0xf0>
  if(newsz < oldsz)
80106497:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010649a:	72 67                	jb     80106503 <allocuvm+0x83>
  a = PGROUNDUP(oldsz);
8010649c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010649f:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
801064a5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
801064ab:	39 fe                	cmp    %edi,%esi
801064ad:	0f 83 c4 00 00 00    	jae    80106577 <allocuvm+0xf7>
    mem = kalloc();
801064b3:	e8 11 bc ff ff       	call   801020c9 <kalloc>
801064b8:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
801064ba:	85 c0                	test   %eax,%eax
801064bc:	74 4d                	je     8010650b <allocuvm+0x8b>
    memset(mem, 0, PGSIZE);
801064be:	83 ec 04             	sub    $0x4,%esp
801064c1:	68 00 10 00 00       	push   $0x1000
801064c6:	6a 00                	push   $0x0
801064c8:	50                   	push   %eax
801064c9:	e8 e7 d8 ff ff       	call   80103db5 <memset>
    if (a < (void*) KERNBASE)
801064ce:	83 c4 10             	add    $0x10,%esp
801064d1:	81 fb ff ff ff 7f    	cmp    $0x7fffffff,%ebx
801064d7:	76 5a                	jbe    80106533 <allocuvm+0xb3>
    return (uint)a - KERNBASE;
...
801064ea:	89 f2                	mov    %esi,%edx
801064ec:	8b 45 08             	mov    0x8(%ebp),%eax
801064ef:	e8 32 f9 ff ff       	call   80105e26 <mappages>
801064f4:	83 c4 10             	add    $0x10,%esp
801064f7:	85 c0                	test   %eax,%eax
801064f9:	78 45                	js     80106540 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
801064fb:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106501:	eb a8                	jmp    801064ab <allocuvm+0x2b>
    return oldsz;
80106503:	8b 45 0c             	mov    0xc(%ebp),%eax
80106506:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106509:	eb 6c                	jmp    80106577 <allocuvm+0xf7>
      cprintf("allocuvm out of memory\n");
8010650b:	83 ec 0c             	sub    $0xc,%esp
8010650e:	68 9d 72 10 80       	push   $0x8010729d
80106513:	e8 ef a0 ff ff       	call   80100607 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106518:	83 c4 0c             	add    $0xc,%esp
8010651b:	ff 75 0c             	push   0xc(%ebp)
8010651e:	57                   	push   %edi
8010651f:	ff 75 08             	push   0x8(%ebp)
80106522:	e8 b3 fe ff ff       	call   801063da <deallocuvm>
      return 0;
80106527:	83 c4 10             	add    $0x10,%esp
8010652a:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106531:	eb 44                	jmp    80106577 <allocuvm+0xf7>
        panic("V2P on address < KERNBASE "
80106533:	83 ec 0c             	sub    $0xc,%esp
80106536:	68 08 6b 10 80       	push   $0x80106b08
8010653b:	e8 08 9e ff ff       	call   80100348 <panic>
      cprintf("allocuvm out of memory (2)\n");
80106540:	83 ec 0c             	sub    $0xc,%esp
80106543:	68 b5 72 10 80       	push   $0x801072b5
80106548:	e8 ba a0 ff ff       	call   80100607 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010654d:	83 c4 0c             	add    $0xc,%esp
80106550:	ff 75 0c             	push   0xc(%ebp)
80106553:	57                   	push   %edi
80106554:	ff 75 08             	push   0x8(%ebp)
80106557:	e8 7e fe ff ff       	call   801063da <deallocuvm>
      kfree(mem);
8010655c:	89 1c 24             	mov    %ebx,(%esp)
8010655f:	e8 28 ba ff ff       	call   80101f8c <kfree>
      return 0;
80106564:	83 c4 10             	add    $0x10,%esp
80106567:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010656e:	eb 07                	jmp    80106577 <allocuvm+0xf7>
    return 0;
...
80106587:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  if(pgdir == 0)
8010658a:	85 f6                	test   %esi,%esi
8010658c:	74 1a                	je     801065a8 <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
8010658e:	83 ec 04             	sub    $0x4,%esp
80106591:	6a 00                	push   $0x0
80106593:	68 00 00 00 80       	push   $0x80000000
80106598:	56                   	push   %esi
80106599:	e8 3c fe ff ff       	call   801063da <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010659e:	83 c4 10             	add    $0x10,%esp
801065a1:	bb 00 00 00 00       	mov    $0x0,%ebx
801065a6:	eb 21                	jmp    801065c9 <freevm+0x47>
    panic("freevm: no pgdir");
801065a8:	83 ec 0c             	sub    $0xc,%esp
801065ab:	68 d1 72 10 80       	push   $0x801072d1
801065b0:	e8 93 9d ff ff       	call   80100348 <panic>
    return (char*)a + KERNBASE;
801065b5:	05 00 00 00 80       	add    $0x80000000,%eax
    if(pgdir[i] & PTE_P){
...
801065c3:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
801065c6:	83 c3 01             	add    $0x1,%ebx
801065c9:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
801065cf:	77 20                	ja     801065f1 <freevm+0x6f>
    if(pgdir[i] & PTE_P){
801065d1:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
801065d4:	a8 01                	test   $0x1,%al
801065d6:	74 ee                	je     801065c6 <freevm+0x44>
801065d8:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if (a > KERNBASE)
801065dd:	3d 00 00 00 80       	cmp    $0x80000000,%eax
801065e2:	76 d1                	jbe    801065b5 <freevm+0x33>
        panic("P2V on address > KERNBASE");
801065e4:	83 ec 0c             	sub    $0xc,%esp
801065e7:	68 38 6e 10 80       	push   $0x80106e38
801065ec:	e8 57 9d ff ff       	call   80100348 <panic>
    }
  }
  kfree((char*)pgdir);
801065f1:	83 ec 0c             	sub    $0xc,%esp
801065f4:	56                   	push   %esi
801065f5:	e8 92 b9 ff ff       	call   80101f8c <kfree>
}
801065fa:	83 c4 10             	add    $0x10,%esp
801065fd:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106600:	5b                   	pop    %ebx
80106601:	5e                   	pop    %esi
80106602:	5d                   	pop    %ebp
80106603:	c3                   	ret    
...
80106609:	e8 bb ba ff ff       	call   801020c9 <kalloc>
8010660e:	89 c6                	mov    %eax,%esi
80106610:	85 c0                	test   %eax,%eax
80106612:	74 55                	je     80106669 <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
80106614:	83 ec 04             	sub    $0x4,%esp
80106617:	68 00 10 00 00       	push   $0x1000
8010661c:	6a 00                	push   $0x0
8010661e:	50                   	push   %eax
8010661f:	e8 91 d7 ff ff       	call   80103db5 <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106624:	83 c4 10             	add    $0x10,%esp
80106627:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
8010662c:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106632:	73 35                	jae    80106669 <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
80106634:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106637:	8b 4b 08             	mov    0x8(%ebx),%ecx
8010663a:	29 c1                	sub    %eax,%ecx
8010663c:	83 ec 08             	sub    $0x8,%esp
8010663f:	ff 73 0c             	push   0xc(%ebx)
80106642:	50                   	push   %eax
80106643:	8b 13                	mov    (%ebx),%edx
80106645:	89 f0                	mov    %esi,%eax
80106647:	e8 da f7 ff ff       	call   80105e26 <mappages>
8010664c:	83 c4 10             	add    $0x10,%esp
8010664f:	85 c0                	test   %eax,%eax
80106651:	78 05                	js     80106658 <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106653:	83 c3 10             	add    $0x10,%ebx
80106656:	eb d4                	jmp    8010662c <setupkvm+0x28>
      freevm(pgdir);
80106658:	83 ec 0c             	sub    $0xc,%esp
8010665b:	56                   	push   %esi
8010665c:	e8 21 ff ff ff       	call   80106582 <freevm>
      return 0;
80106661:	83 c4 10             	add    $0x10,%esp
80106664:	be 00 00 00 00       	mov    $0x0,%esi
}
80106669:	89 f0                	mov    %esi,%eax
8010666b:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010666e:	5b                   	pop    %ebx
8010666f:	5e                   	pop    %esi
80106670:	5d                   	pop    %ebp
80106671:	c3                   	ret    
...
80106675:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106678:	e8 87 ff ff ff       	call   80106604 <setupkvm>
8010667d:	a3 c4 46 11 80       	mov    %eax,0x801146c4
  switchkvm();
80106682:	e8 8a fa ff ff       	call   80106111 <switchkvm>
}
80106687:	c9                   	leave  
80106688:	c3                   	ret    
...
8010668f:	b9 00 00 00 00       	mov    $0x0,%ecx
80106694:	8b 55 0c             	mov    0xc(%ebp),%edx
80106697:	8b 45 08             	mov    0x8(%ebp),%eax
8010669a:	e8 ec f6 ff ff       	call   80105d8b <walkpgdir>
  if(pte == 0)
8010669f:	85 c0                	test   %eax,%eax
801066a1:	74 05                	je     801066a8 <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
801066a3:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801066a6:	c9                   	leave  
801066a7:	c3                   	ret    
    panic("clearpteu");
801066a8:	83 ec 0c             	sub    $0xc,%esp
801066ab:	68 e2 72 10 80       	push   $0x801072e2
801066b0:	e8 93 9c ff ff       	call   80100348 <panic>
...
801066b8:	57                   	push   %edi
801066b9:	56                   	push   %esi
801066ba:	53                   	push   %ebx
801066bb:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801066be:	e8 41 ff ff ff       	call   80106604 <setupkvm>
801066c3:	89 45 dc             	mov    %eax,-0x24(%ebp)
801066c6:	85 c0                	test   %eax,%eax
801066c8:	0f 84 f2 00 00 00    	je     801067c0 <copyuvm+0x10b>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801066ce:	bf 00 00 00 00       	mov    $0x0,%edi
801066d3:	eb 3a                	jmp    8010670f <copyuvm+0x5a>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
801066d5:	83 ec 0c             	sub    $0xc,%esp
801066d8:	68 ec 72 10 80       	push   $0x801072ec
801066dd:	e8 66 9c ff ff       	call   80100348 <panic>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
801066e2:	83 ec 0c             	sub    $0xc,%esp
801066e5:	68 06 73 10 80       	push   $0x80107306
801066ea:	e8 59 9c ff ff       	call   80100348 <panic>
801066ef:	83 ec 0c             	sub    $0xc,%esp
801066f2:	68 38 6e 10 80       	push   $0x80106e38
801066f7:	e8 4c 9c ff ff       	call   80100348 <panic>
        panic("V2P on address < KERNBASE "
801066fc:	83 ec 0c             	sub    $0xc,%esp
801066ff:	68 08 6b 10 80       	push   $0x80106b08
80106704:	e8 3f 9c ff ff       	call   80100348 <panic>
  for(i = 0; i < sz; i += PGSIZE){
80106709:	81 c7 00 10 00 00    	add    $0x1000,%edi
8010670f:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106712:	0f 83 a8 00 00 00    	jae    801067c0 <copyuvm+0x10b>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
...
80106725:	e8 61 f6 ff ff       	call   80105d8b <walkpgdir>
8010672a:	85 c0                	test   %eax,%eax
8010672c:	74 a7                	je     801066d5 <copyuvm+0x20>
    if(!(*pte & PTE_P))
8010672e:	8b 00                	mov    (%eax),%eax
80106730:	a8 01                	test   $0x1,%al
80106732:	74 ae                	je     801066e2 <copyuvm+0x2d>
...
80106741:	89 45 e0             	mov    %eax,-0x20(%ebp)
    ...
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106744:	e8 80 b9 ff ff       	call   801020c9 <kalloc>
80106749:	89 c3                	mov    %eax,%ebx
8010674b:	85 c0                	test   %eax,%eax
8010674d:	74 5c                	je     801067ab <copyuvm+0xf6>
    if (a > KERNBASE)
8010674f:	81 fe 00 00 00 80    	cmp    $0x80000000,%esi
80106755:	77 98                	ja     801066ef <copyuvm+0x3a>
    return (char*)a + KERNBASE;
80106757:	81 c6 00 00 00 80    	add    $0x80000000,%esi
      goto bad;
...
80106767:	e8 c1 d6 ff ff       	call   80103e2d <memmove>
    if (a < (void*) KERNBASE)
8010676c:	83 c4 10             	add    $0x10,%esp
8010676f:	81 fb ff ff ff 7f    	cmp    $0x7fffffff,%ebx
80106775:	76 85                	jbe    801066fc <copyuvm+0x47>
    return (uint)a - KERNBASE;
80106777:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
8010677d:	83 ec 08             	sub    $0x8,%esp
80106780:	ff 75 e0             	push   -0x20(%ebp)
80106783:	50                   	push   %eax
80106784:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106789:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010678c:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010678f:	e8 92 f6 ff ff       	call   80105e26 <mappages>
80106794:	83 c4 10             	add    $0x10,%esp
80106797:	85 c0                	test   %eax,%eax
80106799:	0f 89 6a ff ff ff    	jns    80106709 <copyuvm+0x54>
      kfree(mem);
8010679f:	83 ec 0c             	sub    $0xc,%esp
801067a2:	53                   	push   %ebx
801067a3:	e8 e4 b7 ff ff       	call   80101f8c <kfree>
      goto bad;
...
801067ae:	ff 75 dc             	push   -0x24(%ebp)
801067b1:	e8 cc fd ff ff       	call   80106582 <freevm>
  return 0;
801067b6:	83 c4 10             	add    $0x10,%esp
801067b9:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
801067c0:	8b 45 dc             	mov    -0x24(%ebp),%eax
...
801067ce:	83 ec 08             	sub    $0x8,%esp
  ...
  pte = walkpgdir(pgdir, uva, 0);
801067d1:	b9 00 00 00 00       	mov    $0x0,%ecx
801067d6:	8b 55 0c             	mov    0xc(%ebp),%edx
801067d9:	8b 45 08             	mov    0x8(%ebp),%eax
801067dc:	e8 aa f5 ff ff       	call   80105d8b <walkpgdir>
  if((*pte & PTE_P) == 0)
801067e1:	8b 00                	mov    (%eax),%eax
801067e3:	a8 01                	test   $0x1,%al
801067e5:	74 24                	je     8010680b <uva2ka+0x40>
    return 0;
  if((*pte & PTE_U) == 0)
801067e7:	a8 04                	test   $0x4,%al
801067e9:	74 27                	je     80106812 <uva2ka+0x47>
static inline uint PTE_ADDR(uint pte)  { return pte & ~0xFFF; }
801067eb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if (a > KERNBASE)
801067f0:	3d 00 00 00 80       	cmp    $0x80000000,%eax
801067f5:	77 07                	ja     801067fe <uva2ka+0x33>
    return (char*)a + KERNBASE;
801067f7:	05 00 00 00 80       	add    $0x80000000,%eax
    return 0;
...
80106801:	68 38 6e 10 80       	push   $0x80106e38
80106806:	e8 3d 9b ff ff       	call   80100348 <panic>
    return 0;
8010680b:	b8 00 00 00 00       	mov    $0x0,%eax
80106810:	eb ea                	jmp    801067fc <uva2ka+0x31>
    return 0;
80106812:	b8 00 00 00 00       	mov    $0x0,%eax
80106817:	eb e3                	jmp    801067fc <uva2ka+0x31>
...
80106822:	8b 7d 14             	mov    0x14(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80106825:	eb 25                	jmp    8010684c <copyout+0x33>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
80106827:	8b 55 0c             	mov    0xc(%ebp),%edx
8010682a:	29 f2                	sub    %esi,%edx
8010682c:	01 d0                	add    %edx,%eax
8010682e:	83 ec 04             	sub    $0x4,%esp
80106831:	53                   	push   %ebx
80106832:	ff 75 10             	push   0x10(%ebp)
80106835:	50                   	push   %eax
80106836:	e8 f2 d5 ff ff       	call   80103e2d <memmove>
    len -= n;
8010683b:	29 df                	sub    %ebx,%edi
    buf += n;
8010683d:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80106840:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
80106846:	89 45 0c             	mov    %eax,0xc(%ebp)
80106849:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
8010684c:	85 ff                	test   %edi,%edi
8010684e:	74 2f                	je     8010687f <copyout+0x66>
    va0 = (uint)PGROUNDDOWN(va);
80106850:	8b 75 0c             	mov    0xc(%ebp),%esi
80106853:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106859:	83 ec 08             	sub    $0x8,%esp
8010685c:	56                   	push   %esi
8010685d:	ff 75 08             	push   0x8(%ebp)
80106860:	e8 66 ff ff ff       	call   801067cb <uva2ka>
    if(pa0 == 0)
80106865:	83 c4 10             	add    $0x10,%esp
80106868:	85 c0                	test   %eax,%eax
8010686a:	74 20                	je     8010688c <copyout+0x73>
    n = PGSIZE - (va - va0);
8010686c:	89 f3                	mov    %esi,%ebx
8010686e:	2b 5d 0c             	sub    0xc(%ebp),%ebx
80106871:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
80106877:	39 df                	cmp    %ebx,%edi
80106879:	73 ac                	jae    80106827 <copyout+0xe>
      n = len;
8010687b:	89 fb                	mov    %edi,%ebx
8010687d:	eb a8                	jmp    80106827 <copyout+0xe>
  }
  return 0;
...
80106891:	eb f1                	jmp    80106884 <copyout+0x6b>
