...
fmtname(char *path)
{
  ...
  75:	52                   	push   %edx
  76:	6a 20                	push   $0x20
  78:	05 20 08 00 00       	add    $0x820,%eax
  7d:	50                   	push   %eax
  7e:	e8 c5 02 00 00       	call   348 <memset>
  return buf;
  83:	83 c4 10             	add    $0x10,%esp
  86:	bb 20 08 00 00       	mov    $0x820,%ebx
...
ls(char *path)
{
 ...
 116:	56                   	push   %esi
 117:	50                   	push   %eax
 118:	68 88 07 00 00       	push   $0x788
 11d:	6a 01                	push   $0x1
 11f:	e8 d4 04 00 00       	call   5f8 <printf>
    break;
 ...
 13e:	53                   	push   %ebx
 13f:	68 60 07 00 00       	push   $0x760
 144:	6a 02                	push   $0x2
 146:	e8 ad 04 00 00       	call   5f8 <printf>
    return;
 ...
 153:	53                   	push   %ebx
 154:	68 74 07 00 00       	push   $0x774
 159:	6a 02                	push   $0x2
 15b:	e8 98 04 00 00       	call   5f8 <printf>
    close(fd);
 ...
 186:	68 95 07 00 00       	push   $0x795
 18b:	6a 01                	push   $0x1
 18d:	e8 66 04 00 00       	call   5f8 <printf>
      break;
 ...
 1cb:	50                   	push   %eax
 1cc:	68 74 07 00 00       	push   $0x774
 1d1:	6a 01                	push   $0x1
 1d3:	e8 20 04 00 00       	call   5f8 <printf>
        continue;
 ...
 27d:	50                   	push   %eax
 27e:	52                   	push   %edx
 27f:	68 88 07 00 00       	push   $0x788
 284:	6a 01                	push   $0x1
 286:	e8 6d 03 00 00       	call   5f8 <printf>
...
putc(int fd, char c)
{
 ...
 559:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 55c:	6a 01                	push   $0x1
 55e:	8d 55 f4             	lea    -0xc(%ebp),%edx
 561:	52                   	push   %edx
 562:	50                   	push   %eax
 563:	e8 3b ff ff ff       	call   4a3 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 581:	0f 95 c1             	setne  %cl
 584:	c1 ea 1f             	shr    $0x1f,%edx
 587:	84 d1                	test   %dl,%cl
 589:	74 44                	je     5cf <printint+0x62>
    neg = 1;
    x = -xx;
 58b:	f7 d8                	neg    %eax
 ...
 5a9:	0f b6 92 0c 08 00 00 	movzbl 0x80c(%edx),%edx
 5b0:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 5b4:	89 ca                	mov    %ecx,%edx
 5b6:	89 c1                	mov    %eax,%ecx
 5b8:	39 d6                	cmp    %edx,%esi
 5ba:	76 df                	jbe    59b <printint+0x2e>
  if(neg)
 5bc:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 5c0:	74 31                	je     5f3 <printint+0x86>
    buf[i++] = '-';
 5c2:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 5c7:	8d 5f 02             	lea    0x2(%edi),%ebx
 5ca:	8b 75 d0             	mov    -0x30(%ebp),%esi
 5cd:	eb 17                	jmp    5e6 <printint+0x79>
    x = xx;
 5cf:	89 c1                	mov    %eax,%ecx
  neg = 0;
 5d1:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 5d8:	eb bc                	jmp    596 <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
 5da:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 5df:	89 f0                	mov    %esi,%eax
 5e1:	e8 6d ff ff ff       	call   553 <putc>
  while(--i >= 0)
 5e6:	83 eb 01             	sub    $0x1,%ebx
 5e9:	79 ef                	jns    5da <printint+0x6d>
}
 5eb:	83 c4 2c             	add    $0x2c,%esp
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 5f1:	5d                   	pop    %ebp
 ...
 5f6:	eb ee                	jmp    5e6 <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
 ...
 618:	e8 36 ff ff ff       	call   553 <putc>
 61d:	eb 05                	jmp    624 <printf+0x2c>
      }
    } else if(state == '%'){
 61f:	83 fe 25             	cmp    $0x25,%esi
 622:	74 25                	je     649 <printf+0x51>
  for(i = 0; fmt[i]; i++){
 624:	83 c3 01             	add    $0x1,%ebx
 627:	8b 45 0c             	mov    0xc(%ebp),%eax
 62a:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 62e:	84 c0                	test   %al,%al
 630:	0f 84 20 01 00 00    	je     756 <printf+0x15e>
    c = fmt[i] & 0xff;
 636:	0f be f8             	movsbl %al,%edi
 639:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 63c:	85 f6                	test   %esi,%esi
 63e:	75 df                	jne    61f <printf+0x27>
      if(c == '%'){
 640:	83 f8 25             	cmp    $0x25,%eax
 643:	75 ce                	jne    613 <printf+0x1b>
        state = '%';
 645:	89 c6                	mov    %eax,%esi
 647:	eb db                	jmp    624 <printf+0x2c>
      if(c == 'd'){
 649:	83 f8 25             	cmp    $0x25,%eax
 64c:	0f 84 cf 00 00 00    	je     721 <printf+0x129>
 652:	0f 8c dd 00 00 00    	jl     735 <printf+0x13d>
 658:	83 f8 78             	cmp    $0x78,%eax
 65b:	0f 8f d4 00 00 00    	jg     735 <printf+0x13d>
 661:	83 f8 63             	cmp    $0x63,%eax
 664:	0f 8c cb 00 00 00    	jl     735 <printf+0x13d>
 66a:	83 e8 63             	sub    $0x63,%eax
 66d:	83 f8 15             	cmp    $0x15,%eax
 670:	0f 87 bf 00 00 00    	ja     735 <printf+0x13d>
 676:	ff 24 85 b4 07 00 00 	jmp    *0x7b4(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 68f:	e8 d9 fe ff ff       	call   56d <printint>
        ap++;
 ...
 6c9:	e9 56 ff ff ff       	jmp    624 <printf+0x2c>
        s = (char*)*ap;
 6ce:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 6d1:	8b 30                	mov    (%eax),%esi
        ap++;
 6d3:	83 c0 04             	add    $0x4,%eax
 6d6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 6d9:	85 f6                	test   %esi,%esi
 6db:	75 15                	jne    6f2 <printf+0xfa>
          s = "(null)";
 6dd:	be aa 07 00 00       	mov    $0x7aa,%esi
 6e2:	eb 0e                	jmp    6f2 <printf+0xfa>
          putc(fd, *s);
 6e4:	0f be d2             	movsbl %dl,%edx
 6e7:	8b 45 08             	mov    0x8(%ebp),%eax
 6ea:	e8 64 fe ff ff       	call   553 <putc>
          s++;
 6ef:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 6f2:	0f b6 16             	movzbl (%esi),%edx
 6f5:	84 d2                	test   %dl,%dl
 6f7:	75 eb                	jne    6e4 <printf+0xec>
      state = 0;
 6f9:	be 00 00 00 00       	mov    $0x0,%esi
 6fe:	e9 21 ff ff ff       	jmp    624 <printf+0x2c>
        putc(fd, *ap);
 703:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 706:	0f be 17             	movsbl (%edi),%edx
 709:	8b 45 08             	mov    0x8(%ebp),%eax
 70c:	e8 42 fe ff ff       	call   553 <putc>
        ap++;
 711:	83 c7 04             	add    $0x4,%edi
 714:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 717:	be 00 00 00 00       	mov    $0x0,%esi
 71c:	e9 03 ff ff ff       	jmp    624 <printf+0x2c>
        putc(fd, c);
 721:	89 fa                	mov    %edi,%edx
 723:	8b 45 08             	mov    0x8(%ebp),%eax
 726:	e8 28 fe ff ff       	call   553 <putc>
      state = 0;
 72b:	be 00 00 00 00       	mov    $0x0,%esi
 730:	e9 ef fe ff ff       	jmp    624 <printf+0x2c>
        putc(fd, '%');
 735:	ba 25 00 00 00       	mov    $0x25,%edx
 73a:	8b 45 08             	mov    0x8(%ebp),%eax
 73d:	e8 11 fe ff ff       	call   553 <putc>
        putc(fd, c);
 742:	89 fa                	mov    %edi,%edx
 744:	8b 45 08             	mov    0x8(%ebp),%eax
 747:	e8 07 fe ff ff       	call   553 <putc>
      state = 0;
 74c:	be 00 00 00 00       	mov    $0x0,%esi
 751:	e9 ce fe ff ff       	jmp    624 <printf+0x2c>
    }
  }
}
